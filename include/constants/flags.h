...
#define FLAG_DEFEATED_WEATHERBANE                                           0x49F // Unused Flag
#define FLAG_ITEM_STARTING_ROCK_CANDY                                   0x4A0 // Unused Flag
#define FLAG_ITEM_POND_ROCK_CANDY                                           0x4A1 // Unused Flag
#define FLAG_TREES_CLEARED                                           0x4A2 // Unused Flag
#define FLAG_TREES_CLEARED_2                                           0x4A3 // Unused Flag
#define FLAG_GOT_MARCEL                                           0x4A4 // Unused Flag
#define FLAG_GOT_VICE                                           0x4A5 // Unused Flag
...
#define FLAG_MET_PHANTUMP                                           0x4AF // Unused Flag
#define FLAG_ITEM_BEHIND_CHURCH_CANDY                                           0x4B0 // Unused Flag
#define FLAG_ITEM_FRONT_CHURCH_CANDY                               0x4B1 // Unused Flag
#define FLAG_ITEM_BEHIND_HOUSE_CANDY                                           0x4B2 // Unused Flag
#define FLAG_ITEM_HOUSE_TREE_CANDY                                           0x4B3 // Unused Flag
#define FLAG_ITEM_GRAVEYARD_CANDY                                           0x4B4 // Unused Flag
#define FLAG_ITEM_ARENA_CANDY                                           0x4B5 // Unused Flag
