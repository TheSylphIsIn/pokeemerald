...
#define ANIM_SIT_WEST  (ANIM_STD_COUNT + 4)
#define ANIM_SIT_EAST  (ANIM_STD_COUNT + 5)
#define ANIM_GET_OUT_POKEBALL_DOWN	(ANIM_STD_COUNT + 6)
#define ANIM_PUT_AWAY_POKEBALL_DOWN	(ANIM_STD_COUNT + 7)
