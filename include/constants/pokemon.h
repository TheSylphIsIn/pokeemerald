...
#define DAMAGE_CATEGORY_DYNAMIC		3
...
#define EVO_RELATIVE_TO_MET				  50	 // Pokémon reaches the level specified in the lower 8 bits, OR (level - metLevel) reaches the level specified in the upper 8 bits
