...
#define EVO_ATTRIBUTE_1		 			  43 // Pokemon levels up while knowing 1 or more moves with the specified attribute
#define EVO_ATTRIBUTE_2		 			  44 // Pokemon levels up while knowing 2 or more moves with the specified attribute
#define EVO_ATTRIBUTE_3		 			  45 // Pokemon levels up while knowing 3 or more moves with the specified attribute
#define EVO_ATTRIBUTE_TOP	 			  46 // Pokemon levels up while knowing 2 punch moves and 2 kick moves
