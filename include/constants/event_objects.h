...
#define OBJ_EVENT_GFX_ALTA_GRUNT_M				 239
#define OBJ_EVENT_GFX_ALTA_GRUNT_F				 240
#define OBJ_EVENT_GFX_STAR_PIECE				 241
...
#define OBJ_EVENT_GFX_PLAYER_ASLEEP_M			 247
#define OBJ_EVENT_GFX_PLAYER_ASLEEP_F			 248
