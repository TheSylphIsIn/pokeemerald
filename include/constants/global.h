...
#define TEXT_SPEED_FORCED_SLOW 3
...
#define OPTIONS_DIFFICULTY_UNFAIR 2

#define OPTIONS_BATTLE_MESSAGE_SCROLL_DEFAULT 0
#define OPTIONS_BATTLE_MESSAGE_SCROLL_WAIT_BUTTON 1
#define OPTIONS_BATTLE_MESSAGE_SCROLL_SKIP_BUTTON 2

#define OPTIONS_BATTLE_SLIDE_SPEED_NORMAL 0
#define OPTIONS_BATTLE_SLIDE_SPEED_FAST 1
#define OPTIONS_BATTLE_SLIDE_SPEED_HYPER 2

#define OPTIONS_TEXT_MASH_INPUT_NORMAL 0
#define OPTIONS_TEXT_MASH_INPUT_DPAD 1
#define OPTIONS_TEXT_MASH_INPUT_HOLD 2
