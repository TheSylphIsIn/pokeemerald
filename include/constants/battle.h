...
// potential new status: "Armor break". Increases the crit ratio of attacks against this battler by 2.
...
// Battle Weather flags (16 possible, 10 used)
...
#define B_WEATHER_INTENSE_SUN		  (1 << 7)
#define B_WEATHER_SUN                 (B_WEATHER_SUN_TEMPORARY | B_WEATHER_SUN_PERMANENT | B_WEATHER_INTENSE_SUN)
...
#define MOVE_EFFECT_GASLIGHT 			60
