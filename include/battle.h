...
#define B_ACTION_USE_TACTICS			14
...
struct BattleStruct
{
    ...
    u8 formToChangeInto; // effectively unused now
    ...
    u8 dynamicCategory:1; // Dynamic category moves. TRUE = Special, FALSE = physical.
    u8 ballSpriteIds[4];    // item gfx, window gfx
