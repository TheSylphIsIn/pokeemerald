...
void MovementType_SpinClockwiseDelay(struct Sprite *);
...
u8 MovementType_SpinClockwiseDelay_Step0(struct ObjectEvent *, struct Sprite *);
u8 MovementType_SpinClockwiseDelay_Step1(struct ObjectEvent *, struct Sprite *);
u8 MovementType_SpinClockwiseDelay_Step2(struct ObjectEvent *, struct Sprite *);
u8 MovementType_SpinClockwiseDelay_Step3(struct ObjectEvent *, struct Sprite *);
