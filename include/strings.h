...
extern const u8 gText_DifficultyUnfair[];
...
extern const u8 gText_MessageWait[];
extern const u8 gText_MessageButton[];
...
extern const u8 gText_Tab3Header[];
extern const u8 gText_Tab4Header[];
...
extern const u8 gText_BattleHelpers[];
...
extern const u8 gText_OptionMenuTabExit[];

extern const u8 gText_OptionDescription_DifficultyNormal[];
extern const u8 gText_OptionDescription_DifficultyHard[];
extern const u8 gText_OptionDescription_DifficultyUnfair[];
extern const u8 gText_OptionDescription_ExpAll[];
extern const u8 gText_OptionDescription_BattleStyle[];
extern const u8 gText_OptionDescription_BattleHelp[];
...
extern const u8 gText_OptionDescription_TextSpeedSuper[];
extern const u8 gText_OptionDescription_TextSpeedHyper[];
extern const u8 gText_OptionDescription_TextScrollNormal[];
extern const u8 gText_OptionDescription_TextScrollDpad[];
extern const u8 gText_OptionDescription_TextScrollHold[];
extern const u8 gText_OptionDescription_AutoRunOn[];
extern const u8 gText_OptionDescription_AutoRunOff[];
extern const u8 gText_OptionDescription_FastHMs[];
extern const u8 gText_OptionDescription_FrameType[];
extern const u8 gText_OptionDescription_ButtonMode[];
extern const u8 gText_OptionDescription_Sound[];
extern const u8 gText_OptionDescription_Exit[];
...
extern const u8 gText_DefaultNameMale[];
extern const u8 gText_DefaultNameFemale[];
...
extern const u8 gText_BurrowHere[];
...
extern const u8 gText_Effort[];
extern const u8 gText_AttackShort[];
extern const u8 gText_DefenseShort[];
extern const u8 gText_SpAtkShort[];
extern const u8 gText_SpDefShort[];
extern const u8 gText_SpeedShort[];
extern const u8 gText_TwoMarks[];
...
extern const u8 gText_BaseStatTotal[];
...
extern const u8 gText_EvoMethodLevel[];
extern const u8 gText_EvoMethodTrade[];
extern const u8 gText_EvoMethodTradeItem[];
extern const u8 gText_EvoMethodItem[];
extern const u8 gText_EvoMethodStatDependent[];
extern const u8 gText_EvoMethodStatAtk[];
extern const u8 gText_EvoMethodStatDef[];
extern const u8 gText_EvoMethodStatEqual[];
extern const u8 gText_EvoMethodSilcoonCascoon[];
extern const u8 gText_EvoMethodShedinja[];
extern const u8 gText_EvoMethodBeauty[];
extern const u8 gText_EvoMethodMove[];
extern const u8 gText_EvoMethodAttribute1[];
extern const u8 gText_EvoMethodAttribute2[];
extern const u8 gText_EvoMethodAttribute3[];
...
extern const u8 gText_SpeciesData[];
...
extern const u8 gText_ReadOutAbilities[];
