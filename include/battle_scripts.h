...
extern const u8 BattleScript_AbsorbMoveStatBoost_PPLoss[];
extern const u8 BattleScript_AbsorbMoveStatBoost[];
...
extern const u8 BattleScript_AbilityBlocksSomeDamage[];
