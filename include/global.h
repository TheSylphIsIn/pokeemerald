...
struct SaveBlock2
{
    ...
    /*0x14*/ u16 optionsTextSpeed:3; // OPTIONS_TEXT_SPEED_[SLOW/MID/FAST]
             ...
             u16 optionsExpShare:1; // TRUE to share Exp.
    ...
    /*0x64C*/ struct BattleFrontier frontier;
              u8 shopInventories[TMSHOP_COUNT][TMSHOP_ITEMS_COUNT];
}; // sizeof=0xF2C
...
struct SaveBlock1
{
    ...
    /*0x790*/ struct ItemSlot bagPocket_Berries[BAG_BERRIES_COUNT];
			  ...
			  struct ItemSlot bagPocket_Materials[BAG_MATERIALS_COUNT]; // crafting materials
