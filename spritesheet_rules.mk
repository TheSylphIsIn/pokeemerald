...
$(OBJEVENTGFXDIR)/people/alta_member_m.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/people/alta_member_f.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/people/morgan.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/people/calvin.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/people/morgan_asleep.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
...
$(OBJEVENTGFXDIR)/misc/star_piece.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 2

$(OBJEVENTGFXDIR)/misc/cuttable_tree.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 2
	
$(OBJEVENTGFXDIR)/misc/cuttable_fence.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 2
