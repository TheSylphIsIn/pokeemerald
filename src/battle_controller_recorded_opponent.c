...
static void (*const sRecordedOpponentBufferCommands[CONTROLLER_CMDS_COUNT])(void) =
{
    ...
    [CONTROLLER_USETACTICS]                       = RecordedOpponentHandleCmd23,
    ...
    [CONTROLLER_OPENFIELDSTATUS]                       = RecordedOpponentHandleCmd32,
...
static void RecordedOpponentHandleDrawTrainerPic(void)
{
    ...
    gSprites[gBattlerSpriteIds[gActiveBattler]].x2 = -DISPLAY_WIDTH;
    gSprites[gBattlerSpriteIds[gActiveBattler]].sSpeedX = INTRO_SLIDE_SPEED;
