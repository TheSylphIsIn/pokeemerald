...
static void BagMenu_ItemPrintCallback(u8 windowId, s32 itemIndex, u8 y, u8 listPos)
{
    u16 itemId;
    u16 itemQuantity;
    int offset;
...
{
    if (!isCurrentPocket)
        FillBgTilemapBufferRect_Palette0(2, 0x1023 + x, x + 4, 3, 1, 1);
    else
        FillBgTilemapBufferRect_Palette0(2, 0x1033 + x, x + 4, 3, 1, 1);
    ScheduleBgCopyTilemapToVram(2);
}
