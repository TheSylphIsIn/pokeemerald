...
static const u8 sText_CantEscape2[] = _("You can't.\p");
...
static const u8 sText_RootedToGround[] = _("You're rooted to the ground.\p");
static const u8 sText_CantEscape[] = _("You can't.\p");
...
static const u8 sText_Consume[] = _("{B_ATK_NAME_WITH_PREFIX} consumed {B_DEF_NAME_WITH_PREFIX}.");
...
static const u8 sText_ShootSoClose[] = _("Oh no…");
...
const u8 * const gBattleStringsTable[BATTLESTRINGS_COUNT - BATTLESTRINGS_TABLE_START] =
{
    ...
    [STRINGID_ROOTEDTOGROUND - BATTLESTRINGS_TABLE_START] = sText_RootedToGround,
...
void BufferStringBattle(u16 stringID)
{
    ...
    *(&gBattleStruct->stringMoveType) = gBattleMsgDataPtr->moveType;
    ...
    case STRINGID_USEDMOVE: // pokemon used a move msg
		...
		if (gBattleMsgDataPtr->currentMove == MOVE_CONSUME)
			stringPtr = sText_Consume;
		else
