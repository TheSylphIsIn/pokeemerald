...
static UNUSED void UnusedFlickerAnim(struct Sprite *sprite)
{
    if (sprite->data[2] > 1)
    {
        if (sprite->data[3] & 1)
...
static UNUSED void AnimTask_HideBattlersHealthbox(u8 taskId)
{
    u8 i;
...
static UNUSED void AnimTask_ShowBattlersHealthbox(u8 taskId)
{
    u8 i;
    for (i = 0; i < gBattlersCount; i++)
