...
s32 AI_CalcDamage(u32 move, u32 battlerAtk, u32 battlerDef, u8 *typeEffectiveness, bool32 considerZPower, u32 weather)
{
    ...
    else if (gMovesInfo[move].category == DAMAGE_CATEGORY_DYNAMIC)
        gBattleStruct->dynamicCategory = (GetCategoryBasedOnStats(gBattlerAttacker) == DAMAGE_CATEGORY_PHYSICAL);
