...
const u32 gBattleTextboxTilemap[] = INCBIN_U32("graphics/battle_interface/textbox_map_vert.bin.lz");
...
const u32 gShopMenuStar_Gfx[] = INCBIN_U32("graphics/shop/star.4bpp.lz");
const u32 gShopMenuPieces_Gfx[] = INCBIN_U32("graphics/shop/pieces.4bpp.lz");
...
const u16 gFrontierPassBg_Pal[]                      = INCBIN_U16("graphics/frontier_pass/bg.gbapal");
