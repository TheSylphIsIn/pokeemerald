...
EWRAM_DATA u8 ALIGNED(4) sBasePaletteColorMapTypes[32] = {0}; // modern compiler complained about this not being aligned. Idk if that's the right number there.
// { can't initialize EWRAM
    //background palettes
