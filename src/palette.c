...
// Unused
static UNUSED bool8 BeginPlttFade(u32 selectedPalettes, u8 delay, u8 startY, u8 targetY, u16 blendColor)
{
    ReadPlttIntoBuffers();
...
// Unused
static UNUSED void PaletteStruct_Run(u8 a1, u32 *unkFlags)
{
    u8 i;
...
static UNUSED void PaletteStruct_SetUnusedFlag(u16 id)
{
    u8 paletteNum = PaletteStruct_GetPalNum(id);
    if (paletteNum != NUM_PALETTE_STRUCTS)
...
static UNUSED void PaletteStruct_ClearUnusedFlag(u16 id)
{
    u8 paletteNum = PaletteStruct_GetPalNum(id);
    if (paletteNum != NUM_PALETTE_STRUCTS)
...
// Unused
static UNUSED bool32 IsBlendPalettesGraduallyTaskActive(u8 id)
{
    int i;
...
// Unused
static UNUSED void DestroyBlendPalettesGraduallyTask(void)
{
    u8 taskId;
