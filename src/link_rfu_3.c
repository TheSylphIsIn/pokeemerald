...
static UNUSED void RfuUnusedQueue_Reset(struct RfuUnusedQueue *queue)
{
    s32 i;
    s32 j;
...
static UNUSED void PopulateArrayWithSequence(u8 *arr, u8 mode)
{
    s32 i;
    u8 rval;
    u16 total = 0;
...
static UNUSED void PkmnStrToASCII(u8 *asciiStr, const u8 *pkmnStr)
{
    s32 i;
...
static UNUSED void ASCIIToPkmnStr(u8 *pkmnStr, const u8 *asciiStr)
{
    s32 i;
