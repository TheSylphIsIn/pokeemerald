...
static void ItemPrintFunc_PossibleGroupMembers(u8 windowId, u32 id, u8 y, u8 listPos)
{
    struct WirelessLink_Leader *data = sWirelessLinkMain.leader;
    ...
    case LG_STATE_CHOOSE_LEADER_HANDLE_INPUT:
        ...
        case 0:
            ...
            if (JOY_NEW(A_BUTTON) && id != LIST_NOTHING_CHOSEN)
            {
                ...
                UNUSED u32 activity = data->playerList->players[id].rfu.data.activity;
...
static void ListMenuItemPrintFunc_UnionRoomGroups(u8 windowId, u32 id, u8 y, u8 listPos)
{
    struct WirelessLink_Group *data = sWirelessLinkMain.group;
...
static void ItemPrintFunc_EmptyList(u8 windowId, u32 itemId, u8 y, u8 listPos)
{
}
...
static void TradeBoardListMenuItemPrintFunc(u8 windowId, u32 itemId, u8 y, u8 listPos)
{
