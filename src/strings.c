...
const u8 gText_Tab1Header[] = _("BATTLE - Page 1 of 4 (Scroll with LR)");
const u8 gText_Tab2Header[] = _("BATTLE 2 - Page 2 of 4 (Scroll with LR)");
const u8 gText_Tab3Header[] = _("SPEED - Page 3 of 4 (Scroll with LR)");
const u8 gText_Tab4Header[] = _("MISC - Page 4 of 4 (Scroll with LR)");
...
const u8 gText_OptionDescription_BattleStyle[] = _("On SWITCH, you may switch for free\nwhen an opponent faints.");
