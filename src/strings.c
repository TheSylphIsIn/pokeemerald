...
const u8 gText_Sound[] = _("EXP. ALL");
const u8 gText_Frame[] = _("FRAME");
const u8 gText_OptionMenuCancel[] = _("FINISH");
...
const u8 gText_BattleStyleShift[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}EASY     "); // extra spaces so it overwrites the extra characters of "normal"
const u8 gText_BattleStyleSet[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}NORMAL");
const u8 gText_BattleStyleHard[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}HARD     "); // ^ ditto
const u8 gText_BattleStyleUnfair[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}UNFAIR");
