...
const u8 gText_DadsAdvice[] = _("This isn't useful right now.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ContinueMenuBadges[] = _("SHARDS");
...
const u8 gText_SavingBadges[] = _("SHARDS");
...
const u8 gText_MarcelRefuseCandyMessage[] = _("Ooh, what a pretty little gem…\nHuh? To eat?{PAUSE_UNTIL_PRESS}");
...
const u8 gText_BradleyRefuseCandyMessage[] = _("I think my old master used to traffic\nthese. Get it away from me.{PAUSE_UNTIL_PRESS}");
