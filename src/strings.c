...
const u8 gText_DefaultNameStu[] = _("WRAITH");
const u8 gText_DefaultNameMilton[] = _("SHADE");
const u8 gText_DefaultNameTom[] = _("DARK");
const u8 gText_DefaultNameKenny[] = _("EYE");
const u8 gText_DefaultNameKimmy[] = _("JERICHO");
const u8 gText_DefaultNameTiara[] = _("GHOST");
const u8 gText_DefaultNameBella[] = _("HAUNT");
const u8 gText_DefaultNameJayla[] = _("LOBA");
const u8 gText_ThisIsAPokemon[] = _("I remember something… a POKéMON.{PAUSE 96}\p");
...
const u8 gText_MaterialsPocket[] = _("MATERIALS");
...
const u8 *const gPocketNamesStringsTable[] =
{
	...
	[MATERIALS_POCKET] = gText_MaterialsPocket,
...
const u8 gText_PokedollarVar1QuantityVar2[] = _("¥{STR_VAR_1} x{STR_VAR_2}");
