...
const u8 gText_CrySkip[] = _("CRY SKIP");
...
const u8 gText_OptionDescription_CrySkipOn[] = _("Battles will not pause during\nPOKéMON cries. May sound strange.");
const u8 gText_OptionDescription_CrySkipOff[] = _("Battles will pause while a\nPOKéMON's cry is playing.");
