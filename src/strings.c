...
const u8 gText_DefaultNameMale[] = _("Darren");
const u8 gText_DefaultNameFemale[] = _("Dakota");
...
const u8 gText_Effort[] = _("EFFORT");
const u8 gText_AttackShort[] = _("ATK");
const u8 gText_DefenseShort[] = _("DEF");
const u8 gText_SpAtkShort[] = _("SATK");
const u8 gText_SpDefShort[] = _("SDEF");
const u8 gText_SpeedShort[] = _("SPE");
const u8 gText_TwoMarks[] = _("??");
const u8 gText_UpArrow[] = _("{UP_ARROW}");
const u8 gText_DataIncompleteSeen[] = _("Incomplete data! Catch to learn more!");
...
const u8 gText_EvoMethodLevel[] = _("Train up to Level ");
const u8 gText_EvoMethodTrade[] = _("Receive in a trade");
const u8 gText_EvoMethodTradeItem[] = _("Receive with a ");
const u8 gText_EvoMethodItem[] = _("Use a ");
const u8 gText_EvoMethodStatDependent[] = _("Reach level ");
const u8 gText_EvoMethodStatAtk[] = _(" with high ATK");
const u8 gText_EvoMethodStatDef[] = _(" with high DEF");
const u8 gText_EvoMethodStatEqual[] = _(" with even ATK/DEF");
const u8 gText_EvoMethodSilcoonCascoon[] = _("May reach this form at level ");
const u8 gText_EvoMethodShedinja[] = _("Appears in empty party slot");
const u8 gText_EvoMethodBeauty[] = _("Train while having high BEAUTY");
const u8 gText_EvoMethodMove[] = _("Learn the move ");
const u8 gText_EvoMethodAttribute1[] = _("Learn one ");
const u8 gText_EvoMethodAttribute2[] = _("Learn two ");
const u8 gText_EvoMethodAttribute3[] = _("Learn three ");
const u8 gText_MoveLowercase[] = _(" move");
const u8 gText_EvoMethodRelative1[] = _("Level up ");
const u8 gText_EvoMethodRelative2[] = _(" times or reach Lv ");
const u8 gText_EeveeEvoText[] = _("Use an evolution stone");
...
const u8 gText_BirchInTrouble[] = _("A monster is attacking!\nCan one of these things help?");
...
const u8 gText_NatureChanged[] = _("Oh? Nature changed to ");
const u8 gText_ExclamationPoint[] = _("!");
...
const u8 gText_SpeciesData[] = _("SPECIES DATA");
...
const u8 gText_XNatureFatefulEncounter[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} nature. Obtained\nfatefully at {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}.");
...
const u8 gText_Tab1Header[] = _("BATTLE{CLEAR_TO 131}{EMOJI_CIRCLE} · · · {L_BUTTON}{R_BUTTON}");
const u8 gText_Tab2Header[] = _("BATTLE 2{CLEAR_TO 131}· {EMOJI_CIRCLE} · · {L_BUTTON}{R_BUTTON}");
const u8 gText_Tab3Header[] = _("SPEED{CLEAR_TO 131}· · {EMOJI_CIRCLE} · {L_BUTTON}{R_BUTTON}");
const u8 gText_Tab4Header[] = _("MISC{CLEAR_TO 131}· · · {EMOJI_CIRCLE} {L_BUTTON}{R_BUTTON}");
...
const u8 gText_BattleHelpers[] = _("BATTLE HELPERS");
const u8 gText_Sound[] = _("SOUND");
const u8 gText_Frame[] = _("FRAME");
const u8 gText_BattleMessageScroll[] = _("MESSAGE");
const u8 gText_HotkeyMode[] = _("HOTKEY MODE");
const u8 gText_IntroSlideSpeed[] = _("INTRO SLIDE");
const u8 gText_TextMash[] = _("TEXT SCROLL");
...
const u8 gText_DifficultyHard[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}HARD     "); // extra spaces so it overwrites the extra characters of "normal"
const u8 gText_DifficultyUnfair[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}UNFAIR");
...
const u8 gText_MessageWait[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}WAIT");
const u8 gText_MessageButton[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}BUTTON");
...
const u8 gText_OptionDescription_DifficultyNormal[] = _("Battles similar to original games.\nRecommended for first time.");
const u8 gText_OptionDescription_DifficultyHard[] = _("Battles closer to difficult hacks.\nFor returning players.");
const u8 gText_OptionDescription_DifficultyUnfair[] = _("Unbalanced battles.\nNot recommended.");
const u8 gText_OptionDescription_ExpAll[] = _("If ON, whole party gets half Exp.\nAlso scales Exp by party level.");
const u8 gText_OptionDescription_BattleStyle[] = _("On SHIFT, you may switch for free\nwhen an opponent faints.");
const u8 gText_OptionDescription_BattleHelp[] = _("If ON, will show type matchups\nwhen facing caught species.");
const u8 gText_OptionDescription_BattleMessageWait[] = _("Text in battle will scroll after\na certain amount of time.");
const u8 gText_OptionDescription_BattleMessageButton[] = _("Text in battle will scroll only if\nyou press a button.");
const u8 gText_OptionDescription_BattleMessageBoth[] = _("Wait times can be skipped by\npressing the A or B Button.");
const u8 gText_OptionDescription_HotkeyFandango[] = _("Style for extra actions e.g. Z-moves.\nFandango uses the L and R Buttons.");
const u8 gText_OptionDescription_HotkeyExpansion[] = _("Style for extra actions e.g. Z-moves.\nDefault is the R and Start Buttons.");
const u8 gText_OptionDescription_IntroSlide[] = _("Controls the speed of the slide-in\nwhen a battle begins.");
const u8 gText_OptionDescription_BattleScene[] = _("If OFF, battle animations will\nnot play.");
const u8 gText_OptionDescription_TextSpeedFast[] = _("Text is printed at a rate of\none letter per frame.");
const u8 gText_OptionDescription_TextSpeedSuper[] = _("Text is printed at a rate of\ntwo letters per frame.");
const u8 gText_OptionDescription_TextSpeedHyper[] = _("Text is printed at a rate of\nfour letters per frame.");
const u8 gText_OptionDescription_TextScrollNormal[] = _("Text advances with the\nA or B Buttons.");
const u8 gText_OptionDescription_TextScrollDpad[] = _("Text advances with the A or B\nButtons or the Directional Pad.");
const u8 gText_OptionDescription_TextScrollHold[] = _("Text advances automatically while\nthe A or B Button is held.");
const u8 gText_OptionDescription_AutoRunOn[] = _("Player character will walk if\nthe B button is pressed.");
const u8 gText_OptionDescription_AutoRunOff[] = _("Player character will run if\nthe B button is pressed.");
const u8 gText_OptionDescription_FastHMs[] = _("Shortens the HM use sequence on\nthe overworld.");
const u8 gText_OptionDescription_FrameType[] = _("Customizes the border of some menus.");
const u8 gText_OptionDescription_ButtonMode[] = _("Set the behavior of the L Button.");
const u8 gText_OptionDescription_Sound[] = _("Set Stereo sound compatibility.");
const u8 gText_OptionDescription_Exit[] = _("Exit this menu with A or B.");
...
const u8 gText_StarterSet1[] = _("DEFAULT SET");
const u8 gText_StarterSet2[] = _("HOENN SET");
...
const u8 gText_ReadOutAbilities[] = _("ABILITIES:  {STR_VAR_2}\nHIDDEN:  {STR_VAR_3}{PAUSE_UNTIL_PRESS}");
