...
// Unused
static UNUSED void DrawMoveEffectSymbols(void)
{
    s32 i;
...
// Unused.
static UNUSED void ContestDebugTogglePointTotal(void)
{
...
// Unused.
static UNUSED void HideApplauseMeterNoAnim(void)
{
    gSprites[eContest.applauseMeterSpriteId].x2 = 0;
    gSprites[eContest.applauseMeterSpriteId].invisible = FALSE;
}
...
// Unused.
static UNUSED void ShowApplauseMeterNoAnim(void)
{
