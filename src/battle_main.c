...
// format: row->attacking type, column->defending type
// the multiplier is a (decimal) fixed-point number:
// 20 is ×2.0 TYPE_MUL_SUPER_EFFECTIVE
// 10 is ×1.0 TYPE_MUL_NORMAL
// 05 is ×0.5 TYPE_MUL_NOT_EFFECTIVE
// 00 is ×0.0 TYPE_MUL_NO_EFFECT
#define SE TYPE_MUL_SUPER_EFFECTIVE
#define NT TYPE_MUL_NORMAL
#define RS TYPE_MUL_NOT_EFFECTIVE
#define IM TYPE_MUL_NO_EFFECT
const u8 gTypeEffectiveness[NUMBER_OF_MON_TYPES][NUMBER_OF_MON_TYPES] = 
{					// NORM FIGT FLY POIS  GRND ROCK BUG  GHO  STL  FAI  FIRE WAT  GRAS ELEC PSY ICE   DRG  DRK
	[TYPE_NORMAL]	= {NT,  NT,  NT,  NT,  NT,  RS,  NT,  IM,  RS,  NT,  NT,  NT,  NT,  NT,  NT,  NT,  NT,  NT},
	[TYPE_FIGHTING]	= {SE,  NT,  RS,  RS,  NT,  SE,  RS,  IM,  SE,  RS,  NT,  NT,  NT,  NT,  RS,  SE,  NT,  SE},
	[TYPE_FLYING]	= {NT,  SE,  NT,  NT,  NT,  RS,  SE,  NT,  RS,  NT,  NT,  NT,  SE,  RS,  NT,  RS,  NT,  NT},
	[TYPE_POISON]	= {NT,  NT,  NT,  RS,  RS,  RS,  NT,  RS,  IM,  SE,  NT,  NT,  SE,  NT,  NT,  NT,  NT,  NT},
	[TYPE_GROUND]	= {NT,  NT,  IM,  SE,  NT,  SE,  RS,  NT,  SE,  NT,  SE,  NT,  RS,  SE,  NT,  RS,  NT,  NT},
	[TYPE_ROCK]		= {NT,  RS,  SE,  NT,  RS,  NT,  SE,  NT,  RS,  NT,  SE,  NT,  NT,  NT,  NT,  SE,  NT,  NT},
	[TYPE_BUG]		= {NT,  RS,  RS,  RS,  NT,  NT,  NT,  RS,  RS,  NT,  RS,  NT,  SE,  NT,  SE,  NT,  NT,  SE},
	[TYPE_GHOST]	= {IM,  NT,  NT,  NT,  NT,  NT,  NT,  SE,  RS,  NT,  NT,  NT,  NT,  NT,  SE,  NT,  NT,  RS},
	[TYPE_STEEL]	= {NT,  NT,  NT,  NT,  NT,  SE,  NT,  NT,  RS,  SE,  RS,  RS,  NT,  RS,  NT,  SE,  NT,  NT},
	[TYPE_FAIRY]	= {NT,  SE,  NT,  RS,  NT,  NT,  NT,  NT,  RS,  NT,  RS,  NT,  RS,  NT,  NT,  NT,  SE,  SE},//
	[TYPE_FIRE]		= {NT,  NT,  NT,  NT,  NT,  RS,  SE,  NT,  SE,  NT,  RS,  RS,  SE,  NT,  NT,  SE,  RS,  NT},
	[TYPE_WATER]	= {NT,  NT,  NT,  NT,  SE,  SE,  NT,  NT,  NT,  NT,  SE,  RS,  RS,  NT,  NT,  NT,  RS,  NT},
	[TYPE_GRASS]	= {NT,  NT,  RS,  RS,  SE,  SE,  RS,  NT,  RS,  NT,  RS,  SE,  RS,  NT,  NT,  NT,  RS,  NT},
	[TYPE_ELECTRIC]	= {NT,  NT,  SE,  NT,  IM,  NT,  NT,  NT,  NT,  NT,  NT,  SE,  RS,  RS,  NT,  NT,  RS,  NT},
	[TYPE_PSYCHIC]	= {NT,  SE,  NT,  SE,  NT,  NT,  NT,  NT,  RS,  NT,  NT,  NT,  NT,  NT,  RS,  NT,  NT,  IM},
	[TYPE_ICE]		= {NT,  NT,  SE,  NT,  SE,  NT,  NT,  NT,  RS,  NT,  RS,  RS,  SE,  NT,  NT,  RS,  SE,  NT},
	[TYPE_DRAGON]	= {NT,  NT,  NT,  NT,  NT,  NT,  NT,  NT,  RS,  IM,  NT,  NT,  NT,  NT,  NT,  NT,  SE,  NT},
	[TYPE_DARK]		= {NT,  RS,  NT,  NT,  NT,  NT,  NT,  SE,  RS,  RS,  NT,  NT,  NT,  NT,  SE,  NT,  NT,  RS},
};
#undef SE
#undef NT
#undef RS
...
u8 GetWhoStrikesFirst(u8 battler1, u8 battler2, bool8 ignoreChosenMoves)
{
	...
	if ((gBattleMons[battler1].status1 & STATUS1_ANY) && gBattleMons[battler1].ability == ABILITY_QUICK_FEET && !(gBattleMons[battler1].status1 & STATUS1_PARALYSIS))
		speedBattler1 = (speedBattler1 * 150) / 100;
    ...
    if ((gBattleMons[battler2].status1 & STATUS1_ANY) && gBattleMons[battler2].ability == ABILITY_QUICK_FEET && !(gBattleMons[battler2].status1 & STATUS1_PARALYSIS))
