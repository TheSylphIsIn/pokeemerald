...
static void SetDefaultOptions(void)
{
	...
	gSaveBlock2Ptr->optionsBattleHelpers = FALSE;
...
static void WarpToTruck(void)
{
    SetWarpDestination(MAP_GROUP(DROPPER_POINT), MAP_NUM(DROPPER_POINT), WARP_ID_NONE, -1, -1);
    WarpIntoMap();
}
