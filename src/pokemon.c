...
{
	HOENN_TO_NATIONAL(CACTUMBRA),
	HOENN_TO_NATIONAL(OBSICARGO),
	HOENN_TO_NATIONAL(NORWHALE),
	...
	HOENN_TO_NATIONAL(GLASMA),
	HOENN_TO_NATIONAL(PLASMOLYTE),
	HOENN_TO_NATIONAL(STORMAGE),
	HOENN_TO_NATIONAL(SANDUDE),
	HOENN_TO_NATIONAL(SANDROSS),
	HOENN_TO_NATIONAL(SANDUEL),
	HOENN_TO_NATIONAL(ELADRIFT),
	HOENN_TO_NATIONAL(SLITHURENT),
	HOENN_TO_NATIONAL(PRESCYLLON),
	HOENN_TO_NATIONAL(SLOSHMOSH),
	HOENN_TO_NATIONAL(SLURPINSKI),
	HOENN_TO_NATIONAL(KEESH),
	HOENN_TO_NATIONAL(HATCHBLING),
	HOENN_TO_NATIONAL(HUMMBLING),
	HOENN_TO_NATIONAL(KEESIGHT),
	HOENN_TO_NATIONAL(KEESPELL),
	HOENN_TO_NATIONAL(LARVOOL),
	HOENN_TO_NATIONAL(SPOOLER),
	HOENN_TO_NATIONAL(BILLIARACH),
	HOENN_TO_NATIONAL(SLUGMA_FONEI),
	HOENN_TO_NATIONAL(MAGCARGO_FONEI),
	HOENN_TO_NATIONAL(SUNFOREST),
	HOENN_TO_NATIONAL(HONEDGE_FONEI),
	HOENN_TO_NATIONAL(DOUBLADE_FONEI),
	HOENN_TO_NATIONAL(AEGISLASH_FONEI_A),
	HOENN_TO_NATIONAL(AEGISLASH_FONEI_E),
	HOENN_TO_NATIONAL(ELEMPTY),
	HOENN_TO_NATIONAL(VENEARTH),
	HOENN_TO_NATIONAL(MARSIZZLE),
	HOENN_TO_NATIONAL(JUPLASMA),
	HOENN_TO_NATIONAL(MERLPOOL),
	HOENN_TO_NATIONAL(OPHICALF),
	HOENN_TO_NATIONAL(SERPENTAUR),
	HOENN_TO_NATIONAL(GEODUDE_FONEI),
	HOENN_TO_NATIONAL(GRAVELER_FONEI),
	HOENN_TO_NATIONAL(GOLEM_FONEI),
	HOENN_TO_NATIONAL(SUDOWOODO_FONEI),
	HOENN_TO_NATIONAL(GRITWYRM),
	HOENN_TO_NATIONAL(MOLDUNE),
	HOENN_TO_NATIONAL(WATTITUDE),
	HOENN_TO_NATIONAL(RALTS_FONEI),
	HOENN_TO_NATIONAL(KIRLIA_FONEI),
	HOENN_TO_NATIONAL(GARDEVOIR_FONEI),
	HOENN_TO_NATIONAL(GALLADE_FONEI),
	HOENN_TO_NATIONAL(TRUEBAT),
	HOENN_TO_NATIONAL(HOMBONE),
	HOENN_TO_NATIONAL(HOMBEAST),
	HOENN_TO_NATIONAL(QWILSHARK),
	HOENN_TO_NATIONAL(KRISSY),
	HOENN_TO_NATIONAL(KRAKODEMON),
	HOENN_TO_NATIONAL(WEATHERBANE),
	HOENN_TO_NATIONAL(KETSUBAN),
	HOENN_TO_NATIONAL(DISABY),
	HOENN_TO_NATIONAL(DISASPRITE),
	HOENN_TO_NATIONAL(DISMASTER),
	HOENN_TO_NATIONAL(PURIDIAN),
	HOENN_TO_NATIONAL(MANIPULO),
	HOENN_TO_NATIONAL(COILSPILL),
	HOENN_TO_NATIONAL(BOOWHO),
	HOENN_TO_NATIONAL(BOOXER),
	HOENN_TO_NATIONAL(BOOZERKER),
	HOENN_TO_NATIONAL(DEEPDARK),
	HOENN_TO_NATIONAL(BURMITE),
	HOENN_TO_NATIONAL(SEDIMETAL),
	HOENN_TO_NATIONAL(SOLOSIS_FONEI),
	HOENN_TO_NATIONAL(DUOSION_FONEI),
	HOENN_TO_NATIONAL(REUNICLUS_FONEI),
	HOENN_TO_NATIONAL(VINOS),
	HOENN_TO_NATIONAL(VINOCEIVER),
	HOENN_TO_NATIONAL(ANNOYIDGE),
	HOENN_TO_NATIONAL(PESQUITO),
	HOENN_TO_NATIONAL(MANKEY_FONEI),
	HOENN_TO_NATIONAL(PRIMEAPE_FONEI),
	HOENN_TO_NATIONAL(CRYOGONAL_FONEI),
	HOENN_TO_NATIONAL(AMPIBOISON),
	HOENN_TO_NATIONAL(LAGNET),
	HOENN_TO_NATIONAL(LANNET),
	HOENN_TO_NATIONAL(CYBURN),
	HOENN_TO_NATIONAL(SAPNOSE),
	HOENN_TO_NATIONAL(BURROOT),
	HOENN_TO_NATIONAL(BURRUSH),
	HOENN_TO_NATIONAL(LAV),
	HOENN_TO_NATIONAL(LAVALY),
	HOENN_TO_NATIONAL(LAVSAMUCH),
	HOENN_TO_NATIONAL(GUPPAGE),
	HOENN_TO_NATIONAL(SEAGE),
	HOENN_TO_NATIONAL(BASSTION),
	HOENN_TO_NATIONAL(PANTOM),
	HOENN_TO_NATIONAL(HAPPANING),
	HOENN_TO_NATIONAL(PANZERGAST),
	HOENN_TO_NATIONAL(SCAIRY),
	HOENN_TO_NATIONAL(DANKLIMMER),
	HOENN_TO_NATIONAL(GOLICHEM),
	HOENN_TO_NATIONAL(SPINDA_FONEI),
	HOENN_TO_NATIONAL(EMUNITION),
	HOENN_TO_NATIONAL(EMORTAR),
	HOENN_TO_NATIONAL(OPEBBLISK),
	HOENN_TO_NATIONAL(STONUMENT),
	HOENN_TO_NATIONAL(MEMOIRBLE),
	HOENN_TO_NATIONAL(NOKOMMON),
	HOENN_TO_NATIONAL(TANGHOUL),
	HOENN_TO_NATIONAL(QWILYU),
	HOENN_TO_NATIONAL(CORILIA),
	HOENN_TO_NATIONAL(NIDOROOK),
	HOENN_TO_NATIONAL(SKALVENGER),
	HOENN_TO_NATIONAL(SKULKREX),
	HOENN_TO_NATIONAL(SKELTYRANT),
...
#include "data/pokemon/level_up_learnsets/fandango.h"
	...
	switch (item)
	{
		case ITEM_ABILITY_PILL:
			switch (abilityNum)
			{
				case 0: // if the mon has a second ability, pill can be used.
					if (gSpeciesInfo[GetMonData(mon, MON_DATA_SPECIES, NULL)].abilities[1] != 0)
						return TRUE;
					break;
				...
				case 3: // so, to avoid pill waste, you can't use a normal pill on a hidden ability mon
					if (gSpeciesInfo[GetMonData(mon, MON_DATA_SPECIES, NULL)].abilities[3] != // if both hidden slots have
						gSpeciesInfo[GetMonData(mon, MON_DATA_SPECIES, NULL)].abilities[2]) // the same ability in them.
						return TRUE;
					break;
				default:
					break;
		...
		case ITEM_DREAM_PILL:
			switch (abilityNum)
			{
				...
				case 1:
					if (gSpeciesInfo[GetMonData(mon, MON_DATA_SPECIES, NULL)].abilities[2] != 0)
						return TRUE;
					break;
...
static UNUSED u8 GetOwnOpposingLinkMultiBattlerId(bool8 rightSide)
{
    s32 i;
    s32 battlerId = 0;
