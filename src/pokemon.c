...
static const u16 sSpeciesToHoennPokedexNum[NUM_SPECIES - 1] =
{
	...
	SPECIES_TO_HOENN(GORELAX),
	SPECIES_TO_HOENN(SHINIGAMI),
	SPECIES_TO_HOENN(ANTISPIRAL),
	SPECIES_TO_HOENN(DRAGON),
	SPECIES_TO_HOENN(AMONSTER),
	SPECIES_TO_HOENN(FANGASU),
	SPECIES_TO_HOENN(NIGERA),
	SPECIES_TO_HOENN(KURIPUTO),
	SPECIES_TO_HOENN(ROODANSE),
	SPECIES_TO_HOENN(OOSHE),
	SPECIES_TO_HOENN(GOOSUBOA),
	SPECIES_TO_HOENN(ROCLOBSTER),
	SPECIES_TO_HOENN(X32763),
	SPECIES_TO_HOENN(TELSON),
	SPECIES_TO_HOENN(MAGNEZONE),
	SPECIES_TO_HOENN(VIGOURLAN),
	SPECIES_TO_HOENN(DIAMANDIX),
	SPECIES_TO_HOENN(GIGAWOLF),
	SPECIES_TO_HOENN(GALACTIMON),
	SPECIES_TO_HOENN(QWILSHARK),
	SPECIES_TO_HOENN(DRAGOONE),
	SPECIES_TO_HOENN(CALFBY),
	SPECIES_TO_HOENN(RAMSHAKER),
	SPECIES_TO_HOENN(SEVICIOUS),
	SPECIES_TO_HOENN(ZANGOL),
	SPECIES_TO_HOENN(PSYPIG),
	SPECIES_TO_HOENN(MUNCHLAX),
	SPECIES_TO_HOENN(SKYLAX),
	SPECIES_TO_HOENN(MYSTERYEGG),
	SPECIES_TO_HOENN(SECRETEGG),
	SPECIES_TO_HOENN(HYPEREGG),
	SPECIES_TO_HOENN(HOMBONE),
	SPECIES_TO_HOENN(HOMBEAST),
	SPECIES_TO_HOENN(KENCHIRA),
	SPECIES_TO_HOENN(KENCHUKO),
	SPECIES_TO_HOENN(GLUTE),
	SPECIES_TO_HOENN(BUTE),
	SPECIES_TO_HOENN(NUTE),
	SPECIES_TO_HOENN(FURI_X),
	SPECIES_TO_HOENN(FURI_Z),
	SPECIES_TO_HOENN(FURI_Q),
	SPECIES_TO_HOENN(TURMUR),
	SPECIES_TO_HOENN(SHADERU),
	SPECIES_TO_HOENN(FACELEECH),
	SPECIES_TO_HOENN(LUCA_ZAMON),
	SPECIES_TO_HOENN(TEA_BARCAN),
	SPECIES_TO_HOENN(MINICE),
	SPECIES_TO_HOENN(MINIROCK),
	SPECIES_TO_HOENN(MINISTEEL),
	SPECIES_TO_HOENN(GENEROBO),
};
...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
	...
	SPECIES_TO_NATIONAL(GORELAX),
	SPECIES_TO_NATIONAL(SHINIGAMI),
	SPECIES_TO_NATIONAL(ANTISPIRAL),
	SPECIES_TO_NATIONAL(DRAGON),
	SPECIES_TO_NATIONAL(AMONSTER),
	SPECIES_TO_NATIONAL(FANGASU),
	SPECIES_TO_NATIONAL(NIGERA),
	SPECIES_TO_NATIONAL(KURIPUTO),
	SPECIES_TO_NATIONAL(ROODANSE),
	SPECIES_TO_NATIONAL(OOSHE),
	SPECIES_TO_NATIONAL(GOOSUBOA),
	SPECIES_TO_NATIONAL(ROCLOBSTER),
	SPECIES_TO_NATIONAL(X32763),
	SPECIES_TO_NATIONAL(TELSON),
	SPECIES_TO_NATIONAL(MAGNEZONE),
	SPECIES_TO_NATIONAL(VIGOURLAN),
	SPECIES_TO_NATIONAL(DIAMANDIX),
	SPECIES_TO_NATIONAL(GIGAWOLF),
	SPECIES_TO_NATIONAL(GALACTIMON),
	SPECIES_TO_NATIONAL(QWILSHARK),
	SPECIES_TO_NATIONAL(DRAGOONE),
	SPECIES_TO_NATIONAL(CALFBY),
	SPECIES_TO_NATIONAL(RAMSHAKER),
	SPECIES_TO_NATIONAL(SEVICIOUS),
	SPECIES_TO_NATIONAL(ZANGOL),
	SPECIES_TO_NATIONAL(PSYPIG),
	SPECIES_TO_NATIONAL(MUNCHLAX),
	SPECIES_TO_NATIONAL(SKYLAX),
	SPECIES_TO_NATIONAL(MYSTERYEGG),
	SPECIES_TO_NATIONAL(SECRETEGG),
	SPECIES_TO_NATIONAL(HYPEREGG),
	SPECIES_TO_NATIONAL(HOMBONE),
	SPECIES_TO_NATIONAL(HOMBEAST),
	SPECIES_TO_NATIONAL(KENCHIRA),
	SPECIES_TO_NATIONAL(KENCHUKO),
	SPECIES_TO_NATIONAL(GLUTE),
	SPECIES_TO_NATIONAL(BUTE),
	SPECIES_TO_NATIONAL(NUTE),
	SPECIES_TO_NATIONAL(FURI_X),
	SPECIES_TO_NATIONAL(FURI_Z),
	SPECIES_TO_NATIONAL(FURI_Q),
	SPECIES_TO_NATIONAL(TURMUR),
	SPECIES_TO_NATIONAL(SHADERU),
	SPECIES_TO_NATIONAL(FACELEECH),
	SPECIES_TO_NATIONAL(LUCA_ZAMON),
	SPECIES_TO_NATIONAL(TEA_BARCAN),
	SPECIES_TO_NATIONAL(MINICE),
	SPECIES_TO_NATIONAL(MINIROCK),
	SPECIES_TO_NATIONAL(MINISTEEL),
	SPECIES_TO_NATIONAL(GENEROBO),
};
...
static const u16 sHoennToNationalOrder[NUM_SPECIES - 1] =
{
	...
	HOENN_TO_NATIONAL(GORELAX),
	HOENN_TO_NATIONAL(SHINIGAMI),
	HOENN_TO_NATIONAL(ANTISPIRAL),
	HOENN_TO_NATIONAL(DRAGON),
	HOENN_TO_NATIONAL(AMONSTER),
	HOENN_TO_NATIONAL(FANGASU),
	HOENN_TO_NATIONAL(NIGERA),
	HOENN_TO_NATIONAL(KURIPUTO),
	HOENN_TO_NATIONAL(ROODANSE),
	HOENN_TO_NATIONAL(OOSHE),
	HOENN_TO_NATIONAL(GOOSUBOA),
	HOENN_TO_NATIONAL(ROCLOBSTER),
	HOENN_TO_NATIONAL(X32763),
	HOENN_TO_NATIONAL(TELSON),
	HOENN_TO_NATIONAL(MAGNEZONE),
	HOENN_TO_NATIONAL(VIGOURLAN),
	HOENN_TO_NATIONAL(DIAMANDIX),
	HOENN_TO_NATIONAL(GIGAWOLF),
	HOENN_TO_NATIONAL(GALACTIMON),
	HOENN_TO_NATIONAL(QWILSHARK),
	HOENN_TO_NATIONAL(DRAGOONE),
	HOENN_TO_NATIONAL(CALFBY),
	HOENN_TO_NATIONAL(RAMSHAKER),
	HOENN_TO_NATIONAL(SEVICIOUS),
	HOENN_TO_NATIONAL(ZANGOL),
	HOENN_TO_NATIONAL(PSYPIG),
	HOENN_TO_NATIONAL(MUNCHLAX),
	HOENN_TO_NATIONAL(SKYLAX),
	HOENN_TO_NATIONAL(MYSTERYEGG),
	HOENN_TO_NATIONAL(SECRETEGG),
	HOENN_TO_NATIONAL(HYPEREGG),
	HOENN_TO_NATIONAL(HOMBONE),
	HOENN_TO_NATIONAL(HOMBEAST),
	HOENN_TO_NATIONAL(KENCHIRA),
	HOENN_TO_NATIONAL(KENCHUKO),
	HOENN_TO_NATIONAL(GLUTE),
	HOENN_TO_NATIONAL(BUTE),
	HOENN_TO_NATIONAL(NUTE),
	HOENN_TO_NATIONAL(FURI_X),
	HOENN_TO_NATIONAL(FURI_Z),
	HOENN_TO_NATIONAL(FURI_Q),
	HOENN_TO_NATIONAL(TURMUR),
	HOENN_TO_NATIONAL(SHADERU),
	HOENN_TO_NATIONAL(FACELEECH),
	HOENN_TO_NATIONAL(LUCA_ZAMON),
	HOENN_TO_NATIONAL(TEA_BARCAN),
	HOENN_TO_NATIONAL(MINICE),
	HOENN_TO_NATIONAL(MINIROCK),
	HOENN_TO_NATIONAL(MINISTEEL),
	HOENN_TO_NATIONAL(GENEROBO),
...
static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
	...
	[SPECIES_GORELAX- 1]	= ANIM_H_SHAKE,
	[SPECIES_SHINIGAMI- 1]	= ANIM_H_SHAKE,
	[SPECIES_ANTISPIRAL- 1]	= ANIM_H_SHAKE,
	[SPECIES_DRAGON- 1]	= ANIM_H_SHAKE,
	[SPECIES_AMONSTER- 1]	= ANIM_H_SHAKE,
	[SPECIES_FANGASU- 1]	= ANIM_H_SHAKE,
	[SPECIES_NIGERA- 1]	= ANIM_H_SHAKE,
	[SPECIES_KURIPUTO- 1]	= ANIM_H_SHAKE,
	[SPECIES_ROODANSE- 1]	= ANIM_H_SHAKE,
	[SPECIES_OOSHE- 1]	= ANIM_H_SHAKE,
	[SPECIES_GOOSUBOA- 1]	= ANIM_H_SHAKE,
	[SPECIES_ROCLOBSTER- 1]	= ANIM_H_SHAKE,
	[SPECIES_X32763- 1]	= ANIM_H_SHAKE,
	[SPECIES_TELSON- 1]	= ANIM_H_SHAKE,
	[SPECIES_MAGNEZONE- 1]	= ANIM_H_SHAKE,
	[SPECIES_VIGOURLAN- 1]	= ANIM_H_JUMPS,
	[SPECIES_DIAMANDIX- 1]	= ANIM_H_SHAKE,
	[SPECIES_GIGAWOLF- 1]	= ANIM_V_SHAKE,
	[SPECIES_GALACTIMON- 1]	= ANIM_H_SHAKE,
	[SPECIES_QWILSHARK- 1]	= ANIM_H_SHAKE,
	[SPECIES_DRAGOONE- 1]	= ANIM_GROW_VIBRATE,
	[SPECIES_CALFBY- 1]	= ANIM_H_SHAKE,
	[SPECIES_RAMSHAKER- 1]	= ANIM_H_SHAKE,
	[SPECIES_SEVICIOUS- 1]	= ANIM_H_SHAKE,
	[SPECIES_ZANGOL- 1]	= ANIM_H_SHAKE,
	[SPECIES_PSYPIG- 1]	= ANIM_H_SHAKE,
	[SPECIES_MUNCHLAX- 1]	= ANIM_H_SHAKE,
	[SPECIES_SKYLAX- 1]	= ANIM_H_SHAKE,
	[SPECIES_MYSTERYEGG- 1]	= ANIM_V_SHAKE,
	[SPECIES_SECRETEGG- 1]	= ANIM_V_SHAKE,
	[SPECIES_HYPEREGG- 1]	= ANIM_V_SHAKE,
	[SPECIES_HOMBONE- 1]	= ANIM_V_SHAKE_TWICE,
	[SPECIES_HOMBEAST- 1]	= ANIM_V_SHAKE_TWICE,
	[SPECIES_KENCHIRA- 1]	= ANIM_H_SHAKE,
	[SPECIES_KENCHUKO- 1]	= ANIM_H_SHAKE,
	[SPECIES_GLUTE- 1]	= ANIM_H_SHAKE,
	[SPECIES_BUTE- 1]	= ANIM_H_SHAKE,
	[SPECIES_NUTE- 1]	= ANIM_H_SHAKE,
	[SPECIES_FURI_X- 1]	= ANIM_H_SHAKE,
	[SPECIES_FURI_Z- 1]	= ANIM_H_SHAKE,
	...
	[SPECIES_MINICE- 1]	= ANIM_FOUR_PETAL,
	[SPECIES_MINIROCK- 1]	= ANIM_H_SHAKE,
	[SPECIES_MINISTEEL- 1]	= ANIM_H_SHAKE,
	[SPECIES_GENEROBO- 1]	= ANIM_H_SHAKE,
};
...
s32 CalculateBaseDamage(struct BattlePokemon *attacker, struct BattlePokemon *defender, u32 move, u16 sideStatus, u16 powerOverride, u8 typeOverride, u8 battlerIdAtk, u8 battlerIdDef)
{
    ...
    if (attacker->ability == ABILITY_MINUS && ABILITY_ON_FIELD2(ABILITY_PLUS))
        spAttack = (150 * spAttack) / 100;
	if (IS_BATTLER_OF_TYPE(gBattlerAttacker, TYPE_ELECTRIC) && ABILITY_ON_FIELD2(ABILITY_GENERATOR))
...
u16 GetBattleBGM(void)
{
    ...
    else if (gBattleTypeFlags & BATTLE_TYPE_TRAINER)
    {
		...
		case TRAINER_CLASS_GHOST_GIRL:
		case TRAINER_CLASS_ZOMBIE_KID:
		case TRAINER_CLASS_DEMON_CORPSE:
