...
static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_BUTTERFREE - 1]  = ANIM_FLASH_YELLOW,
    ...
    [SPECIES_WEEPINBELL - 1]  = ANIM_H_SLIDE_WOBBLE,
    ...
    [SPECIES_TAILLOW - 1]     = ANIM_H_SLIDE_WOBBLE,
    ...
    [SPECIES_LUNATONE - 1]    = ANIM_H_SHAKE_SLOW,
    [SPECIES_SOLROCK - 1]     = ANIM_H_SHAKE_SLOW,
    ...
    [SPECIES_ABSOL - 1]       = ANIM_GROW_IN_STAGES,
