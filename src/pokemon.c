...
static u16 ApplyAbility(struct BattlePokemon *mon, u16 stat, u8 statIndex, u8 moveType, bool8 defending);
...
static const u16 sSpeciesToHoennPokedexNum[NUM_SPECIES - 1] =
{
	...
	SPECIES_TO_HOENN(CACTUMBRA),
	SPECIES_TO_HOENN(OBSICARGO),
	SPECIES_TO_HOENN(NORWHALE),
	...
	SPECIES_TO_HOENN(GLASMA),
	SPECIES_TO_HOENN(PLASMOLYTE),
	SPECIES_TO_HOENN(STORMAGE),
	SPECIES_TO_HOENN(SANDUDE),
	SPECIES_TO_HOENN(SANDROSS),
	SPECIES_TO_HOENN(SANDUEL),
	SPECIES_TO_HOENN(ELADRIFT),
	SPECIES_TO_HOENN(SLITHURENT),
	SPECIES_TO_HOENN(PRESCYLLON),
	SPECIES_TO_HOENN(SLOSHMOSH),
	SPECIES_TO_HOENN(SLURPINSKI),
	SPECIES_TO_HOENN(KEESH),
	SPECIES_TO_HOENN(HATCHBLING),
	SPECIES_TO_HOENN(HUMMBLING),
	SPECIES_TO_HOENN(KEESIGHT),
	SPECIES_TO_HOENN(KEESPELL),
	SPECIES_TO_HOENN(LARVOOL),
	SPECIES_TO_HOENN(SPOOLER),
	SPECIES_TO_HOENN(BILLIARACH),
	SPECIES_TO_HOENN(SLUGMA_FONEI),
	SPECIES_TO_HOENN(MAGCARGO_FONEI),
	SPECIES_TO_HOENN(SUNFOREST),
	SPECIES_TO_HOENN(HONEDGE_FONEI),
	SPECIES_TO_HOENN(DOUBLADE_FONEI),
	SPECIES_TO_HOENN(AEGISLASH_FONEI_A),
	SPECIES_TO_HOENN(AEGISLASH_FONEI_E),
	SPECIES_TO_HOENN(ELEMPTY),
	SPECIES_TO_HOENN(VENEARTH),
	SPECIES_TO_HOENN(MARSIZZLE),
	SPECIES_TO_HOENN(JUPLASMA),
	SPECIES_TO_HOENN(MERLPOOL),
	SPECIES_TO_HOENN(OPHICALF),
	SPECIES_TO_HOENN(SERPENTAUR),
	SPECIES_TO_HOENN(GEODUDE_FONEI),
	SPECIES_TO_HOENN(GRAVELER_FONEI),
	SPECIES_TO_HOENN(GOLEM_FONEI),
	SPECIES_TO_HOENN(SUDOWOODO_FONEI),
	SPECIES_TO_HOENN(GRITWYRM),
	SPECIES_TO_HOENN(MOLDUNE),
	SPECIES_TO_HOENN(WATTITUDE),
	SPECIES_TO_HOENN(RALTS_FONEI),
	SPECIES_TO_HOENN(KIRLIA_FONEI),
	SPECIES_TO_HOENN(GARDEVOIR_FONEI),
	SPECIES_TO_HOENN(GALLADE_FONEI),
	SPECIES_TO_HOENN(WOOBAT),
	SPECIES_TO_HOENN(SWOOBAT),
	SPECIES_TO_HOENN(TRUEBAT),
	SPECIES_TO_HOENN(HOMBONE),
	SPECIES_TO_HOENN(HOMBEAST),
	SPECIES_TO_HOENN(QWILSHARK),
	SPECIES_TO_HOENN(KRISSY),
	SPECIES_TO_HOENN(KRAKODEMON),
	SPECIES_TO_HOENN(WEATHERBANE),
	SPECIES_TO_HOENN(KETSUBAN),
	SPECIES_TO_HOENN(DISABY),
	SPECIES_TO_HOENN(DISASPRITE),
	SPECIES_TO_HOENN(DISMASTER),
	SPECIES_TO_HOENN(PURIDIAN),
	SPECIES_TO_HOENN(MANIPULO),
	SPECIES_TO_HOENN(COILSPILL),
	SPECIES_TO_HOENN(BOOWHO),
	SPECIES_TO_HOENN(BOOXER),
	SPECIES_TO_HOENN(BOOZERKER),
	SPECIES_TO_HOENN(DEEPDARK),
	SPECIES_TO_HOENN(BURMITE),
	SPECIES_TO_HOENN(SEDIMETAL),
	SPECIES_TO_HOENN(SOLOSIS_FONEI),
	SPECIES_TO_HOENN(DUOSION_FONEI),
	SPECIES_TO_HOENN(REUNICLUS_FONEI),
	SPECIES_TO_HOENN(VINOS),
	SPECIES_TO_HOENN(VINOCEIVER),
	SPECIES_TO_HOENN(ANNOYIDGE),
	SPECIES_TO_HOENN(PESQUITO),
	SPECIES_TO_HOENN(MANKEY_FONEI),
	SPECIES_TO_HOENN(PRIMEAPE_FONEI),
	SPECIES_TO_HOENN(CRYOGONAL_FONEI),
	SPECIES_TO_HOENN(AMPIBOISON),
	SPECIES_TO_HOENN(LAGNET),
	SPECIES_TO_HOENN(LANNET),
	SPECIES_TO_HOENN(CYBURN),
	SPECIES_TO_HOENN(SAPNOSE),
	SPECIES_TO_HOENN(BURROOT),
	SPECIES_TO_HOENN(BURRUSH),
	SPECIES_TO_HOENN(LAV),
	SPECIES_TO_HOENN(LAVALY),
	SPECIES_TO_HOENN(LAVSAMUCH),
	SPECIES_TO_HOENN(GUPPAGE),
	SPECIES_TO_HOENN(SEAGE),
	SPECIES_TO_HOENN(BASSTION),
	SPECIES_TO_HOENN(PANTOM),
	SPECIES_TO_HOENN(HAPPANING),
	SPECIES_TO_HOENN(PANZERGAST),
	SPECIES_TO_HOENN(SCAIRY),
	SPECIES_TO_HOENN(DANKLIMMER),
	SPECIES_TO_HOENN(GOLICHEM),
	SPECIES_TO_HOENN(SPINDA_FONEI),
	SPECIES_TO_HOENN(EMUNITION),
	SPECIES_TO_HOENN(EMORTAR),
	SPECIES_TO_HOENN(OPEBBLISK),
	SPECIES_TO_HOENN(STONUMENT),
	SPECIES_TO_HOENN(MEMOIRBLE),
	SPECIES_TO_HOENN(NOKOMMON),
	SPECIES_TO_HOENN(TANGHOUL),
	SPECIES_TO_HOENN(QWILYU),
	SPECIES_TO_HOENN(CORILIA),
	SPECIES_TO_HOENN(NIDOROOK),
	SPECIES_TO_HOENN(SKALVENGER),
	SPECIES_TO_HOENN(SKULKREX),
	SPECIES_TO_HOENN(SKELTYRANT),
...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
	...
	SPECIES_TO_NATIONAL(CACTUMBRA),
	SPECIES_TO_NATIONAL(OBSICARGO),
	SPECIES_TO_NATIONAL(NORWHALE),
	...
	SPECIES_TO_NATIONAL(GLASMA),
	SPECIES_TO_NATIONAL(PLASMOLYTE),
	SPECIES_TO_NATIONAL(STORMAGE),
	SPECIES_TO_NATIONAL(SANDUDE),
	SPECIES_TO_NATIONAL(SANDROSS),
	SPECIES_TO_NATIONAL(SANDUEL),
	SPECIES_TO_NATIONAL(ELADRIFT),
	SPECIES_TO_NATIONAL(SLITHURENT),
	SPECIES_TO_NATIONAL(PRESCYLLON),
	SPECIES_TO_NATIONAL(SLOSHMOSH),
	SPECIES_TO_NATIONAL(SLURPINSKI),
	SPECIES_TO_NATIONAL(KEESH),
	SPECIES_TO_NATIONAL(HATCHBLING),
	SPECIES_TO_NATIONAL(HUMMBLING),
	SPECIES_TO_NATIONAL(KEESIGHT),
	SPECIES_TO_NATIONAL(KEESPELL),
	SPECIES_TO_NATIONAL(LARVOOL),
	SPECIES_TO_NATIONAL(SPOOLER),
	SPECIES_TO_NATIONAL(BILLIARACH),
	SPECIES_TO_NATIONAL(SLUGMA_FONEI),
	SPECIES_TO_NATIONAL(MAGCARGO_FONEI),
	SPECIES_TO_NATIONAL(SUNFOREST),
	SPECIES_TO_NATIONAL(HONEDGE_FONEI),
	SPECIES_TO_NATIONAL(DOUBLADE_FONEI),
	SPECIES_TO_NATIONAL(AEGISLASH_FONEI_A),
	SPECIES_TO_NATIONAL(AEGISLASH_FONEI_E),
	SPECIES_TO_NATIONAL(ELEMPTY),
	SPECIES_TO_NATIONAL(VENEARTH),
	SPECIES_TO_NATIONAL(MARSIZZLE),
	SPECIES_TO_NATIONAL(JUPLASMA),
	SPECIES_TO_NATIONAL(MERLPOOL),
	SPECIES_TO_NATIONAL(OPHICALF),
	SPECIES_TO_NATIONAL(SERPENTAUR),
	SPECIES_TO_NATIONAL(GEODUDE_FONEI),
	SPECIES_TO_NATIONAL(GRAVELER_FONEI),
	SPECIES_TO_NATIONAL(GOLEM_FONEI),
	SPECIES_TO_NATIONAL(SUDOWOODO_FONEI),
	SPECIES_TO_NATIONAL(GRITWYRM),
	SPECIES_TO_NATIONAL(MOLDUNE),
	SPECIES_TO_NATIONAL(WATTITUDE),
	SPECIES_TO_NATIONAL(RALTS_FONEI),
	SPECIES_TO_NATIONAL(KIRLIA_FONEI),
	SPECIES_TO_NATIONAL(GARDEVOIR_FONEI),
	SPECIES_TO_NATIONAL(GALLADE_FONEI),
	SPECIES_TO_NATIONAL(WOOBAT),
	SPECIES_TO_NATIONAL(SWOOBAT),
	SPECIES_TO_NATIONAL(TRUEBAT),
	SPECIES_TO_NATIONAL(HOMBONE),
	SPECIES_TO_NATIONAL(HOMBEAST),
	SPECIES_TO_NATIONAL(QWILSHARK),
	SPECIES_TO_NATIONAL(KRISSY),
	SPECIES_TO_NATIONAL(KRAKODEMON),
	SPECIES_TO_NATIONAL(WEATHERBANE),
	SPECIES_TO_NATIONAL(KETSUBAN),
	SPECIES_TO_NATIONAL(DISABY),
	SPECIES_TO_NATIONAL(DISASPRITE),
	SPECIES_TO_NATIONAL(DISMASTER),
	SPECIES_TO_NATIONAL(PURIDIAN),
	SPECIES_TO_NATIONAL(MANIPULO),
	SPECIES_TO_NATIONAL(COILSPILL),
	SPECIES_TO_NATIONAL(BOOWHO),
	SPECIES_TO_NATIONAL(BOOXER),
	SPECIES_TO_NATIONAL(BOOZERKER),
	SPECIES_TO_NATIONAL(DEEPDARK),
	SPECIES_TO_NATIONAL(BURMITE),
	SPECIES_TO_NATIONAL(SEDIMETAL),
	SPECIES_TO_NATIONAL(SOLOSIS_FONEI),
	SPECIES_TO_NATIONAL(DUOSION_FONEI),
	SPECIES_TO_NATIONAL(REUNICLUS_FONEI),
	SPECIES_TO_NATIONAL(VINOS),
	SPECIES_TO_NATIONAL(VINOCEIVER),
	SPECIES_TO_NATIONAL(ANNOYIDGE),
	SPECIES_TO_NATIONAL(PESQUITO),
	SPECIES_TO_NATIONAL(MANKEY_FONEI),
	SPECIES_TO_NATIONAL(PRIMEAPE_FONEI),
	SPECIES_TO_NATIONAL(CRYOGONAL_FONEI),
	SPECIES_TO_NATIONAL(AMPIBOISON),
	SPECIES_TO_NATIONAL(LAGNET),
	SPECIES_TO_NATIONAL(LANNET),
	SPECIES_TO_NATIONAL(CYBURN),
	SPECIES_TO_NATIONAL(SAPNOSE),
	SPECIES_TO_NATIONAL(BURROOT),
	SPECIES_TO_NATIONAL(BURRUSH),
	SPECIES_TO_NATIONAL(LAV),
	SPECIES_TO_NATIONAL(LAVALY),
	SPECIES_TO_NATIONAL(LAVSAMUCH),
	SPECIES_TO_NATIONAL(GUPPAGE),
	SPECIES_TO_NATIONAL(SEAGE),
	SPECIES_TO_NATIONAL(BASSTION),
	SPECIES_TO_NATIONAL(PANTOM),
	SPECIES_TO_NATIONAL(HAPPANING),
	SPECIES_TO_NATIONAL(PANZERGAST),
	SPECIES_TO_NATIONAL(SCAIRY),
	SPECIES_TO_NATIONAL(DANKLIMMER),
	SPECIES_TO_NATIONAL(GOLICHEM),
	SPECIES_TO_NATIONAL(SPINDA_FONEI),
	SPECIES_TO_NATIONAL(EMUNITION),
	SPECIES_TO_NATIONAL(EMORTAR),
	SPECIES_TO_NATIONAL(OPEBBLISK),
	SPECIES_TO_NATIONAL(STONUMENT),
	SPECIES_TO_NATIONAL(MEMOIRBLE),
	SPECIES_TO_NATIONAL(NOKOMMON),
	SPECIES_TO_NATIONAL(TANGHOUL),
	SPECIES_TO_NATIONAL(QWILYU),
	SPECIES_TO_NATIONAL(CORILIA),
	SPECIES_TO_NATIONAL(NIDOROOK),
	SPECIES_TO_NATIONAL(SKALVENGER),
	SPECIES_TO_NATIONAL(SKULKREX),
	SPECIES_TO_NATIONAL(SKELTYRANT),
...
static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
	...
	[SPECIES_CACTUMBRA - 1]	  = ANIM_V_SHAKE,
	[SPECIES_OBSICARGO - 1]	  = ANIM_V_SHAKE,
	[SPECIES_NORWHALE - 1]	  = ANIM_V_SHAKE,
	...
	[SPECIES_GLASMA- 1]	= ANIM_H_JUMPS,
	[SPECIES_PLASMOLYTE- 1]	= ANIM_V_SHAKE,
	[SPECIES_STORMAGE- 1]	= ANIM_V_SHAKE,
	[SPECIES_SANDUDE- 1]	= ANIM_V_SHAKE,
	[SPECIES_SANDROSS- 1]	= ANIM_V_SHAKE,
	[SPECIES_SANDUEL- 1]	= ANIM_V_SHAKE,
	...
	[SPECIES_KEESPELL- 1]	= ANIM_V_SHAKE,
	[SPECIES_LARVOOL- 1]	= ANIM_V_SHAKE,
	[SPECIES_SPOOLER- 1]	= ANIM_V_SHAKE,
	[SPECIES_BILLIARACH- 1]	= ANIM_V_SHAKE,
	[SPECIES_SLUGMA_FONEI- 1]	= ANIM_V_STRETCH,
	[SPECIES_MAGCARGO_FONEI- 1]	= ANIM_V_STRETCH,
	[SPECIES_SUNFOREST- 1]	= ANIM_V_SHAKE,
	[SPECIES_HONEDGE_FONEI- 1]	= ANIM_V_SHAKE,
	[SPECIES_DOUBLADE_FONEI- 1]	= ANIM_V_SHAKE,
	[SPECIES_AEGISLASH_FONEI_A- 1]	= ANIM_V_SHAKE,
	[SPECIES_AEGISLASH_FONEI_E- 1]	= ANIM_V_SHAKE,
	[SPECIES_ELEMPTY- 1]	= ANIM_V_SHAKE,
	[SPECIES_VENEARTH- 1]	= ANIM_V_SHAKE,
	[SPECIES_MARSIZZLE- 1]	= ANIM_V_SHAKE,
	[SPECIES_JUPLASMA- 1]	= ANIM_V_SHAKE,
	[SPECIES_MERLPOOL- 1]	= ANIM_V_SHAKE,
	[SPECIES_OPHICALF- 1]	= ANIM_V_SHAKE,
	[SPECIES_SERPENTAUR- 1]	= ANIM_V_SHAKE,
	[SPECIES_GEODUDE_FONEI- 1]	= ANIM_V_SHAKE,
	[SPECIES_GRAVELER_FONEI- 1]	= ANIM_V_SHAKE,
	[SPECIES_GOLEM_FONEI- 1]	= ANIM_V_SHAKE,
	[SPECIES_SUDOWOODO_FONEI- 1]	= ANIM_V_SHAKE,
	...
	[SPECIES_RALTS_FONEI- 1]	= ANIM_H_SHAKE,
	[SPECIES_KIRLIA_FONEI- 1]	= ANIM_H_SHAKE,
	[SPECIES_GARDEVOIR_FONEI- 1]	= ANIM_H_SHAKE,
	[SPECIES_GALLADE_FONEI- 1]	= ANIM_H_SHAKE,
	[SPECIES_WOOBAT- 1]	= ANIM_H_SHAKE,
	[SPECIES_SWOOBAT- 1]	= ANIM_H_SHAKE,
	[SPECIES_TRUEBAT- 1]	= ANIM_H_SHAKE,
	[SPECIES_HOMBONE- 1]	= ANIM_H_SHAKE,
	[SPECIES_HOMBEAST- 1]	= ANIM_H_SHAKE,
	[SPECIES_QWILSHARK- 1]	= ANIM_H_SHAKE,
	[SPECIES_KRISSY- 1]	= ANIM_H_SHAKE,
	[SPECIES_KRAKODEMON- 1]	= ANIM_H_SHAKE,
	[SPECIES_WEATHERBANE- 1]	= ANIM_H_SHAKE,
	[SPECIES_KETSUBAN- 1]	= ANIM_H_SHAKE,
	[SPECIES_DISABY- 1]	= ANIM_RISING_WOBBLE,
	[SPECIES_DISASPRITE- 1]	= ANIM_H_SHAKE,
	[SPECIES_DISMASTER- 1]	= ANIM_H_SHAKE,
	[SPECIES_PURIDIAN- 1]	= ANIM_H_SHAKE,
	[SPECIES_MANIPULO- 1]	= ANIM_GROW_VIBRATE,
	[SPECIES_COILSPILL- 1]	= ANIM_H_SHAKE,
	[SPECIES_BOOWHO- 1]	= ANIM_H_SHAKE,
	[SPECIES_BOOXER- 1]	= ANIM_H_SHAKE,
	[SPECIES_BOOZERKER- 1]	= ANIM_H_SHAKE,
	[SPECIES_DEEPDARK- 1]	= ANIM_H_SHAKE,
	[SPECIES_BURMITE- 1]	= ANIM_H_SHAKE,
	[SPECIES_SEDIMETAL- 1]	= ANIM_H_SHAKE,
	[SPECIES_SOLOSIS_FONEI- 1]	= ANIM_V_SLIDE_WOBBLE,
	[SPECIES_DUOSION_FONEI- 1]	= ANIM_H_SHAKE,
	[SPECIES_REUNICLUS_FONEI- 1]	= ANIM_H_SHAKE,
	[SPECIES_VINOS- 1]	= ANIM_H_SHAKE,
	[SPECIES_VINOCEIVER- 1]	= ANIM_H_SHAKE,
	[SPECIES_ANNOYIDGE- 1]	= ANIM_H_SHAKE,
	[SPECIES_PESQUITO- 1]	= ANIM_H_SHAKE,
	[SPECIES_MANKEY_FONEI- 1]	= ANIM_H_SHAKE,
	[SPECIES_PRIMEAPE_FONEI- 1]	= ANIM_H_SHAKE,
	[SPECIES_CRYOGONAL_FONEI- 1]	= ANIM_H_SHAKE,
	[SPECIES_AMPIBOISON- 1]	= ANIM_H_SHAKE,
	[SPECIES_LAGNET- 1]	= ANIM_H_SHAKE,
	[SPECIES_LANNET- 1]	= ANIM_H_SHAKE,
	[SPECIES_CYBURN- 1]	= ANIM_H_SHAKE,
	[SPECIES_SAPNOSE- 1]	= ANIM_H_SHAKE,
	[SPECIES_BURROOT- 1]	= ANIM_H_SHAKE,
	[SPECIES_BURRUSH- 1]	= ANIM_H_SHAKE,
	[SPECIES_LAV- 1]	= ANIM_H_SHAKE,
	[SPECIES_LAVALY- 1]	= ANIM_H_SHAKE,
	[SPECIES_LAVSAMUCH- 1]	= ANIM_H_SHAKE,
	[SPECIES_GUPPAGE- 1]	= ANIM_H_SHAKE,
	[SPECIES_SEAGE- 1]	= ANIM_H_SHAKE,
	[SPECIES_BASSTION- 1]	= ANIM_H_SHAKE,
	[SPECIES_PANTOM- 1]	= ANIM_H_SHAKE,
	[SPECIES_HAPPANING- 1]	= ANIM_H_SHAKE,
	[SPECIES_PANZERGAST- 1]	= ANIM_H_SHAKE,
	[SPECIES_SCAIRY- 1]	= ANIM_H_SHAKE,
	[SPECIES_DANKLIMMER- 1]	= ANIM_H_SHAKE,
	[SPECIES_GOLICHEM- 1]	= ANIM_H_SHAKE,
	[SPECIES_SPINDA_FONEI- 1]	= ANIM_H_SHAKE,
	[SPECIES_EMUNITION- 1]	= ANIM_H_SHAKE,
	[SPECIES_EMORTAR- 1]	= ANIM_H_SHAKE,
	[SPECIES_OPEBBLISK- 1]	= ANIM_H_SHAKE,
	[SPECIES_STONUMENT- 1]	= ANIM_H_SHAKE,
	[SPECIES_MEMOIRBLE- 1]	= ANIM_H_SHAKE,
	[SPECIES_NOKOMMON- 1]	= ANIM_H_SHAKE,
	[SPECIES_TANGHOUL- 1]	= ANIM_H_SHAKE,
	[SPECIES_QWILYU- 1]	= ANIM_H_SHAKE,
	[SPECIES_CORILIA- 1]	= ANIM_H_SHAKE,
	[SPECIES_NIDOROOK- 1]	= ANIM_H_SHAKE,
	[SPECIES_SKALVENGER- 1]	= ANIM_H_SHAKE,
	[SPECIES_SKULKREX- 1]	= ANIM_H_SHAKE,
	[SPECIES_SKELTYRANT- 1]	= ANIM_H_SHAKE,
};
...
s32 CalculateBaseDamage(struct BattlePokemon *attacker, struct BattlePokemon *defender, u32 move, u16 sideStatus, u16 powerOverride, u8 typeOverride, u8 battlerIdAtk, u8 battlerIdDef)
{
	...
	// assign category from move
    category = gBattleMoves[gCurrentMove].category;
	if (category == MOVE_CATEGORY_DYNAMIC)
	{
		APPLY_STAT_MOD(damage, attacker, attacker->attack, STAT_ATK);
		APPLY_STAT_MOD(damageHelper, attacker, attacker->spAttack, STAT_SPATK);
		category = (damage > damageHelper) ? MOVE_CATEGORY_PHYSICAL : MOVE_CATEGORY_SPECIAL;
		damage = 0;
		damageHelper = 0;
	}
	
	// assign offense and defense from category
	switch (category)
	{
		case MOVE_CATEGORY_PHYSICAL:
			offense = attacker->attack;
			offenseStatIndex = STAT_ATK;
			defense = defender->defense;
			defenseStatIndex = STAT_DEF;
			break;
		case MOVE_CATEGORY_SPECIAL:
			offense = attacker->spAttack;
			offenseStatIndex = STAT_SPATK;
			defense = defender->spDefense;
			defenseStatIndex = STAT_SPDEF;
			break;
	...
	switch (gBattleMoves[move].effect)
	{
		case EFFECT_HIT_WITH_DEFENSE:
			...
			offenseStatIndex = (category == MOVE_CATEGORY_PHYSICAL) ? STAT_DEF : STAT_SPDEF;
			break;
		case EFFECT_HIT_OPPOSITE_DEFENSE:
			defense = (category == MOVE_CATEGORY_PHYSICAL) ? defender->spDefense : defender->defense;
			defenseStatIndex = (category == MOVE_CATEGORY_PHYSICAL) ? STAT_SPDEF : STAT_DEF;
			break;
		default:
			break;
	}
	...
	// apply badge boosts. kinda dumb but whatever.
    if (ShouldGetStatBadgeBoost(FLAG_BADGE01_GET, battlerIdAtk) && offenseStatIndex == STAT_ATK)
        offense = (110 * offense) / 100;
    if (ShouldGetStatBadgeBoost(FLAG_BADGE05_GET, battlerIdAtk) && offenseStatIndex == STAT_DEF)
        offense = (110 * offense) / 100;
    if (ShouldGetStatBadgeBoost(FLAG_BADGE07_GET, battlerIdAtk) && offenseStatIndex == STAT_SPATK)
        offense = (110 * offense) / 100;
    if (ShouldGetStatBadgeBoost(FLAG_BADGE07_GET, battlerIdAtk) && offenseStatIndex == STAT_SPDEF)
        offense = (110 * offense) / 100;
	
	if (ShouldGetStatBadgeBoost(FLAG_BADGE01_GET, battlerIdDef) && defenseStatIndex == STAT_ATK)
        defense = (110 * defense) / 100;
    if (ShouldGetStatBadgeBoost(FLAG_BADGE05_GET, battlerIdDef) && defenseStatIndex == STAT_DEF)
        defense = (110 * defense) / 100;
    if (ShouldGetStatBadgeBoost(FLAG_BADGE07_GET, battlerIdDef) && defenseStatIndex == STAT_SPATK)
        defense = (110 * defense) / 100;
    if (ShouldGetStatBadgeBoost(FLAG_BADGE07_GET, battlerIdDef) && defenseStatIndex == STAT_SPDEF)
        defense = (110 * defense) / 100;

	offense = ApplyAbility(attacker, offense, offenseStatIndex, type, FALSE);
	if (AbilityIsActive())
		defense = ApplyAbility(defender, defense, defenseStatIndex, type, TRUE);
	
	offense = ApplyItems(attacker, offense, attackerHoldEffect, attackerHoldEffectParam, type, offenseStatIndex, FALSE);
	defense = ApplyItems(defender, defense, defenderHoldEffect, defenderHoldEffectParam, type, defenseStatIndex, TRUE);
	
	// apply items, pass:
	// mon, item, item param, offense/defense, category, stat, defending
	...
	if (defender->ability != ABILITY_UNAWARE || !(AbilityIsActive()))
	{
		if (gCritMultiplier >= 2)
		{
			...
			if (attacker->statStages[offenseStatIndex] > DEFAULT_STAT_STAGE)
				APPLY_STAT_MOD(damage, attacker, offense, offenseStatIndex)
			else
				damage = offense;
		}
		else
	...
	// apply defender's stat atages
	if (attacker->ability != ABILITY_UNAWARE)
	{
		if (gCritMultiplier >= 2)
		{
			// Critical hit, if defender has gained defense stat stages then ignore stat increase
			if (defender->statStages[defenseStatIndex] < DEFAULT_STAT_STAGE)
				APPLY_STAT_MOD(damageHelper, defender, defense, defenseStatIndex)
			else
...
static u16 ApplyAbility(struct BattlePokemon *mon, u16 stat, u8 statIndex, u8 type, bool8 defending)
{
	u32 i = 0;
		...
		case STAT_ATK:
			switch (mon->ability)
			{
				...
				case ABILITY_SAND_FORCE:
					if (WEATHER_HAS_EFFECT2 && (gBattleWeather & B_WEATHER_SANDSTORM))
						stat = (stat * 150) / 100;
					break;
				case ABILITY_WHITEOUT:
					if (WEATHER_HAS_EFFECT2 && (gBattleWeather & B_WEATHER_HAIL))
						stat = (stat * 150) / 100;
					break;
			}
			break;
	...
	if (defending)
	{
		switch (mon->ability)
		{
			...
			case ABILITY_CACOPHONY:
				if (gBattleMoves[gCurrentMove].attribute == MOVE_ATTRIBUTE_SOUND)
					gBattleMovePower /= 2;
				break;
	...
	else
	{
		switch (mon->ability)
		{
			case ABILITY_OVERGROW:
				if (type == TYPE_GRASS && mon->hp <= (mon->maxHP / 3))
					gBattleMovePower = (gBattleMovePower * 150) / 100;
				break;
			case ABILITY_BLAZE:
				if (type == TYPE_FIRE && mon->hp <= (mon->maxHP / 3))
					gBattleMovePower = (gBattleMovePower * 150) / 100;
				break;
			case ABILITY_TORRENT:
				if (type == TYPE_WATER && mon->hp <= (mon->maxHP / 3))
					gBattleMovePower = (gBattleMovePower * 150) / 100;
				break;
			case ABILITY_SWARM:
				if (type == TYPE_BUG && mon->hp <= (mon->maxHP / 3))
					gBattleMovePower = (gBattleMovePower * 150) / 100;
				break;
			...
			case ABILITY_IRON_FIST:
				if (gBattleMoves[gCurrentMove].attribute == MOVE_ATTRIBUTE_PUNCH)
					gBattleMovePower = (130 * gBattleMovePower) / 100;
				break;
			case ABILITY_CACOPHONY:
				if (gBattleMoves[gCurrentMove].attribute == MOVE_ATTRIBUTE_SOUND)
			...
			case ABILITY_STRIKER:
				if (gBattleMoves[gCurrentMove].attribute == MOVE_ATTRIBUTE_KICK)
					gBattleMovePower = (120 * gBattleMovePower) / 100;
				break;
			case ABILITY_RECKLESS:
				if (gBattleMoves[gCurrentMove].attribute == MOVE_ATTRIBUTE_RISKY)
					gBattleMovePower = (120 * gBattleMovePower) / 100;
				break;
			...
			case ABILITY_ANALYTIC:
				if (gBattlerByTurnOrder[gBattlerAttacker] == gBattlersCount - 1)
					gBattleMovePower = (130 * gBattleMovePower) / 100;
				break;
			default:
				break;
	...
	// doesn't fit in the switches because it concerns multiple abilities
	if ((mon->ability >= ABILITIES_ATE_START && mon->ability < ABILITIES_ATE_END)
		&& type == TYPE_NORMAL)
		gBattleMovePower = (120 * gBattleMovePower) / 100;
...
static u16 ApplyItems(struct BattlePokemon *mon, u16 stat, u8 effect, u8 effectParam, u8 type, u8 statIndex, bool8 defending)
{
		...
		case STAT_ATK:
			switch (effect)
			{
				...
				case HOLD_EFFECT_LIGHT_BALL:
					if (mon->species == SPECIES_PIKACHU)
						stat *= 2;
					break;
				case HOLD_EFFECT_THICK_CLUB:
					if ((mon->species == SPECIES_CUBONE || mon->species == SPECIES_MAROWAK))
						stat *= 2;
					break;
			}
			break;
		...
		case STAT_SPATK:
			switch (effect)
			{
				...
				case HOLD_EFFECT_SOUL_DEW:
					if ((mon->species == SPECIES_LATIAS || mon->species == SPECIES_LATIOS))
						stat = (stat * 150) / 100;
					break;
				case HOLD_EFFECT_DEEP_SEA_TOOTH:
					if (mon->species == SPECIES_CLAMPERL)
						stat *= 2;
					break;
				case HOLD_EFFECT_LIGHT_BALL:
					if (mon->species == SPECIES_PIKACHU)
	...
	// items that always apply
	if (defending)
	{
		switch (effect)
		{
			case HOLD_EFFECT_EVIOLITE:
				if (gEvolutionTable[mon->species][0].method != 0
	...
	else
	{
		switch (effect)
		{
			case HOLD_EFFECT_LIFE_ORB:
				...
				break;
			case HOLD_EFFECT_RAGE_BAND:
				if (mon->hp <= (mon->maxHP / 20))
					gBattleMovePower = (150 * gBattleMovePower) / 100;
				else if (mon->hp <= (mon->maxHP / 5))
					gBattleMovePower = (135 * gBattleMovePower) / 100;
				else if (mon->hp <= (mon->maxHP / 2))
					gBattleMovePower = (120 * gBattleMovePower) / 100;
				break;
