...
static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
	...
	[SPECIES_MYSTERYEGG- 1]	= ANIM_BOUNCE_ROTATE_TO_SIDES,
	[SPECIES_SECRETEGG- 1]	= ANIM_H_SHAKE,
	[SPECIES_HYPEREGG- 1]	= ANIM_H_SHAKE,
