...
bool32 CanBeParalyzed(u32 battler)
{
    ...
    if ((B_PARALYZE_ELECTRIC >= GEN_6 && IS_BATTLER_OF_TYPE(battler, TYPE_ELECTRIC) && moveType == TYPE_ELECTRIC)
        || gSideStatuses[GetBattlerSide(battler)] & SIDE_STATUS_SAFEGUARD
...
bool32 IsMoveMakingContact(u32 move, u32 battlerAtk)
{
    ...
    {
        if (gMovesInfo[move].effect == EFFECT_SHELL_SIDE_ARM && gBattleStruct->dynamicCategory == DAMAGE_CATEGORY_PHYSICAL)
            return TRUE;
        else
            return FALSE;
    }
...
bool32 IsBattlerProtected(u32 battler, u32 move)
{
    ...
    if (GetBattlerAbility(gBattlerAttacker) == ABILITY_UNSEEN_FIST
        && (gMovesInfo[move].makesContact || (gMovesInfo[move].effect == EFFECT_SHELL_SIDE_ARM && gBattleStruct->dynamicCategory == DAMAGE_CATEGORY_PHYSICAL))
...
static inline u32 CalcAttackStat(u32 move, u32 battlerAtk, u32 battlerDef, u32 moveType, bool32 isCrit, bool32 updateFlags, u32 atkAbility, u32 defAbility, u32 holdEffectAtk)
{
	...
	if (gMovesInfo[move].category == DAMAGE_CATEGORY_DYNAMIC)
		gBattleStruct->dynamicCategory = (GetCategoryBasedOnStats(battlerAtk));
...
static inline void MulByTypeEffectiveness(uq4_12_t *modifier, u32 move, u32 moveType, u32 battlerDef, u32 defType, u32 battlerAtk, bool32 recordAbilities)
{
    ...
    if (moveType == TYPE_PSYCHIC && defType == TYPE_DARK && gStatuses3[battlerDef] & STATUS3_MIRACLE_EYED && mod == UQ_4_12(0.0))
        mod = UQ_4_12(1.0);
    if (gMovesInfo[move].effect == EFFECT_SE_ON_ARG_TYPE && defType == gMovesInfo[move].argument)
        mod = UQ_4_12(2.0);
...
u8 GetBattleMoveCategory(u32 moveId)
{
    ...
    if (gBattleStruct != NULL && gMovesInfo[moveId].category == DAMAGE_CATEGORY_DYNAMIC) // Photon Geyser, Shell Side Arm, Light That Burns the Sky
