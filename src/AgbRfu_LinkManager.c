...
static UNUSED void rfu_LMAN_PARENT_stopWaitLinkRecoveryAndDisconnect(u8 bm_targetSlot)
{
    u8 i;
...
static UNUSED void rfu_LMAN_setLMANCallback(void (*func)(u8, u8))
{
...
static UNUSED u8 rfu_LMAN_setNIFailCounterLimit(u16 NI_failCounter_limit)
{
...
static UNUSED u8 rfu_LMAN_setFastSearchParent(u8 enable_flag)
{
