...
// Unused
static UNUSED u8 RouletteFlash_Remove(struct RouletteFlashUtil *flash, u8 id)
{
...
static UNUSED void FillTilemapRect_Unused(void *dest, u16 value, u8 left, u8 top, u8 width, u8 height)
{
    u8 i, j;
    u8 x, y;
...
static UNUSED void SetTilemapRect_Unused(void *dest, const u16 *src, u8 left, u8 top, u8 width, u8 height)
{
    u8 i, j;
    u8 x, y;
    const u16 *_src;
