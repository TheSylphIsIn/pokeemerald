...
const u32 gMonFrontPic_CastformSunny[] = INCBIN_U32("graphics/pokemon/castform_sunny/anim_front_sunny_form.4bpp.lz");
const u32 gMonFrontPic_CastformRainy[] = INCBIN_U32("graphics/pokemon/castform_rainy/anim_front_rainy_form.4bpp.lz");
const u32 gMonFrontPic_CastformSnowy[] = INCBIN_U32("graphics/pokemon/castform_snowy/anim_front_snowy_form.4bpp.lz");
