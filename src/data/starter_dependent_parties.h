...
static const struct TrainerMonItemCustomMoves * const sStarterDependentParties[STARTER_MON_COUNT][STARTER_SET_COUNT][STARTER_DEPENDENT_PARTIES_COUNT] = {
	[STARTER_MON_0] = {
		[STARTER_SET_FONEI] = {
...
static const struct TrainerMonItemCustomMoves * const sHardStarterDependentParties[STARTER_MON_COUNT][STARTER_SET_COUNT][STARTER_DEPENDENT_PARTIES_COUNT] = {
	[STARTER_MON_0] = {
		[STARTER_SET_FONEI] = {
...
static const struct TrainerMonItemCustomMoves * const sUnfairStarterDependentParties[STARTER_MON_COUNT][STARTER_SET_COUNT][STARTER_DEPENDENT_PARTIES_COUNT] = {
	[STARTER_MON_0] = {
		[STARTER_SET_FONEI] = {
