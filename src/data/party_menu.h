...
const u16 sDemiveeFormChangeData[8][7] = // 4 base moves; 2 learned moves; ability override
{
//	[SPECIES_EEVEE - SPECIES_EEVEE] = {MOVE_TAKE_DOWN, MOVE_BITE, MOVE_COPYCAT, MOVE_QUICK_ATTACK, MOVE_TRUMP_CARD, MOVE_HYPER_BEAM},
	[SPECIES_DEMIVEE_WATER - SPECIES_DEMIVEE_WATER] = {MOVE_WATER_PULSE, MOVE_DEFENSE_CURL, MOVE_MUDDY_WATER, MOVE_MUD_SHOT, MOVE_HYDRO_PUMP, MOVE_AQUA_RING, ABILITY_HYDRATION},
	[SPECIES_DEMIVEE_ELECTRIC - SPECIES_DEMIVEE_WATER] = {MOVE_SHOCK_WAVE, MOVE_SWIFT, MOVE_THUNDER_WAVE, MOVE_SAND_ATTACK, MOVE_THUNDER, MOVE_LIGHT_SCREEN, ABILITY_SPEED_BOOST},
	[SPECIES_DEMIVEE_FIRE - SPECIES_DEMIVEE_WATER] = {MOVE_FLAME_WHEEL, MOVE_DOUBLE_KICK, MOVE_DOUBLE_EDGE, MOVE_MEDITATE, MOVE_FLARE_BLITZ, MOVE_REST, ABILITY_CLOUD_NINE},
	[SPECIES_DEMIVEE_PSYCHIC - SPECIES_DEMIVEE_WATER] = {MOVE_PSYBEAM, MOVE_MIRACLE_EYE, MOVE_AGILITY, MOVE_SHADOW_BALL, MOVE_PSYCHIC, MOVE_REFLECT, ABILITY_MAGIC_GUARD},
	[SPECIES_DEMIVEE_DARK - SPECIES_DEMIVEE_WATER] = {MOVE_BITE, MOVE_SCREECH, MOVE_CONFUSE_RAY, MOVE_PROTECT, MOVE_ACID_SPRAY, MOVE_PARTING_SHOT, ABILITY_SERENE_GRACE},
	[SPECIES_DEMIVEE_GRASS - SPECIES_DEMIVEE_WATER] = {MOVE_RAZOR_LEAF, MOVE_SLASH, MOVE_TAIL_WHIP, MOVE_FURY_CUTTER, MOVE_SEED_BOMB, MOVE_STRENGTH_SAP, ABILITY_EFFECT_SPORE},
	[SPECIES_DEMIVEE_ICE - SPECIES_DEMIVEE_WATER] = {MOVE_ICY_WIND, MOVE_CONFIDE, MOVE_HAIL, MOVE_FREEZE_DRY, MOVE_ICE_BEAM, MOVE_AURORA_VEIL, ABILITY_ICE_BODY},
	[SPECIES_DEMIVEE_FAIRY - SPECIES_DEMIVEE_WATER] = {MOVE_DRAINING_KISS, MOVE_HYPER_VOICE, MOVE_RECOVER, MOVE_NOBLE_ROAR, MOVE_MOONBLAST, MOVE_WISH, ABILITY_NATURAL_CURE},
};
