...
static const u16 sDemiveeFormChangeMoves[9][9] = // lv30 (base) move, lv40 move, lv50 move
{
	[SPECIES_EEVEE - SPECIES_EEVEE] = {MOVE_TAKE_DOWN, MOVE_BITE, MOVE_COPYCAT, MOVE_QUICK_ATTACK, MOVE_TRUMP_CARD, MOVE_HYPER_BEAM},
	[SPECIES_DEMIVEE_WATER - SPECIES_EEVEE] = {MOVE_WATER_PULSE, MOVE_DEFENSE_CURL, MOVE_MUDDY_WATER, MOVE_MUD_SHOT, MOVE_HYDRO_PUMP, MOVE_HEAL_BELL},
	[SPECIES_DEMIVEE_ELECTRIC - SPECIES_EEVEE] = {MOVE_SHOCK_WAVE, MOVE_SWIFT, MOVE_THUNDER_WAVE, MOVE_SAND_ATTACK, MOVE_THUNDER, MOVE_LIGHT_SCREEN},
	[SPECIES_DEMIVEE_FIRE - SPECIES_EEVEE] = {MOVE_FLAME_WHEEL, MOVE_DOUBLE_KICK, MOVE_DOUBLE_EDGE, MOVE_MEDITATE, MOVE_FLARE_BLITZ, MOVE_REST},
	[SPECIES_DEMIVEE_PSYCHIC - SPECIES_EEVEE] = {MOVE_PSYBEAM, MOVE_MIRACLE_EYE, MOVE_AGILITY, MOVE_SHADOW_BALL, MOVE_PSYCHIC, MOVE_REFLECT},
	[SPECIES_DEMIVEE_DARK - SPECIES_EEVEE] = {MOVE_FAINT_ATTACK, MOVE_SCREECH, MOVE_CONFUSE_RAY, MOVE_FAKE_TEARS, MOVE_TOXIC, MOVE_PARTING_SHOT},
	[SPECIES_DEMIVEE_GRASS - SPECIES_EEVEE] = {MOVE_RAZOR_LEAF, MOVE_SLASH, MOVE_TAIL_WHIP, MOVE_FURY_CUTTER, MOVE_LEAF_BLADE, MOVE_LEECH_SEED},
	[SPECIES_DEMIVEE_ICE - SPECIES_EEVEE] = {MOVE_ICY_WIND, MOVE_CONFIDE, MOVE_HAIL, MOVE_FREEZE_DRY, MOVE_ICE_BEAM, MOVE_AURORA_VEIL},
	[SPECIES_DEMIVEE_FAIRY - SPECIES_EEVEE] = {MOVE_DRAINING_KISS, MOVE_HYPER_VOICE, MOVE_RECOVER, MOVE_NOBLE_ROAR, MOVE_MOONBLAST, MOVE_WISH},
};
