...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_StarPiece;
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_AltaMemberM;
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_AltaMemberF;
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Bard;
