...
static const struct SpriteFrameImage sPicTable_StarPiece[] = {
    overworld_frame(gObjectEventPic_StarPiece, 2, 2, 0),
    overworld_frame(gObjectEventPic_StarPiece, 2, 2, 1),
    overworld_frame(gObjectEventPic_StarPiece, 2, 2, 2),
	overworld_frame(gObjectEventPic_StarPiece, 2, 2, 0),
    overworld_frame(gObjectEventPic_StarPiece, 2, 2, 0),
    overworld_frame(gObjectEventPic_StarPiece, 2, 2, 1),
    overworld_frame(gObjectEventPic_StarPiece, 2, 2, 1),
...
static const struct SpriteFrameImage sPicTable_AltaMemberM[] = {
    overworld_frame(gObjectEventPic_AltaGruntM, 2, 4, 0),
    overworld_frame(gObjectEventPic_AltaGruntM, 2, 4, 1),
    overworld_frame(gObjectEventPic_AltaGruntM, 2, 4, 2),
    overworld_frame(gObjectEventPic_AltaGruntM, 2, 4, 3),
    overworld_frame(gObjectEventPic_AltaGruntM, 2, 4, 4),
    overworld_frame(gObjectEventPic_AltaGruntM, 2, 4, 5),
    overworld_frame(gObjectEventPic_AltaGruntM, 2, 4, 6),
    overworld_frame(gObjectEventPic_AltaGruntM, 2, 4, 7),
    overworld_frame(gObjectEventPic_AltaGruntM, 2, 4, 8),
};

static const struct SpriteFrameImage sPicTable_AltaMemberF[] = {
    overworld_frame(gObjectEventPic_AltaGruntF, 2, 4, 0),
    overworld_frame(gObjectEventPic_AltaGruntF, 2, 4, 1),
    overworld_frame(gObjectEventPic_AltaGruntF, 2, 4, 2),
    overworld_frame(gObjectEventPic_AltaGruntF, 2, 4, 3),
    overworld_frame(gObjectEventPic_AltaGruntF, 2, 4, 4),
    overworld_frame(gObjectEventPic_AltaGruntF, 2, 4, 5),
    overworld_frame(gObjectEventPic_AltaGruntF, 2, 4, 6),
    overworld_frame(gObjectEventPic_AltaGruntF, 2, 4, 7),
    overworld_frame(gObjectEventPic_AltaGruntF, 2, 4, 8),
};
...
static const struct SpriteFrameImage sPicTable_CuttableFence[] = {
    overworld_frame(gObjectEventPic_CuttableFence, 2, 2, 0),
    overworld_frame(gObjectEventPic_CuttableFence, 2, 2, 1),
    overworld_frame(gObjectEventPic_CuttableFence, 2, 2, 2),
    overworld_frame(gObjectEventPic_CuttableFence, 2, 2, 3),
};
...
static const struct SpriteFrameImage sPicTable_Morgan[] = {
    overworld_frame(gObjectEventPic_Morgan, 2, 4, 0),
    overworld_frame(gObjectEventPic_Morgan, 2, 4, 1),
    overworld_frame(gObjectEventPic_Morgan, 2, 4, 2),
    overworld_frame(gObjectEventPic_Morgan, 2, 4, 3),
    overworld_frame(gObjectEventPic_Morgan, 2, 4, 4),
    overworld_frame(gObjectEventPic_Morgan, 2, 4, 5),
    overworld_frame(gObjectEventPic_Morgan, 2, 4, 6),
    overworld_frame(gObjectEventPic_Morgan, 2, 4, 7),
    overworld_frame(gObjectEventPic_Morgan, 2, 4, 8),
};

static const struct SpriteFrameImage sPicTable_Calvin[] = {
    overworld_frame(gObjectEventPic_Calvin, 2, 4, 0),
    overworld_frame(gObjectEventPic_Calvin, 2, 4, 1),
    overworld_frame(gObjectEventPic_Calvin, 2, 4, 2),
    overworld_frame(gObjectEventPic_Calvin, 2, 4, 3),
    overworld_frame(gObjectEventPic_Calvin, 2, 4, 4),
    overworld_frame(gObjectEventPic_Calvin, 2, 4, 5),
    overworld_frame(gObjectEventPic_Calvin, 2, 4, 6),
    overworld_frame(gObjectEventPic_Calvin, 2, 4, 7),
    overworld_frame(gObjectEventPic_Calvin, 2, 4, 8),
};

static const struct SpriteFrameImage sPicTable_MorganAsleep[] = {
    overworld_frame(gObjectEventPic_MorganAsleep, 2, 4, 0),
    overworld_frame(gObjectEventPic_MorganAsleep, 2, 4, 1),
    overworld_frame(gObjectEventPic_MorganAsleep, 2, 4, 2),
    overworld_frame(gObjectEventPic_MorganAsleep, 2, 4, 0),
    overworld_frame(gObjectEventPic_MorganAsleep, 2, 4, 0),
    overworld_frame(gObjectEventPic_MorganAsleep, 2, 4, 1),
    overworld_frame(gObjectEventPic_MorganAsleep, 2, 4, 1),
...
static const struct SpriteFrameImage sPicTable_CalvinAsleep[] = {
    overworld_frame(gObjectEventPic_CalvinAsleep, 2, 4, 0),
    overworld_frame(gObjectEventPic_CalvinAsleep, 2, 4, 1),
