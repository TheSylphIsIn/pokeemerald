...
static const struct SpriteFrameImage sPicTable_Boy1[] = {
    ...
    overworld_frame(gObjectEventPic_Boy1, 2, 4, 9),
    overworld_frame(gObjectEventPic_Boy1, 2, 4, 10),
    overworld_frame(gObjectEventPic_Boy1, 2, 4, 11),
    overworld_frame(gObjectEventPic_Boy1, 2, 4, 12),
};
...
static const struct SpriteFrameImage sPicTable_Girl2[] = {
    ...
    overworld_frame(gObjectEventPic_Girl2, 2, 4, 9),
    overworld_frame(gObjectEventPic_Girl2, 2, 4, 10),
    overworld_frame(gObjectEventPic_Girl2, 2, 4, 11),
    overworld_frame(gObjectEventPic_Girl2, 2, 4, 12),
};
...
static const struct SpriteFrameImage sPicTable_OldWoman[] = {
    ...
    overworld_frame(gObjectEventPic_OldWoman, 2, 4, 9),
    overworld_frame(gObjectEventPic_OldWoman, 2, 4, 10),
    overworld_frame(gObjectEventPic_OldWoman, 2, 4, 11),
    overworld_frame(gObjectEventPic_OldWoman, 2, 4, 12),
};
...
static const struct SpriteFrameImage sPicTable_CoilBoy[] = {
    overworld_frame(gObjectEventPic_CoilBoy, 2, 4, 0),
    overworld_frame(gObjectEventPic_CoilBoy, 2, 4, 1),
    overworld_frame(gObjectEventPic_CoilBoy, 2, 4, 2),
    overworld_frame(gObjectEventPic_CoilBoy, 2, 4, 3),
    overworld_frame(gObjectEventPic_CoilBoy, 2, 4, 4),
    overworld_frame(gObjectEventPic_CoilBoy, 2, 4, 5),
    overworld_frame(gObjectEventPic_CoilBoy, 2, 4, 6),
    overworld_frame(gObjectEventPic_CoilBoy, 2, 4, 7),
    overworld_frame(gObjectEventPic_CoilBoy, 2, 4, 8),
};

static const struct SpriteFrameImage sPicTable_HikerShirtless[] = {
    overworld_frame(gObjectEventPic_HikerShirtless, 2, 4, 0),
    overworld_frame(gObjectEventPic_HikerShirtless, 2, 4, 1),
    overworld_frame(gObjectEventPic_HikerShirtless, 2, 4, 2),
    overworld_frame(gObjectEventPic_HikerShirtless, 2, 4, 3),
    overworld_frame(gObjectEventPic_HikerShirtless, 2, 4, 4),
    overworld_frame(gObjectEventPic_HikerShirtless, 2, 4, 5),
    overworld_frame(gObjectEventPic_HikerShirtless, 2, 4, 6),
    overworld_frame(gObjectEventPic_HikerShirtless, 2, 4, 7),
    overworld_frame(gObjectEventPic_HikerShirtless, 2, 4, 8),
};

static const struct SpriteFrameImage sPicTable_Demon[] = {
    overworld_frame(gObjectEventPic_Demon, 2, 4, 0),
    overworld_frame(gObjectEventPic_Demon, 2, 4, 1),
    overworld_frame(gObjectEventPic_Demon, 2, 4, 2),
    overworld_frame(gObjectEventPic_Demon, 2, 4, 3),
    overworld_frame(gObjectEventPic_Demon, 2, 4, 4),
    overworld_frame(gObjectEventPic_Demon, 2, 4, 5),
    overworld_frame(gObjectEventPic_Demon, 2, 4, 6),
    overworld_frame(gObjectEventPic_Demon, 2, 4, 7),
    overworld_frame(gObjectEventPic_Demon, 2, 4, 8),
};

static const struct SpriteFrameImage sPicTable_ArchDemon[] = {
    overworld_frame(gObjectEventPic_ArchDemon, 2, 4, 0),
    overworld_frame(gObjectEventPic_ArchDemon, 2, 4, 1),
    overworld_frame(gObjectEventPic_ArchDemon, 2, 4, 2),
    overworld_frame(gObjectEventPic_ArchDemon, 2, 4, 3),
    overworld_frame(gObjectEventPic_ArchDemon, 2, 4, 4),
    overworld_frame(gObjectEventPic_ArchDemon, 2, 4, 5),
    overworld_frame(gObjectEventPic_ArchDemon, 2, 4, 6),
    overworld_frame(gObjectEventPic_ArchDemon, 2, 4, 7),
    overworld_frame(gObjectEventPic_ArchDemon, 2, 4, 8),
};
