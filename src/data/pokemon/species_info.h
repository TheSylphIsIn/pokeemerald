...
#define OVERWORLD_ASYM(picTable, _size, shadow, _tracks, ...)                                    \
.overworldData = {                                                                          \
    .tileTag = TAG_NONE,                                                                    \
    .paletteTag = OBJ_EVENT_PAL_TAG_DYNAMIC,                                                \
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,                                         \
...
const struct SpeciesInfo gSpeciesInfo[] =
{
    ...
    [SPECIES_VINOS] =
    {
        ...
        .natDexNum = NATIONAL_DEX_NONE,
        .categoryName = _("Grapevine"),
        .height = 20,
        .weight = 30,
        .description = COMPOUND_STRING(
            "A carnivorous vine which disguises itself\n"
            "as an inanimate fruit-bearing plant.\n"
            "Its berries contain a paralyzing toxin,\n"
            "and it preys on those who eat them."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_vinos,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_Vinos,
        .frontAnimId = ANIM_BACK_AND_LUNGE,
        .backPic = gMonBackPic_vinos,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_NONE,
        .palette = gMonPalette_vinos,
        .shinyPalette = gMonShinyPalette_vinos,
        .iconSprite = gMonIcon_vinos,
        .iconPalIndex = 0,
        FOOTPRINT(vinos)
