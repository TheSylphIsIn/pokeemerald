...
static const struct FormChange sEeveeFormChangeTable[] = {
    {FORM_CHANGE_ITEM_HOLD, SPECIES_EEVEE, ITEM_NONE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DEMIVEE_WATER, ITEM_VAPORSHARD},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DEMIVEE_ELECTRIC, ITEM_JOLTSHARD},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DEMIVEE_FIRE, ITEM_FLARESHARD},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DEMIVEE_PSYCHIC, ITEM_ESPERSHARD},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DEMIVEE_DARK, ITEM_UMBRASHARD},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DEMIVEE_GRASS, ITEM_LEAFSHARD},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DEMIVEE_ICE, ITEM_GLACIALSHARD},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DEMIVEE_FAIRY, ITEM_SYLVANSHARD},
    {FORM_CHANGE_TERMINATOR},
};
