...
const u32 gTMHMLearnsets[][2] =
{
	...
	[SPECIES_MYSTERYEGG] = TMHM_LEARNSET(0),
	[SPECIES_SECRETEGG] = TMHM_LEARNSET(0),
	[SPECIES_HYPEREGG] = TMHM_LEARNSET(0),
	[SPECIES_HOMBONE] = TMHM_LEARNSET(0),
	[SPECIES_HOMBEAST] = TMHM_LEARNSET(0),
