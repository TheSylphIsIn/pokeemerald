...
const u32 gTMHMLearnsets[][4] =
{
    ...
    [SPECIES_MEW]         = TMHM_LEARNSET(TMHM(TM01_FOCUS_PUNCH)
										...
										| TMHM(TM52_IRON_DEFENSE)
										| TMHM(TM53_AGILITY)
										| TMHM(TM54_NASTY_PLOT)
										| TMHM(TM55_AMNESIA)
										...
										| TMHM(TM61_LAVA_PLUME)
										| TMHM(TM62_WHITEWATER)
										| TMHM(TM63_PIN_MISSILE)
										| TMHM(TM64_CHILL_TOUCH)
										,
										TMHM_64(TM65_BODY_PRESS)
										| TMHM_64(TM66_BLACKOUT)
										| TMHM_64(TM67_DRAGON_PULSE)
										| TMHM_64(TM68_GIGA_IMPACT)
										| TMHM_64(TM69_PLAY_ROUGH)
										| TMHM_64(TM70_BLADE_STORM)
										| TMHM_64(TM71_OVERHEAT)
										| TMHM_64(TM72_FOCUS_RUSH)
										| TMHM_64(TM73_POWER_GEM)
										| TMHM_64(TM74_EARTH_POWER)
										| TMHM_64(TM75_AIR_SLASH)
										| TMHM_64(TM76_BUZZ_BLITZ)
										| TMHM_64(TM77_STEEL_WING)
										| TMHM_64(TM78_HEAL_ORDER)
										| TMHM_64(TM79_POISON_JAB)
										| TMHM_64(TM80_FUMUGATE)
										| TMHM_64(TM81_U_TURN)
										| TMHM_64(TM82_VOLT_SWITCH)
										| TMHM_64(TM83_FADE_AWAY)
										| TMHM_64(TM84_TELEPORT)
										| TMHM_64(TM85_FOCUS_BLAST)
										| TMHM_64(TM86_HYDRO_PUMP)
										| TMHM_64(TM87_SIGNAL_BEAM)
										| TMHM_64(TM88_FLASH_CANNON)
										| TMHM_64(TM89_BITTER_SLASH)
										| TMHM_64(TM90_HORRIFY)
										| TMHM_64(TM91_MAGIC_BURST)
										| TMHM_64(TM92_PRECISE_CUT)
										| TMHM_64(TM93_DIG)
										| TMHM_64(TM94_X_SCISSOR)
										| TMHM_64(TM95_TOXIN_SLASH)
										| TMHM_64(TM96_REND)
										| TMHM_64(TM97_SUPERPOWER)
										| TMHM_64(TM98_TAILWIND)
										| TMHM_64(TM99_SWEET_KISS)
										| TMHM_64(TM100_SWIFT)
										| TMHM_64(TM101_ARMOR_CRUSH)
										| TMHM_64(TM102_REST)
										| TMHM_64(TM103_SHORE_UP)
										| TMHM_64(TM104_FLAME_CHARGE)
										| TMHM_64(TM105_TRAILBLAZE)
										| TMHM_64(TM106_ACID_SPRAY)
										| TMHM_64(TM107_SHOCK_WAVE)
										| TMHM_64(TM108_TWISTER)
										| TMHM_64(TM109_AERIAL_ACE)
										| TMHM_64(TM110_TANTRUM)
										| TMHM_64(TM111_SHADOW_SNEAK)
										| TMHM_64(TM112_THIEF)
										| TMHM_64(TM113_POISON_FANG)
										| TMHM_64(TM114_SILVER_WIND)
										| TMHM_64(TM115_STRUGGLE_BUG)
										| TMHM_64(TM116_AURA_WAVE)
										| TMHM_64(TM117_MUD_SHOT)
										| TMHM_64(TM118_GEM_SPARK)
										| TMHM_64(TM119_MOCKERY)
										| TMHM_64(TM120_TWINKLE_POP)
										| TMHM_64(HM01_CUT)
										| TMHM_64(HM02_FLY)
										| TMHM_64(HM03_SURF)
										| TMHM_64(HM04_STRENGTH)
	...
	[SPECIES_SANDUDE] = TMHM_LEARNSET(TMHM(TM08_BULK_UP)
										| TMHM(TM10_HIDDEN_POWER)
										| TMHM(TM17_PROTECT)
										| TMHM(TM26_EARTHQUAKE)
										| TMHM(TM27_RETURN)
	...
	[SPECIES_SANDROSS] = TMHM_LEARNSET(TMHM(TM08_BULK_UP)
										| TMHM(TM10_HIDDEN_POWER)
										| TMHM(TM16_GROWTH)
										| TMHM(TM17_PROTECT)
										| TMHM(TM21_REFLECT)
	...
	[SPECIES_SANDUEL] = TMHM_LEARNSET(TMHM(TM01_FOCUS_PUNCH)
										| TMHM(TM08_BULK_UP)
										| TMHM(TM10_HIDDEN_POWER)
										| TMHM(TM12_LIMBER_UP)
										| TMHM(TM16_GROWTH)
	...
	[SPECIES_COILSPILL] = TMHM_LEARNSET(0,0),
	[SPECIES_BOOWHO] = TMHM_LEARNSET(0,0),
	[SPECIES_BOOXER] = TMHM_LEARNSET(0,0),
	[SPECIES_BOOZERKER] = TMHM_LEARNSET(0,0),
	[SPECIES_DEEPDARK] = TMHM_LEARNSET(0,0),
	[SPECIES_BURMITE] = TMHM_LEARNSET(0,0),
	[SPECIES_SEDIMETAL] = TMHM_LEARNSET(0,0),
	[SPECIES_SOLOSIS_FONEI] = TMHM_LEARNSET(0,0),
	[SPECIES_DUOSION_FONEI] = TMHM_LEARNSET(0,0),
	[SPECIES_REUNICLUS_FONEI] = TMHM_LEARNSET(0,0),
	[SPECIES_VINOS] = TMHM_LEARNSET(0,0),
	[SPECIES_VINOCEIVER] = TMHM_LEARNSET(0,0),
	[SPECIES_ANNOYIDGE] = TMHM_LEARNSET(0,0),
	[SPECIES_PESQUITO] = TMHM_LEARNSET(0,0),
	[SPECIES_MANKEY_FONEI] = TMHM_LEARNSET(0,0),
	[SPECIES_PRIMEAPE_FONEI] = TMHM_LEARNSET(0,0),
	[SPECIES_CRYOGONAL_FONEI] = TMHM_LEARNSET(0,0),
	[SPECIES_AMPIBOISON] = TMHM_LEARNSET(0,0),
	[SPECIES_LAGNET] = TMHM_LEARNSET(0,0),
	[SPECIES_LANNET] = TMHM_LEARNSET(0,0),
	[SPECIES_CYBURN] = TMHM_LEARNSET(0,0),
	[SPECIES_SAPNOSE] = TMHM_LEARNSET(0,0),
	[SPECIES_BURROOT] = TMHM_LEARNSET(0,0),
	[SPECIES_BURRUSH] = TMHM_LEARNSET(0,0),
	[SPECIES_LAV] = TMHM_LEARNSET(0,0),
	[SPECIES_LAVALY] = TMHM_LEARNSET(0,0),
	[SPECIES_LAVSAMUCH] = TMHM_LEARNSET(0,0),
	[SPECIES_GUPPAGE] = TMHM_LEARNSET(0,0),
	[SPECIES_SEAGE] = TMHM_LEARNSET(0,0),
	[SPECIES_BASSTION] = TMHM_LEARNSET(0,0),
	[SPECIES_PANTOM] = TMHM_LEARNSET(0,0),
	[SPECIES_HAPPANING] = TMHM_LEARNSET(0,0),
	[SPECIES_PANZERGAST] = TMHM_LEARNSET(0,0),
	[SPECIES_SCAIRY] = TMHM_LEARNSET(0,0),
	[SPECIES_DANKLIMMER] = TMHM_LEARNSET(0,0),
	[SPECIES_GOLICHEM] = TMHM_LEARNSET(0,0),
	[SPECIES_SPINDA_FONEI] = TMHM_LEARNSET(0,0),
	[SPECIES_EMUNITION] = TMHM_LEARNSET(0,0),
	[SPECIES_EMORTAR] = TMHM_LEARNSET(0,0),
	[SPECIES_OPEBBLISK] = TMHM_LEARNSET(0,0),
	[SPECIES_STONUMENT] = TMHM_LEARNSET(0,0),
	[SPECIES_MEMOIRBLE] = TMHM_LEARNSET(0,0),
	[SPECIES_NOKOMMON] = TMHM_LEARNSET(0,0),
	[SPECIES_TANGHOUL] = TMHM_LEARNSET(0,0),
	[SPECIES_QWILYU] = TMHM_LEARNSET(0,0),
	[SPECIES_CORILIA] = TMHM_LEARNSET(0,0),
	[SPECIES_NIDOROOK] = TMHM_LEARNSET(0,0),
	[SPECIES_SKALVENGER] = TMHM_LEARNSET(0,0),
	[SPECIES_SKULKREX] = TMHM_LEARNSET(0,0),
	[SPECIES_SKELTYRANT] = TMHM_LEARNSET(0,0),
};