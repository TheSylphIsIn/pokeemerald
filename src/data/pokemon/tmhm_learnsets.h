...
const u32 gTMHMLearnsets[][2] =
{
	...
	[SPECIES_GORELAX] = TMHM_LEARNSET(0),
	[SPECIES_SHINIGAMI] = TMHM_LEARNSET(0),
	[SPECIES_ANTISPIRAL] = TMHM_LEARNSET(0),
	[SPECIES_DRAGON] = TMHM_LEARNSET(0),
	[SPECIES_AMONSTER] = TMHM_LEARNSET(0),
	[SPECIES_FANGASU] = TMHM_LEARNSET(0),
	[SPECIES_NIGERA] = TMHM_LEARNSET(0),
	[SPECIES_KURIPUTO] = TMHM_LEARNSET(0),
	[SPECIES_ROODANSE] = TMHM_LEARNSET(0),
	[SPECIES_OOSHE] = TMHM_LEARNSET(0),
	[SPECIES_GOOSUBOA] = TMHM_LEARNSET(0),
	[SPECIES_ROCLOBSTER] = TMHM_LEARNSET(0),
	[SPECIES_X32763] = TMHM_LEARNSET(0),
	[SPECIES_TELSON] = TMHM_LEARNSET(0),
	[SPECIES_MAGNEZONE] = TMHM_LEARNSET(0),
	[SPECIES_VIGOURLAN] = TMHM_LEARNSET(TMHM(TM01_FOCUS_PUNCH)
										| TMHM(TM02_DRAGON_CLAW)
                                        | TMHM(TM03_WATER_PULSE)
										| TMHM(TM04_CALM_MIND)
                                        | TMHM(TM05_ROAR)
										...
										| TMHM(HM05_FLASH)
                                        | TMHM(HM06_ROCK_SMASH)),
	[SPECIES_DIAMANDIX] = TMHM_LEARNSET(0),
	[SPECIES_GIGAWOLF] = TMHM_LEARNSET(TMHM(TM01_FOCUS_PUNCH)
										| TMHM(TM05_ROAR)
                                        | TMHM(TM06_TOXIC)
										| TMHM(TM08_BULK_UP)
                                        | TMHM(TM10_HIDDEN_POWER)
                                        ...
                                        | TMHM(HM04_STRENGTH)
                                        | TMHM(HM06_ROCK_SMASH)),
	[SPECIES_GALACTIMON] = TMHM_LEARNSET(0),
	[SPECIES_QWILSHARK] = TMHM_LEARNSET(0),
	[SPECIES_DRAGOONE] = TMHM_LEARNSET(TMHM(TM02_DRAGON_CLAW)
										| TMHM(TM03_WATER_PULSE)
                                        | TMHM(TM05_ROAR)
                                        | TMHM(TM06_TOXIC)
                                        | TMHM(TM10_HIDDEN_POWER)
                                        ...
                                        | TMHM(HM04_STRENGTH)
                                        | TMHM(HM06_ROCK_SMASH)),
	[SPECIES_CALFBY] = TMHM_LEARNSET(0),
	[SPECIES_RAMSHAKER] = TMHM_LEARNSET(0),
	[SPECIES_SEVICIOUS] = TMHM_LEARNSET(0),
	[SPECIES_ZANGOL] = TMHM_LEARNSET(0),
	[SPECIES_PSYPIG] = TMHM_LEARNSET(0),
	[SPECIES_MUNCHLAX] = TMHM_LEARNSET(0),
	[SPECIES_SKYLAX] = TMHM_LEARNSET(0),
	[SPECIES_MYSTERYEGG] = TMHM_LEARNSET(TMHM(TM03_WATER_PULSE)
                                        | TMHM(TM04_CALM_MIND)
                                        | TMHM(TM06_TOXIC)
                                        | TMHM(TM08_BULK_UP)
                                        | TMHM(TM09_BULLET_SEED)
                                        ...
                                        | TMHM(HM05_FLASH)
                                        | TMHM(HM08_DIVE)),
	[SPECIES_SECRETEGG] = TMHM_LEARNSET(TMHM(TM03_WATER_PULSE)
                                        | TMHM(TM04_CALM_MIND)
                                        | TMHM(TM06_TOXIC)
                                        | TMHM(TM08_BULK_UP)
                                        | TMHM(TM09_BULLET_SEED)
                                        ...
                                        | TMHM(HM05_FLASH)
                                        | TMHM(HM08_DIVE)),
	[SPECIES_HYPEREGG] = TMHM_LEARNSET(TMHM(TM03_WATER_PULSE)
                                        | TMHM(TM04_CALM_MIND)
                                        | TMHM(TM06_TOXIC)
                                        | TMHM(TM08_BULK_UP)
                                        | TMHM(TM09_BULLET_SEED)
	...
	[SPECIES_HOMBONE] = TMHM_LEARNSET(
                                        ...
                                        | TMHM(HM04_STRENGTH)
                                        | TMHM(HM06_ROCK_SMASH)),
	[SPECIES_HOMBEAST] = TMHM_LEARNSET(
										TMHM(TM02_DRAGON_CLAW)
										| TMHM(TM05_ROAR)
                                        | TMHM(TM06_TOXIC)
                                        | TMHM(TM10_HIDDEN_POWER)
                                        ...
                                        | TMHM(HM04_STRENGTH)
                                        | TMHM(HM06_ROCK_SMASH)),
	[SPECIES_KENCHIRA] = TMHM_LEARNSET(0),
	[SPECIES_KENCHUKO] = TMHM_LEARNSET(0),
	[SPECIES_GLUTE] = TMHM_LEARNSET(0),
	[SPECIES_BUTE] = TMHM_LEARNSET(0),
	[SPECIES_NUTE] = TMHM_LEARNSET(0),
	[SPECIES_FURI_X] = TMHM_LEARNSET(0),
	[SPECIES_FURI_Z] = TMHM_LEARNSET(0),
	[SPECIES_FURI_Q] = TMHM_LEARNSET(0),
	[SPECIES_TURMUR] = TMHM_LEARNSET(0),
	[SPECIES_SHADERU] = TMHM_LEARNSET(0),
