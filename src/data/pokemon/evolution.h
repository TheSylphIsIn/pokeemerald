const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
	...
	[SPECIES_QWILFISH]	 = {{EVO_ITEM, ITEM_ZOMBIE_TOOTH, SPECIES_QWILSHARK}},
	...
	[SPECIES_KEESH]		 = {{EVO_ATTRIBUTE_1, MOVE_ATTRIBUTE_LIGHT, SPECIES_HATCHBLING},
							{EVO_ATTRIBUTE_1, MOVE_ATTRIBUTE_ENERGY, SPECIES_KEESIGHT},
							{0, 0, 0},
							{EVO_LEVEL_SILCOON, 7, SPECIES_HATCHBLING},
