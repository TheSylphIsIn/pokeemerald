const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
	...
	[SPECIES_STEELIX]	 = {{EVO_BEAUTY, 170, SPECIES_DIAMANDIX}},
	[SPECIES_QWILFISH]	 = {{EVO_LEVEL, 33, SPECIES_QWILSHARK}},
	...
	[SPECIES_MIGHTYENA]	 = {{EVO_FRIENDSHIP, 0, SPECIES_GIGAWOLF}},
    [SPECIES_ZIGZAGOON]  = {{EVO_LEVEL, 20, SPECIES_LINOONE}},
	[SPECIES_LINOONE]	 = {{EVO_LEVEL, 41, SPECIES_DRAGOONE}},
	...
	[SPECIES_GRUMPIG]	 = {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_PSYPIG}},
	[SPECIES_SEVIPER]	 = {{EVO_LEVEL, 45, SPECIES_SEVICIOUS}},
	[SPECIES_ZANGOOSE]	 = {{EVO_LEVEL, 45, SPECIES_ZANGOL}},
    [SPECIES_MEDITITE]   = {{EVO_LEVEL, 37, SPECIES_MEDICHAM}},
    [SPECIES_SWABLU]     = {{EVO_LEVEL, 35, SPECIES_ALTARIA}},
	[SPECIES_SOLROCK]	 = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_GALACTIMON}},
	[SPECIES_LUNATONE]	 = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_GALACTIMON}},
    ...
    [SPECIES_VIGOROTH]   = {{EVO_LEVEL_CASCOON, 36, SPECIES_SLAKING},
							{EVO_LEVEL_SILCOON, 36, SPECIES_VIGOURLAN}},
	...
	[SPECIES_CALFBY]	 = {{EVO_LEVEL_ATK_GT_DEF, 26, SPECIES_TAUROS},
							{EVO_LEVEL_ATK_LT_DEF, 26, SPECIES_MILTANK},
							{EVO_LEVEL_ATK_EQ_DEF, 26, SPECIES_RAMSHAKER}},
	[SPECIES_MUNCHLAX]	 = {{EVO_FRIENDSHIP, 0, SPECIES_SNORLAX}},
	[SPECIES_SNORLAX]	 = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_SKYLAX}},
	[SPECIES_MYSTERYEGG] = {{EVO_LEVEL, 21, SPECIES_SECRETEGG}},
	[SPECIES_SECRETEGG]	 = {{EVO_LEVEL, 42, SPECIES_HYPEREGG}},
	[SPECIES_HYPEREGG]	 = {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_ENTEI},
							{EVO_ITEM, ITEM_WATER_STONE, SPECIES_SUICUNE},
							{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_RAIKOU},
							{EVO_ITEM, ITEM_MOON_STONE, SPECIES_UNOWN},
							{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_CELEBI}},
	[SPECIES_HOMBONE]	 = {{EVO_LEVEL, 40, SPECIES_HOMBEAST}},
	[SPECIES_KENCHIRA]	 = {{EVO_LEVEL, 44, SPECIES_KENCHUKO}},
	[SPECIES_GLUTE]		 = {{EVO_LEVEL, 56, SPECIES_BUTE}},
	[SPECIES_BUTE]		 = {{EVO_LEVEL, 70, SPECIES_NUTE}},
};
