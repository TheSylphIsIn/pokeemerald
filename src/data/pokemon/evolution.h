const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_NIDORINA]   = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_NIDOQUEEN}, 
							{EVO_ITEM, ITEM_SUN_STONE, SPECIES_NIDOROOK}, 
							{0, 0, 0},
							{EVO_ITEM, ITEM_HEART_STONE, SPECIES_NIDOKING}},
    [SPECIES_NIDORAN_M]  = {{EVO_LEVEL, 16, SPECIES_NIDORINO}},
    [SPECIES_NIDORINO]   = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_NIDOKING}, 
							{EVO_ITEM, ITEM_SUN_STONE, SPECIES_NIDOROOK}, 
							{0, 0, 0},
							{EVO_ITEM, ITEM_HEART_STONE, SPECIES_NIDOQUEEN}},
	...
	[SPECIES_DEWGONG]    = {{EVO_ITEM, ITEM_ALPHA_STONE, SPECIES_NORWHALE}},
	...
	[SPECIES_HYPNO]		 = {{EVO_ATTRIBUTE_3, MOVE_ATTRIBUTE_INFLICT_STATUS, SPECIES_MANIPULO}},
	...
	[SPECIES_TANGELA]	 = {{EVO_MOVE, MOVE_NIGHTMARE, SPECIES_TANGHOUL}},
	...
	[SPECIES_SUNFLORA]	 = {{EVO_ITEM, ITEM_OMEGA_STONE, SPECIES_SUNFOREST}},
    [SPECIES_WOOPER]     = {{EVO_LEVEL, 20, SPECIES_QUAGSIRE}},
    [SPECIES_PINECO]     = {{EVO_LEVEL, 31, SPECIES_FORRETRESS}},
	[SPECIES_DUNSPARCE]	 = {{EVO_FRIENDSHIP, 220, SPECIES_NOKOMMON}},
    [SPECIES_SNUBBULL]   = {{EVO_LEVEL, 23, SPECIES_GRANBULL}},
	[SPECIES_QWILFISH]	 = {{EVO_LEVEL, 38, SPECIES_QWILYU},
							{EVO_ITEM, ITEM_ZOMBIE_TOOTH, SPECIES_QWILSHARK}},
    [SPECIES_TEDDIURSA]  = {{EVO_LEVEL, 30, SPECIES_URSARING}},
    [SPECIES_SLUGMA]     = {{EVO_LEVEL, 26, SPECIES_MAGCARGO}},
	[SPECIES_MAGCARGO]   = {{EVO_ITEM, ITEM_ALPHA_STONE, SPECIES_OBSICARGO}},
    [SPECIES_SWINUB]     = {{EVO_LEVEL, 33, SPECIES_PILOSWINE}},
	[SPECIES_CORSOLA]	 = {{EVO_ITEM, ITEM_ALPHA_STONE, SPECIES_CORILIA}},
    ...
    [SPECIES_TYROGUE]    = {{EVO_ATTRIBUTE_3, MOVE_ATTRIBUTE_PUNCH, SPECIES_HITMONCHAN},
							{EVO_ATTRIBUTE_3, MOVE_ATTRIBUTE_KICK, SPECIES_HITMONLEE},
							{EVO_ATTRIBUTE_TOP, 0, SPECIES_HITMONTOP}},
	...
	[SPECIES_CACTURNE]   = {{EVO_ITEM, ITEM_OMEGA_STONE, SPECIES_CACTUMBRA}},
	...
	[SPECIES_DUBSNAKE]	 = {{EVO_MOVE, MOVE_LAVA_PLUME, SPECIES_HYDROIL},
							{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_COILSPILL}},
	[SPECIES_WYCERN] 	 = {{EVO_LEVEL, 40, SPECIES_BITTERAGON}},
	[SPECIES_GLASMA]	 = {{EVO_LEVEL, 16, SPECIES_PLASMOLYTE}},
	[SPECIES_PLASMOLYTE] = {{EVO_LEVEL, 36, SPECIES_STORMAGE}},
	[SPECIES_SANDUDE]	 = {{EVO_LEVEL, 16, SPECIES_SANDROSS}},
	[SPECIES_SANDROSS]	 = {{EVO_LEVEL, 36, SPECIES_SANDUEL}},
	[SPECIES_ELADRIFT]	 = {{EVO_LEVEL, 16, SPECIES_SLITHURENT}},
	[SPECIES_SLITHURENT] = {{EVO_LEVEL, 36, SPECIES_PRESCYLLON}},
	[SPECIES_SLOSHMOSH]	 = {{EVO_LEVEL, 23, SPECIES_SLURPINSKI}},
	[SPECIES_KEESH]		 = {{EVO_LEVEL_SILCOON, 7, SPECIES_HATCHBLING},
							{EVO_LEVEL_CASCOON, 7, SPECIES_KEESIGHT},
							{0, 0, 0},
							{EVO_ATTRIBUTE_1, MOVE_ATTRIBUTE_LIGHT, SPECIES_HATCHBLING},
							{EVO_ATTRIBUTE_1, MOVE_ATTRIBUTE_ENERGY, SPECIES_KEESIGHT}},
	[SPECIES_HATCHBLING] = {{EVO_LEVEL, 14, SPECIES_HUMMBLING}},
	[SPECIES_KEESIGHT]	 = {{EVO_LEVEL, 14, SPECIES_KEESPELL}},
	[SPECIES_LARVOOL]	 = {{EVO_LEVEL, 15, SPECIES_SPOOLER}},
	[SPECIES_SPOOLER]	 = {{EVO_LEVEL, 32, SPECIES_BILLIARACH}},
	[SPECIES_SLUGMA_FONEI] = {{EVO_LEVEL, 25, SPECIES_MAGCARGO_FONEI}},
	[SPECIES_HONEDGE_FONEI] = {{EVO_LEVEL, 33, SPECIES_DOUBLADE_FONEI}},
	[SPECIES_DOUBLADE_FONEI] = {{EVO_ITEM, ITEM_DAWN_STONE, SPECIES_AEGISLASH_FONEI_A}},
	[SPECIES_ELEMPTY]	 = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_VENEARTH},
	...
	[SPECIES_VENEARTH]	 = {{EVO_ITEM, ITEM_ALPHA_STONE, SPECIES_ELEMPTY}},
	[SPECIES_MARSIZZLE]	 = {{EVO_ITEM, ITEM_ALPHA_STONE, SPECIES_ELEMPTY}},
	[SPECIES_JUPLASMA]	 = {{EVO_ITEM, ITEM_ALPHA_STONE, SPECIES_ELEMPTY}},
	[SPECIES_MERLPOOL]	 = {{EVO_ITEM, ITEM_ALPHA_STONE, SPECIES_ELEMPTY}},
	[SPECIES_OPHICALF]	 = {{EVO_LEVEL, 30, SPECIES_SERPENTAUR}},
	[SPECIES_GEODUDE_FONEI] = {{EVO_LEVEL, 25, SPECIES_GRAVELER_FONEI}},
	[SPECIES_GRAVELER_FONEI] = {{EVO_ITEM, ITEM_ICE_STONE, SPECIES_GOLEM_FONEI}},
	[SPECIES_GRITWYRM]	 = {{EVO_LEVEL, 45, SPECIES_MOLDUNE}},
	[SPECIES_LAGNET]	 = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_LANNET}, // should be upgrade and dubious disc
							{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_CYBURN}}, // but they don't exist as evo items yet
	[SPECIES_HOMBONE]	 = {{EVO_LEVEL, 40, SPECIES_HOMBEAST}},
	[SPECIES_KRISSY]	 = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_KRAKODEMON}},
	[SPECIES_BOOWHO]	 = {{EVO_LEVEL, 14, SPECIES_BOOXER}},
	[SPECIES_BOOXER]	 = {{EVO_ATTRIBUTE_2, MOVE_ATTRIBUTE_PUNCH, SPECIES_BOOZERKER}},
	[SPECIES_SOLOSIS_FONEI] = {{EVO_LEVEL, 26, SPECIES_DUOSION_FONEI}},
	[SPECIES_DUOSION_FONEI] = {{EVO_LEVEL, 38, SPECIES_REUNICLUS_FONEI}},
	[SPECIES_VINOS]		 = {{EVO_LEVEL, 27, SPECIES_VINOCEIVER}},
	[SPECIES_ANNOYIDGE]	 = {{EVO_LEVEL, 35, SPECIES_PESQUITO}},
	[SPECIES_MANKEY_FONEI] = {{EVO_LEVEL, 28, SPECIES_PRIMEAPE_FONEI}},
	[SPECIES_SAPNOSE]	 = {{EVO_LEVEL, 17, SPECIES_BURROOT}},
	[SPECIES_BURROOT]	 = {{EVO_ATTRIBUTE_2, MOVE_ATTRIBUTE_SLASH, SPECIES_BURRUSH}},
	[SPECIES_LAV]		 = {{EVO_LEVEL, 17, SPECIES_LAVALY}},
	[SPECIES_LAVALY]	 = {{EVO_FRIENDSHIP, 220, SPECIES_LAVSAMUCH}},
	[SPECIES_GUPPAGE]	 = {{EVO_LEVEL, 17, SPECIES_SEAGE}},
	[SPECIES_SEAGE]		 = {{EVO_MOVE, MOVE_IRON_DEFENSE, SPECIES_BASSTION}},
	[SPECIES_PANTOM]	 = {{EVO_LEVEL_ATK_GT_DEF, 32, SPECIES_HAPPANING},
							{EVO_LEVEL_ATK_LT_DEF, 32, SPECIES_PANZERGAST}},
	[SPECIES_RALTS_FONEI] = {{EVO_LEVEL, 21, SPECIES_KIRLIA_FONEI}},
	[SPECIES_KIRLIA_FONEI] 	 = {{EVO_LEVEL, 32, SPECIES_GARDEVOIR_FONEI},
								{EVO_ITEM, ITEM_OMEGA_STONE, SPECIES_GALLADE_FONEI}},
	[SPECIES_DANKLIMMER] = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_GOLICHEM}},
	[SPECIES_EMUNITION] = {{EVO_MOVE, MOVE_ROCK_TOMB, SPECIES_EMORTAR}},
	[SPECIES_OPEBBLISK] = {{EVO_LEVEL, 30, SPECIES_STONUMENT}},
	[SPECIES_STONUMENT] = {{EVO_LEVEL, 42, SPECIES_MEMOIRBLE}},
	[SPECIES_WOOBAT] = {{EVO_FRIENDSHIP, 170, SPECIES_SWOOBAT}},
	[SPECIES_SWOOBAT] = {{EVO_FRIENDSHIP, 255, SPECIES_TRUEBAT}},
	[SPECIES_DISABY] = {{EVO_LEVEL, 35, SPECIES_DISASPRITE}},
	[SPECIES_DISASPRITE] = {{EVO_LEVEL, 55, SPECIES_DISMASTER},
							{EVO_MOVE, MOVE_SAFEGUARD, SPECIES_PURIDIAN}},
	[SPECIES_SKULKREX]	 = {{EVO_LEVEL, 30, SPECIES_SKALVENGER}},
	[SPECIES_SKALVENGER] = {{EVO_LEVEL, 55, SPECIES_SKELTYRANT}},
};
