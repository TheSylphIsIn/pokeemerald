const u16 gTutorMoves[TUTOR_MOVE_COUNT] =
{
    ...
    [TUTOR_MOVE_DOUBLE_EDGE] = MOVE_DOUBLE_EDGE, // expendable
    [TUTOR_MOVE_COUNTER] = MOVE_COUNTER, // expendable
    [TUTOR_MOVE_SEISMIC_TOSS] = MOVE_SEISMIC_TOSS, // expendable
    [TUTOR_MOVE_MIMIC] = MOVE_MIMIC, // expendable
    [TUTOR_MOVE_METRONOME] = MOVE_METRONOME,
    [TUTOR_MOVE_SOFT_BOILED] = MOVE_SOFT_BOILED, // expendable
    [TUTOR_MOVE_DREAM_EATER] = MOVE_DREAM_EATER, // expendable
    [TUTOR_MOVE_THUNDER_WAVE] = MOVE_THUNDER_WAVE, // remove
    [TUTOR_MOVE_EXPLOSION] = MOVE_EXPLOSION,
    [TUTOR_MOVE_ROCK_SLIDE] = MOVE_ROCK_SLIDE, // remove
    [TUTOR_MOVE_SUBSTITUTE] = MOVE_SUBSTITUTE,
    [TUTOR_MOVE_DYNAMIC_PUNCH] = MOVE_DYNAMIC_PUNCH, // expendable
    [TUTOR_MOVE_ROLLOUT] = MOVE_ROLLOUT, // expendable
    [TUTOR_MOVE_PSYCH_UP] = MOVE_PSYCH_UP, // expendable
    [TUTOR_MOVE_SNORE] = MOVE_SNORE, // expendable
    [TUTOR_MOVE_ICY_WIND] = MOVE_ICY_WIND, // expendable
    [TUTOR_MOVE_ENDURE] = MOVE_ENDURE, // expendable
    [TUTOR_MOVE_MUD_SLAP] = MOVE_MUD_SLAP, // expendable
    [TUTOR_MOVE_ICE_PUNCH] = MOVE_ICE_PUNCH,
    [TUTOR_MOVE_SWAGGER] = MOVE_SWAGGER, // expendable
    [TUTOR_MOVE_SLEEP_TALK] = MOVE_SLEEP_TALK,
    [TUTOR_MOVE_SWIFT] = MOVE_SWIFT,
    [TUTOR_MOVE_DEFENSE_CURL] = MOVE_DEFENSE_CURL, // expendable
    [TUTOR_MOVE_THUNDER_PUNCH] = MOVE_THUNDER_PUNCH,
    [TUTOR_MOVE_FIRE_PUNCH] = MOVE_FIRE_PUNCH,
    [TUTOR_MOVE_FURY_CUTTER] = MOVE_FURY_CUTTER, // expendable
};
