...
#define DEMIVEE_DATA(hp, atk, def, speed, spatk, spdef, type, formName, ability, cry)		\
    ...
    [SPECIES_DEMIVEE_ICE] =
    {
		DEMIVEE_DATA(85, 55, 60, 85, 85, 65, TYPE_ICE, DemiveeIce, ABILITY_SNOW_CLOAK, CRY_GLACEON)
    },

    [SPECIES_DEMIVEE_FAIRY] =
    {
		DEMIVEE_DATA(75, 65, 60, 55, 75, 105, TYPE_FAIRY, DemiveeFairy, ABILITY_CUTE_CHARM, CRY_SYLVEON)
    },
