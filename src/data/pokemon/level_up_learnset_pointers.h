const u16 *const gLevelUpLearnsets[NUM_SPECIES] =
{
	...
	[SPECIES_GORELAX] = sGorelaxLevelUpLearnset,
	[SPECIES_SHINIGAMI] = sShinigamiLevelUpLearnset,
	[SPECIES_ANTISPIRAL] = sAntispiralLevelUpLearnset,
	[SPECIES_DRAGON] = sDragonLevelUpLearnset,
	[SPECIES_AMONSTER] = sAmonsterLevelUpLearnset,
	[SPECIES_FANGASU] = sFangasuLevelUpLearnset,
	[SPECIES_NIGERA] = sNigeraLevelUpLearnset,
	[SPECIES_KURIPUTO] = sKuriputoLevelUpLearnset,
	[SPECIES_ROODANSE] = sRoodanseLevelUpLearnset,
	[SPECIES_OOSHE] = sOosheLevelUpLearnset,
	[SPECIES_GOOSUBOA] = sGoosuboaLevelUpLearnset,
	[SPECIES_ROCLOBSTER] = sRoclobsterLevelUpLearnset,
	[SPECIES_X32763] = sX32763LevelUpLearnset,
	[SPECIES_TELSON] = sTelsonLevelUpLearnset,
	[SPECIES_MAGNEZONE] = sMagnezoneLevelUpLearnset,
	[SPECIES_VIGOURLAN] = sVigourlanLevelUpLearnset,
	[SPECIES_DIAMANDIX] = sDiamandixLevelUpLearnset,
	[SPECIES_GIGAWOLF] = sGigawolfLevelUpLearnset,
	[SPECIES_GALACTIMON] = sGalactimonLevelUpLearnset,
	[SPECIES_QWILSHARK] = sQwilsharkLevelUpLearnset,
	[SPECIES_DRAGOONE] = sDragooneLevelUpLearnset,
	[SPECIES_CALFBY] = sCalfbyLevelUpLearnset,
	[SPECIES_RAMSHAKER] = sRamshakerLevelUpLearnset,
	[SPECIES_SEVICIOUS] = sSeviciousLevelUpLearnset,
	[SPECIES_ZANGOL] = sZangolLevelUpLearnset,
	[SPECIES_PSYPIG] = sPsypigLevelUpLearnset,
	[SPECIES_MUNCHLAX] = sMunchlaxLevelUpLearnset,
	[SPECIES_SKYLAX] = sSkylaxLevelUpLearnset,
	[SPECIES_MYSTERYEGG] = sMysteryeggLevelUpLearnset,
	[SPECIES_SECRETEGG] = sSecreteggLevelUpLearnset,
	[SPECIES_HYPEREGG] = sHypereggLevelUpLearnset,
	[SPECIES_HOMBONE] = sHomboneLevelUpLearnset,
	[SPECIES_HOMBEAST] = sHombeastLevelUpLearnset,
	[SPECIES_KENCHIRA] = sKenchiraLevelUpLearnset,
	[SPECIES_KENCHUKO] = sKenchukoLevelUpLearnset,
	[SPECIES_GLUTE] = sGluteLevelUpLearnset,
	[SPECIES_BUTE] = sButeLevelUpLearnset,
	[SPECIES_NUTE] = sNuteLevelUpLearnset,
	[SPECIES_FURI_X] = sFuriXLevelUpLearnset,
	[SPECIES_FURI_Z] = sFuriZLevelUpLearnset,
	[SPECIES_FURI_Q] = sFuriQLevelUpLearnset,
	[SPECIES_TURMUR] = sTurmurLevelUpLearnset,
	[SPECIES_SHADERU] = sShaderuLevelUpLearnset,
	[SPECIES_FACELEECH] = sFaceleechLevelUpLearnset,
	[SPECIES_LUCA_ZAMON] = sLucaZamonLevelUpLearnset,
	[SPECIES_TEA_BARCAN] = sTeaBarcanLevelUpLearnset,
	[SPECIES_MINICE] = sMiniceLevelUpLearnset,
	[SPECIES_MINIROCK] = sMinirockLevelUpLearnset,
	[SPECIES_MINISTEEL] = sMinisteelLevelUpLearnset,
	[SPECIES_GENEROBO] = sGeneroboLevelUpLearnset,
};
