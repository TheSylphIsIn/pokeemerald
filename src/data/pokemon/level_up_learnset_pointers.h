const u16 *const gLevelUpLearnsets[NUM_SPECIES] =
{
	...
	[SPECIES_SPOOKUM] = sSpookumLevelUpLearnset,
	[SPECIES_SPOOKUM_BUSTED] = sSpookumLevelUpLearnset,
	[SPECIES_GLASMA] = sGlasmaLevelUpLearnset,
	[SPECIES_PLASMOLYTE] = sPlasmolyteLevelUpLearnset,
	[SPECIES_STORMAGE] = sStormageLevelUpLearnset,
	[SPECIES_SANDUDE] = sSandudeLevelUpLearnset,
	[SPECIES_SANDROSS] = sSandrossLevelUpLearnset,
	[SPECIES_SANDUEL] = sSanduelLevelUpLearnset,
	[SPECIES_ELADRIFT] = sEladriftLevelUpLearnset,
	[SPECIES_SLITHURENT] = sSlithurentLevelUpLearnset,
	[SPECIES_PRESCYLLON] = sPrescyllonLevelUpLearnset,
	[SPECIES_SLOSHMOSH] = sSloshmoshLevelUpLearnset,
	[SPECIES_SLURPINSKI] = sSlurpinskiLevelUpLearnset,
	[SPECIES_KEESH] = sKeeshLevelUpLearnset,
	[SPECIES_HATCHBLING] = sHatchblingLevelUpLearnset,
	[SPECIES_HUMMBLING] = sHummblingLevelUpLearnset,
	[SPECIES_KEESIGHT] = sKeesightLevelUpLearnset,
	[SPECIES_KEESPELL] = sKeespellLevelUpLearnset,
	[SPECIES_LARVOOL] = sLarvoolLevelUpLearnset,
	[SPECIES_SPOOLER] = sSpoolerLevelUpLearnset,
	[SPECIES_BILLIARACH] = sBilliarachLevelUpLearnset,
	[SPECIES_SLUGMA_FONEI] = sSlugmaFoneiLevelUpLearnset,
	[SPECIES_MAGCARGO_FONEI] = sMagcargoFoneiLevelUpLearnset,
	[SPECIES_SUNFOREST] = sSunforestLevelUpLearnset,
	[SPECIES_HONEDGE_FONEI] = sHonedgeFoneiLevelUpLearnset,
	[SPECIES_DOUBLADE_FONEI] = sDoubladeFoneiLevelUpLearnset,
	[SPECIES_AEGISLASH_FONEI_A] = sAegislashFoneiALevelUpLearnset,
	[SPECIES_AEGISLASH_FONEI_E] = sAegislashFoneiELevelUpLearnset,
	[SPECIES_ELEMPTY] = sElemptyLevelUpLearnset,
	[SPECIES_VENEARTH] = sVenearthLevelUpLearnset,
	[SPECIES_MARSIZZLE] = sMarsizzleLevelUpLearnset,
	[SPECIES_JUPLASMA] = sJuplasmaLevelUpLearnset,
	[SPECIES_MERLPOOL] = sMerlpoolLevelUpLearnset,
	[SPECIES_OPHICALF] = sOphicalfLevelUpLearnset,
	[SPECIES_SERPENTAUR] = sSerpentaurLevelUpLearnset,
	[SPECIES_GEODUDE_FONEI] = sGeodudeFoneiLevelUpLearnset,
	[SPECIES_GRAVELER_FONEI] = sGravelerFoneiLevelUpLearnset,
	[SPECIES_GOLEM_FONEI] = sGolemFoneiLevelUpLearnset,
	...
	[SPECIES_RALTS_FONEI] = sRaltsFoneiLevelUpLearnset,
	[SPECIES_KIRLIA_FONEI] = sKirliaFoneiLevelUpLearnset,
	[SPECIES_GARDEVOIR_FONEI] = sGardevoirFoneiLevelUpLearnset,
	[SPECIES_GALLADE_FONEI] = sGalladeFoneiLevelUpLearnset,
	[SPECIES_WOOBAT] = sWoobatLevelUpLearnset,
	[SPECIES_SWOOBAT] = sSwoobatLevelUpLearnset,
	[SPECIES_TRUEBAT] = sTruebatLevelUpLearnset,
	[SPECIES_HOMBONE] = sHomboneLevelUpLearnset,
	[SPECIES_HOMBEAST] = sHombeastLevelUpLearnset,
	[SPECIES_QWILSHARK] = sQwilsharkLevelUpLearnset,
	[SPECIES_KRISSY] = sKrissyLevelUpLearnset,
	[SPECIES_KRAKODEMON] = sKrakodemonLevelUpLearnset,
	[SPECIES_WEATHERBANE] = sWeatherbaneLevelUpLearnset,
	[SPECIES_KETSUBAN] = sKetsubanLevelUpLearnset,
	[SPECIES_DISABY] = sDisabyLevelUpLearnset,
	[SPECIES_DISASPRITE] = sDisaspriteLevelUpLearnset,
	[SPECIES_DISMASTER] = sDismasterLevelUpLearnset,
	[SPECIES_PURIDIAN] = sPuridianLevelUpLearnset,
	[SPECIES_MANIPULO] = sManipuloLevelUpLearnset,
	[SPECIES_COILSPILL] = sCoilspillLevelUpLearnset,
	[SPECIES_BOOWHO] = sBoowhoLevelUpLearnset,
	[SPECIES_BOOXER] = sBooxerLevelUpLearnset,
	[SPECIES_BOOZERKER] = sBoozerkerLevelUpLearnset,
	[SPECIES_DEEPDARK] = sDeepdarkLevelUpLearnset,
	[SPECIES_BURMITE] = sBurmiteLevelUpLearnset,
	[SPECIES_SEDIMETAL] = sSedimetalLevelUpLearnset,
	[SPECIES_SOLOSIS_FONEI] = sSolosisFoneiLevelUpLearnset,
	[SPECIES_DUOSION_FONEI] = sDuosionFoneiLevelUpLearnset,
	[SPECIES_REUNICLUS_FONEI] = sReuniclusFoneiLevelUpLearnset,
	[SPECIES_VINOS] = sVinosLevelUpLearnset,
	[SPECIES_VINOCEIVER] = sVinoceiverLevelUpLearnset,
	[SPECIES_ANNOYIDGE] = sAnnoyidgeLevelUpLearnset,
	[SPECIES_PESQUITO] = sPesquitoLevelUpLearnset,
	[SPECIES_MANKEY_FONEI] = sMankeyFoneiLevelUpLearnset,
	[SPECIES_PRIMEAPE_FONEI] = sPrimeapeFoneiLevelUpLearnset,
	[SPECIES_CRYOGONAL_FONEI] = sCryogonalFoneiLevelUpLearnset,
	[SPECIES_AMPIBOISON] = sAmpiboisonLevelUpLearnset,
	[SPECIES_LAGNET] = sLagnetLevelUpLearnset,
	[SPECIES_LANNET] = sLannetLevelUpLearnset,
	[SPECIES_CYBURN] = sCyburnLevelUpLearnset,
	[SPECIES_SAPNOSE] = sSapnoseLevelUpLearnset,
	[SPECIES_BURROOT] = sBurrootLevelUpLearnset,
	[SPECIES_BURRUSH] = sBurrushLevelUpLearnset,
	[SPECIES_LAV] = sLavLevelUpLearnset,
	[SPECIES_LAVALY] = sLavalyLevelUpLearnset,
	[SPECIES_LAVSAMUCH] = sLavsamuchLevelUpLearnset,
	[SPECIES_GUPPAGE] = sGuppageLevelUpLearnset,
	[SPECIES_SEAGE] = sSeageLevelUpLearnset,
	[SPECIES_BASSTION] = sBasstionLevelUpLearnset,
	[SPECIES_PANTOM] = sPantomLevelUpLearnset,
	[SPECIES_HAPPANING] = sHappaningLevelUpLearnset,
	[SPECIES_PANZERGAST] = sPanzergastLevelUpLearnset,
	[SPECIES_SCAIRY] = sScairyLevelUpLearnset,
	[SPECIES_DANKLIMMER] = sDanklimmerLevelUpLearnset,
	[SPECIES_GOLICHEM] = sGolichemLevelUpLearnset,
	[SPECIES_SPINDA_FONEI] = sSpindaFoneiLevelUpLearnset,
	[SPECIES_EMUNITION] = sEmunitionLevelUpLearnset,
	[SPECIES_EMORTAR] = sEmortarLevelUpLearnset,
	[SPECIES_OPEBBLISK] = sOpebbliskLevelUpLearnset,
	[SPECIES_STONUMENT] = sStonumentLevelUpLearnset,
	[SPECIES_MEMOIRBLE] = sMemoirbleLevelUpLearnset,
	[SPECIES_NOKOMMON] = sNokommonLevelUpLearnset,
	[SPECIES_TANGHOUL] = sTanghoulLevelUpLearnset,
	[SPECIES_QWILYU] = sQwilyuLevelUpLearnset,
	[SPECIES_CORILIA] = sCoriliaLevelUpLearnset,
	[SPECIES_NIDOROOK] = sNidorookLevelUpLearnset,
	[SPECIES_SKALVENGER] = sSkalvengerLevelUpLearnset,
	[SPECIES_SKULKREX] = sSkulkrexLevelUpLearnset,
	[SPECIES_SKELTYRANT] = sSkeltyrantLevelUpLearnset,
