...
static const struct TrainerMonItemDefaultMoves sParty_Winston1[] = { //edited
    {
    .iv = 0,
    .lvl = 12,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Haley1[] = { // edited
    {
    .iv = 0,
    .lvl = 11,
    .species = SPECIES_BULBASAUR,
