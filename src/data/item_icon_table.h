const u32 *const gItemIconTable[ITEMS_COUNT + 1][2] =
{
    ...
    // ????????
    [ITEM_ANTIDOTE_SHAKE] = {gItemIcon_PotionShake, gItemIconPalette_AntidoteShake},
    [ITEM_ANTIDOTE_BLEND] = {gItemIcon_PotionBlend, gItemIconPalette_AntidoteShake},
    [ITEM_PARALYZE_HEAL_SHAKE] = {gItemIcon_PotionShake, gItemIconPalette_ParlyzHealShake},
    [ITEM_PARALYZE_HEAL_BLEND] = {gItemIcon_PotionBlend, gItemIconPalette_ParlyzHealShake},
    [ITEM_BURN_HEAL_SHAKE] = {gItemIcon_PotionShake, gItemIconPalette_BurnHealShake},
    [ITEM_BURN_HEAL_BLEND] = {gItemIcon_PotionBlend, gItemIconPalette_BurnHealShake},
    [ITEM_AWAKENING_SHAKE] = {gItemIcon_PotionShake, gItemIconPalette_AwakeningShake},
    [ITEM_AWAKENING_BLEND] = {gItemIcon_PotionBlend, gItemIconPalette_AwakeningShake},
    [ITEM_ICE_HEAL_SHAKE] = {gItemIcon_PotionShake, gItemIconPalette_IceHealShake},
    [ITEM_ICE_HEAL_BLEND] = {gItemIcon_PotionBlend, gItemIconPalette_IceHealShake},
    [ITEM_ARNOLD_PALMER] = {gItemIcon_Lemonade, gItemIconPalette_Lemonade},
    // Vitamins
    ...
    // ????????
    [ITEM_ZOMBIE_LIVER] = {gItemIcon_ZombieLiver, gItemIconPalette_ZombieLiver},
    [ITEM_APRICORN] = {gItemIcon_Apricorn, gItemIconPalette_Apricorn},
    [ITEM_SUPERCORN] = {gItemIcon_Apricorn, gItemIconPalette_Supercorn},
    [ITEM_HYPERCORN] = {gItemIcon_Apricorn, gItemIconPalette_Hypercorn},
    [ITEM_ZOMBIE_SLOP] = {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_ZOMBIE_HAND] = {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_EMPTY_TM] = {gItemIcon_TM, gItemIconPalette_EmptyTM},
    [ITEM_DRIED_ROOT] = {gItemIcon_DriedRoot, gItemIconPalette_EnergyRoot},
    [ITEM_DRIED_HERB] = {gItemIcon_DriedHerb, gItemIconPalette_RevivalHerb},
    [ITEM_MAGIC_POWDER] = {gItemIcon_SoftSand, gItemIconPalette_MagicDust},
    [ITEM_FIRE_DUST] = {gItemIcon_SilverPowder, gItemIconPalette_FireDust},
    [ITEM_WATER_DUST] = {gItemIcon_SilverPowder, gItemIconPalette_WaterDust},
    [ITEM_ELEC_DUST] = {gItemIcon_SilverPowder, gItemIconPalette_ElecDust},
    [ITEM_LEAF_DUST] = {gItemIcon_SilverPowder, gItemIconPalette_LeafDust},
