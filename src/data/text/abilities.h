...
static const u8 sStenchDescription[] = _("Lowers encounter rate\nand makes foes flinch.");
...
static const u8 sLevitateDescription[] = _("Levitates over terrains\nand Ground type moves.");
...
static const u8 sEarlyBirdDescription[] = _("User sleeps for half as\nlong as normal.");
...
static const u8 sPlusDescription[] = _("Ups Sp. Atk by 50%\nif ally has Minus.");
static const u8 sMinusDescription[] = _("Ups Sp. Atk by 50%\nif ally has Plus.");
...
static const u8 sBrainPowerDescription[] = _("Doubles Sp. Atk stat\nwhen attacking.");
static const u8 sSlimeCoatDescription[] = _("Doubles Sp. Def stat\nduring battle.");
static const u8 sSpecialistDescription[] = _("User's type counts twice\nfor damage.");
static const u8 sExploitativeDescription[] = _("Foe's type effects are\n50% more effective.");
...
static const u8 sMotorDriveDescription[] = _("Raises Speed if hit by\nan Electric attack.");
static const u8 sRivalryDescription[] = _("Deals more damage to foes\nof the same gender.");
static const u8 sSteadfastDescription[] = _("Speed goes up by 1 stage\nif the user flinches.");
static const u8 sSnowCloakDescription[] = _("Ups evasion by 20%\nin Hail or Snow.");
static const u8 sGluttonyDescription[] = _("Will eat Berries when HP\nisn't as low as normal.");
static const u8 sAngerPointDescription[] = _("Maximizes Attack stages\nif critically hit.");
static const u8 sUnburdenDescription[] = _("Doubles Speed after losing\nits held item.");
static const u8 sHeatproofDescription[] = _("Halves Fire damage and\nBurn status damage.");
static const u8 sSimpleDescription[] = _("Stat stage changes are\ndoubled.");
static const u8 sDrySkinDescription[] = _("Absorbs Water, but hurt\nmore by Fire.");
static const u8 sDownloadDescription[] = _("Boosts Atk or Sp. Atk\nbased on foe's defenses.");
static const u8 sIronFistDescription[] = _("Boosts punching moves\nand blocks contact effects.");
static const u8 sPoisonHealDescription[] = _("Poison status restores HP\ninstead of draining it.");
static const u8 sAdaptabilityDescription[] = _("Same type damage bonus\nis 2x instead of 1.5x.");
static const u8 sSkillLinkDescription[] = _("Multi-hit moves hit 5 times.");
static const u8 sHydrationDescription[] = _("Removes status problems\nif it is raining.");
static const u8 sSolarPowerDescription[] = _("In sun: ups Sp. Atk by 50%,\nbut lose 10% HP per turn.");
static const u8 sQuickFeetDescription[] = _("Boosts Speed by 50% if\nuser has a status problem.");
static const u8 sNormalizeDescription[] = _("All moves become\nNormal-type.");
static const u8 sSniperDescription[] = _("Critical hit damage bonus\nis 50% higher.");
static const u8 sMagicGuardDescription[] = _("Indirect damage is\nnullified.");
static const u8 sNoGuardDescription[] = _("User and target can never\nmiss each other.");
static const u8 sStallDescription[] = _("Always moves last, but\nwon't flinch.");
static const u8 sTechnicianDescription[] = _("Boosts moves with 60 or\nless power by 50%.");
static const u8 sLeafGuardDescription[] = _("Blocks status problems\nin sunny weather.");
static const u8 sKlutzDescription[] = _("Can't use hold items.");
static const u8 sMoldBreakerDescription[] = _("Foe's abilities are\nignored.");
static const u8 sSuperLuckDescription[] = _("Ups critical hit ratio.");
static const u8 sAftermathDescription[] = _("Deals damage to the foe\nwhen the user faints.");
static const u8 sAnticipationDescription[] = _("Shudders if foe knows\na super-effective move.");
static const u8 sForewarnDescription[] = _("Warns about the foe's\nmost powerful attack.");
static const u8 sUnawareDescription[] = _("Ignores the foe's\nstat stages.");
static const u8 sTintedLensDescription[] = _("Partly ignores foe's\ntype resistances.");
static const u8 sFilterDescription[] = _("Partly ignores user's\ntype weaknesses.");
static const u8 sSlowStartDescription[] = _("Weakens the user for\n5 turns.");
static const u8 sScrappyDescription[] = _("Ignores Ghost-type\nimmunities.");
static const u8 sStormDrainDescription[] = _("Draws in Water moves\nto boost Sp. Atk.");
static const u8 sIceBodyDescription[] = _("Restores 1/16th HP in snow.");
...
#endif
static const u8 sHoneyGatherDescription[] = _("May find Honey after battle.");
static const u8 sFriskDescription[] = _("Reveals the foe's\nheld item.");
static const u8 sRecklessDescription[] = _("Moves with recoil deal\n20% more damage.");
static const u8 sMultitypeDescription[] = _("Changes type to its Plate.");
static const u8 sFlowerGiftDescription[] = _("In sunshine, boosts ally's\nAtk and Sp. Def.");
static const u8 sBadDreamsDescription[] = _("Sleeping foes take\nindirect damage.");
static const u8 sPickpocketDescription[] = _("Steals the foe's held item\nif it makes contact.");
static const u8 sSheerForceDescription[] = _("Removes added effects to\nboost the move's power.");
static const u8 sContraryDescription[] = _("Inverts stat changes.");
static const u8 sUnnerveDescription[] = _("Stops foes from eating\nBerries while active.");
static const u8 sDefiantDescription[] = _("Ups Attack by 2 stages\nwhen a stat is lowered.");
static const u8 sDefeatistDescription[] = _("Halves damage dealt\nif HP is below half.");
static const u8 sCursedBodyDescription[] = _("30% chance to Disable\nfoe's move on contact.");
static const u8 sHealerDescription[] = _("1/3 chance to remove\nally's status problem.");
static const u8 sFriendGuardDescription[] = _("Ally takes 25% less\ndamage.");
static const u8 sWeakArmorDescription[] = _("When hit, lowers Def\nto boost Speed.");
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
	...
	[ABILITY_FIRE_AFFINITY] = _("Fire Affinity"),
