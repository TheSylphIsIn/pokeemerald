const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
	...
	[MOVE_ROTTEN_CLAW] = _("ROTTEN CLAW"),
	[MOVE_VIRAL_BITE] = _("VIRAL BITE"),
	[MOVE_DISEASE_RAY] = _("DISEASE RAY"),
	[MOVE_DEATH_CHOMP] = _("DEATH CHOMP"),
	[MOVE_BLOODY_SLASH] = _("BLOODY SLASH"),
	[MOVE_UNHOLY_HOWL] = _("UNHOLY HOWL"),
	[MOVE_VIRAL_COUGH] = _("VIRAL COUGH"),
	[MOVE_ICE_VOODOO] = _("ICE VOODOO"),
	[MOVE_AFRO_BEAM] = _("AFRO BEAM"),
	[MOVE_MADIO_RADIO] = _("MADIO RADIO"),
	[MOVE_WEIRD_THING] = _("WEIRD THING"),
	[MOVE_SPIN_AROUND] = _("SPIN AROUND"),
