const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_POISON_TAIL] = _("TOXIN SLASH"),
    [MOVE_COVET] = _("COVET"),
	...
	[MOVE_SHADOW_STALK] = _("SHADOW STALK"),
	[MOVE_AURA_WAVE] = _("AURA WAVE"),
	...
	[MOVE_CHILL_TOUCH] = _("CHILL TOUCH"),
	[MOVE_LIMBER_UP] = _("LIMBER UP"),
	[MOVE_ACID_SPRAY] = _("ACID SPRAY"),
	[MOVE_SHEAR_WIND] = _("SHEAR WIND"),
	[MOVE_WASH_OFF] = _("WASH OFF"),
	[MOVE_CLEAR_SMOG] = _("CLEAR SMOG"),
	[MOVE_WHITEWATER] = _("WHITEWATER"),
	[MOVE_BLACKOUT] = _("BLACKOUT"),
	[MOVE_BLADE_STORM] = _("BLADE STORM"),
	[MOVE_HEAL_ORDER] = _("HEAL ORDER"),
	[MOVE_FUMUGATE] = _("FUMUGATE"),
	[MOVE_FADE_AWAY] = _("FADE AWAY"),
	[MOVE_BITTER_SLASH] = _("BITTER SLASH"),
	[MOVE_HORRIFY] = _("HORRIFY"),
	[MOVE_MAGIC_BURST] = _("MAGIC BURST"),
	[MOVE_PRECISE_CUT] = _("PRECISE CUT"),
	[MOVE_KOWTOW_CLEAVE] = _("KOWTOW CUT"),
	[MOVE_REND] = _("REND"),
	[MOVE_HEX] = _("HEX"),
	[MOVE_TAILWIND] = _("TAILWIND"),
	[MOVE_ARMOR_CRUSH] = _("ARMOR CRUSH"),
	[MOVE_SHORE_UP] = _("SHORE UP"),
	[MOVE_FLAME_CHARGE] = _("FLAME CHARGE"),
	[MOVE_TRAILBLAZE] = _("TRAILBLAZE"),
	[MOVE_TANTRUM] = _("TANTRUM"),
	[MOVE_STRUGGLE_BUG] = _("STRUGGLE BUG"),
	[MOVE_GEM_SPARK] = _("GEM SPARK"),
	[MOVE_MOCKERY] = _("MOCKERY"),
};
