const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
	...
	[SPECIES_CACTUMBRA] = _("CACTUMBRA"),
	[SPECIES_OBSICARGO] = _("OBSICARGO"),
	[SPECIES_NORWHALE] = _("NORWHALE"),
	...
	[SPECIES_SPOOKUM] = _("SPOOKUM"),
	[SPECIES_SPOOKUM_BUSTED] = _("SPOOKUM"),
	[SPECIES_GLASMA] = _("GLASMA"),
	[SPECIES_PLASMOLYTE] = _("PLASMOLYTE"),
	[SPECIES_STORMAGE] = _("STORMAGE"),
	[SPECIES_SANDUDE] = _("SANDUDE"),
	[SPECIES_SANDROSS] = _("DUNEBRIS"),
	[SPECIES_SANDUEL] = _("BEACHIFU"),
	[SPECIES_ELADRIFT] = _("ELADRIFT"),
	[SPECIES_SLITHURENT] = _("SLITHURENT"),
	[SPECIES_PRESCYLLON] = _("PRESCYLLON"),
	[SPECIES_SLOSHMOSH] = _("SLOSHMOSH"),
	[SPECIES_SLURPINSKI] = _("SLURPINSKI"),
	[SPECIES_KEESH] = _("KEESH"),
	[SPECIES_HATCHBLING] = _("HATCHBLING"),
	[SPECIES_HUMMBLING] = _("HUMMBLING"),
	[SPECIES_KEESIGHT] = _("KEESIGHT"),
	[SPECIES_KEESPELL] = _("KEESPELL"),
	[SPECIES_LARVOOL] = _("LARVOOL"),
	[SPECIES_SPOOLER] = _("SPOOLER"),
	[SPECIES_BILLIARACH] = _("BILLIARACH"),
	[SPECIES_SLUGMA_FONEI] = _("SLUGMA"),
	[SPECIES_MAGCARGO_FONEI] = _("MAGCARGO"),
	[SPECIES_SUNFOREST] = _("SUNFOREST"),
	[SPECIES_HONEDGE_FONEI] = _("HONEDGE"),
	[SPECIES_DOUBLADE_FONEI] = _("MAGINI"),
	[SPECIES_AEGISLASH_FONEI_A] = _("RUNICAST"),
	[SPECIES_AEGISLASH_FONEI_E] = _("RUNICAST"),
	[SPECIES_ELEMPTY] = _("ELEMPTY"),
	[SPECIES_VENEARTH] = _("VENEARTH"),
	[SPECIES_MARSIZZLE] = _("MARSIZZLE"),
	[SPECIES_JUPLASMA] = _("JUPLASMA"),
	[SPECIES_MERLPOOL] = _("MERLPOOL"),
	[SPECIES_OPHICALF] = _("OPHICALF"),
	[SPECIES_SERPENTAUR] = _("SERPENTAUR"),
	[SPECIES_GEODUDE_FONEI] = _("GEODUDE"),
	[SPECIES_GRAVELER_FONEI] = _("SNOWLEM"),
	[SPECIES_GOLEM_FONEI] = _("BASNOWLISK"),
	[SPECIES_SUDOWOODO_FONEI] = _("SUDOWOODO"),
	[SPECIES_GRITWYRM] = _("GRITWYRM"),
	[SPECIES_MOLDUNE] = _("MOLDUNE"),
	[SPECIES_WATTITUDE] = _("WATTITUDE"),
	[SPECIES_RALTS_FONEI] = _("RALTS"),
	[SPECIES_KIRLIA_FONEI] = _("KILOUETTE"),
	[SPECIES_GARDEVOIR_FONEI] = _("TUERVOIR"),
	[SPECIES_GALLADE_FONEI] = _("CALLON"),
	[SPECIES_WOOBAT] = _("WOOBAT"),
	[SPECIES_SWOOBAT] = _("SWOOBAT"),
	[SPECIES_TRUEBAT] = _("TRUEBAT"),
	[SPECIES_HOMBONE] = _("HOMBONE"),
	[SPECIES_HOMBEAST] = _("HOMBEAST"),
	[SPECIES_QWILSHARK] = _("QWILSHARK"),
	[SPECIES_KRISSY] = _("KRISSY"),
	[SPECIES_KRAKODEMON] = _("KRAKODEMON"),
	[SPECIES_WEATHERBANE] = _("WETHERBANE"),
	[SPECIES_KETSUBAN] = _("0xB-?ketsu"),
	[SPECIES_DISABY] = _("DISABY"),
	[SPECIES_DISASPRITE] = _("DISASPRITE"),
	[SPECIES_DISMASTER] = _("DISMASTER"),
	[SPECIES_PURIDIAN] = _("PURIDIAN"),
	[SPECIES_MANIPULO] = _("MANIPULO"),
	[SPECIES_COILSPILL] = _("COILSPILL"),
	[SPECIES_BOOWHO] = _("BOOWHO"),
	[SPECIES_BOOXER] = _("BOOXER"),
	[SPECIES_BOOZERKER] = _("BOOZERKER"),
	[SPECIES_DEEPDARK] = _("DEEPDARK"),
	[SPECIES_BURMITE] = _("BURMITE"),
	[SPECIES_SEDIMETAL] = _("SEDIMETAL"),
	[SPECIES_SOLOSIS_FONEI] = _("SOLOSIS"),
	[SPECIES_DUOSION_FONEI] = _("MIGHTOSIS"),
	[SPECIES_REUNICLUS_FONEI] = _("CLUSTELOT"),
	[SPECIES_VINOS] = _("VINOS"),
	[SPECIES_VINOCEIVER] = _("VINOCEIVER"),
	[SPECIES_ANNOYIDGE] = _("ANNOYIDGE"),
	[SPECIES_PESQUITO] = _("PESQUITO"),
	[SPECIES_MANKEY_FONEI] = _("MANKEY"),
	[SPECIES_PRIMEAPE_FONEI] = _("YETAPE"),
	[SPECIES_CRYOGONAL_FONEI] = _("GEOGONAL"),
	[SPECIES_AMPIBOISON] = _("AMPIBOISON"),
	[SPECIES_LAGNET] = _("LAGNET"),
	[SPECIES_LANNET] = _("LANNET"),
	[SPECIES_CYBURN] = _("CYBURN"),
	[SPECIES_SAPNOSE] = _("SAPNOSE"),
	[SPECIES_BURROOT] = _("BURROOT"),
	[SPECIES_BURRUSH] = _("BURRUSH"),
	[SPECIES_LAV] = _("LAV"),
	[SPECIES_LAVALY] = _("LAVALY"),
	[SPECIES_LAVSAMUCH] = _("LAVSAMUCH"),
	[SPECIES_GUPPAGE] = _("GUPPAGE"),
	[SPECIES_SEAGE] = _("SEAGE"),
	[SPECIES_BASSTION] = _("BASSTION"),
	[SPECIES_PANTOM] = _("PANTOM"),
	[SPECIES_HAPPANING] = _("HAPPANING"),
	[SPECIES_PANZERGAST] = _("PANZERGAST"),
	[SPECIES_SCAIRY] = _("SCAIRY"),
	[SPECIES_DANKLIMMER] = _("DANKLIMMER"),
	[SPECIES_GOLICHEM] = _("GOLICHEM"),
	[SPECIES_SPINDA_FONEI] = _("SPINDA"),
	[SPECIES_EMUNITION] = _("EMUNITION"),
	[SPECIES_EMORTAR] = _("EMORTAR"),
	[SPECIES_OPEBBLISK] = _("OPEBBLISK"),
	[SPECIES_STONUMENT] = _("STONUMENT"),
	[SPECIES_MEMOIRBLE] = _("MEMOIRBLE"),
	[SPECIES_NOKOMMON] = _("NOKOMMON"),
	[SPECIES_TANGHOUL] = _("TANGHOUL"),
	[SPECIES_QWILYU] = _("QWILYU"),
	[SPECIES_CORILIA] = _("CORILIA"),
	[SPECIES_NIDOROOK] = _("NIDOROOK"),
	[SPECIES_SKALVENGER] = _("SKALVENGER"),
	[SPECIES_SKULKREX] = _("SKULKREX"),
	[SPECIES_SKELTYRANT] = _("SKELTYRANT"),
