const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    [SPECIES_NONE] = _("??????????"),
    [SPECIES_BULBASAUR] = _("BOILBASAUR"),
    [SPECIES_IVYSAUR] = _("SHRIVLSAUR"),
    [SPECIES_VENUSAUR] = _("LEPROSAUR"),
    [SPECIES_CHARMANDER] = _("ROTMANDER"),
    [SPECIES_CHARMELEON] = _("CHARMEWORM"),
    [SPECIES_CHARIZARD] = _("DECAYZARD"),
    [SPECIES_SQUIRTLE] = _("OOZLE"),
    [SPECIES_WARTORTLE] = _("ENTRAILTLE"),
    [SPECIES_BLASTOISE] = _("BLEEDTOISE"),
    ...
    [SPECIES_POLIWAG] = _("POLIHAG"),
    [SPECIES_POLIWHIRL] = _("POLIWORM"),
    [SPECIES_POLIWRATH] = _("POLIWRAITH"),
    [SPECIES_ABRA] = _("ABRA"),
    ...
    [SPECIES_SCYTHER] = _("GRIMREAPER"),
    [SPECIES_JYNX] = _("EYE-EYE"),
    [SPECIES_ELECTABUZZ] = _("ELECTABUGZ"),
    [SPECIES_MAGMAR] = _("MIASMAR"),
    ...
    [SPECIES_MARILL] = _("GRAVEILL"),
    [SPECIES_AZUMARILL] = _("AZOMBARILL"),
    [SPECIES_SUDOWOODO] = _("SUDOWOODO"),
    [SPECIES_POLITOED] = _("POLIWART"),
    ...
    [SPECIES_HOUNDOUR] = _("HOUNDSOUR"),
    [SPECIES_HOUNDOOM] = _("HEADDOOM"),
    ...
    [SPECIES_SMOOCHUM] = _("SUCKEYE"),
    [SPECIES_ELEKID] = _("ELEKILL"),
    [SPECIES_MAGBY] = _("MIASBY"),
    ...
    [SPECIES_LATIOS] = _("STITCHER"),
    [SPECIES_JIRACHI] = _("JIRACHI"),
    [SPECIES_DEOXYS] = _("DEOXYS"),
    [SPECIES_CHIMECHO] = _("CHIMECHO"),
	[SPECIES_GORELAX] = _("GORELAX"),
	[SPECIES_SHINIGAMI] = _("SHINIGAMI"),
	[SPECIES_ANTISPIRAL] = _("ANTISPIRAL"),
	[SPECIES_DRAGON] = _("DRAGON"),
	[SPECIES_AMONSTER] = _("A MONSTER"),
	[SPECIES_FANGASU] = _("fangasu"),
	[SPECIES_NIGERA] = _("nigera"),
	[SPECIES_KURIPUTO] = _("kuriputo"),
	[SPECIES_ROODANSE] = _("roodanse"),
	[SPECIES_OOSHE] = _("ooshe"),
	[SPECIES_GOOSUBOA] = _("goosuboa"),
	[SPECIES_ROCLOBSTER] = _("ROCLOBSTER"),
	[SPECIES_X32763] = _("X32763"),
	[SPECIES_TELSON] = _("Telson"),
	[SPECIES_MAGNEZONE] = _("MAGNEZONE"),
	[SPECIES_VIGOURLAN] = _("VIGOURLAN"),
	[SPECIES_DIAMANDIX] = _("DIAMANDIX"),
	[SPECIES_GIGAWOLF] = _("GIGAWOLF"),
	[SPECIES_GALACTIMON] = _("GALACTIMON"),
	[SPECIES_QWILSHARK] = _("QWILSHARK"),
	[SPECIES_DRAGOONE] = _("DRAGOONE"),
	[SPECIES_CALFBY] = _("CALFBY"),
	[SPECIES_RAMSHAKER] = _("RAMSHAKER"),
	[SPECIES_SEVICIOUS] = _("SEVICIOUS"),
	[SPECIES_ZANGOL] = _("ZANGOL"),
	[SPECIES_PSYPIG] = _("PSYPIG"),
	[SPECIES_MUNCHLAX] = _("MUNCHLAX"),
	[SPECIES_SKYLAX] = _("SKYLAX"),
	[SPECIES_MYSTERYEGG] = _("MYSTERYEGG"),
	[SPECIES_SECRETEGG] = _("SECRETEGG"),
	[SPECIES_HYPEREGG] = _("HYPEREGG"),
	[SPECIES_HOMBONE] = _("HOMBONE"),
	[SPECIES_HOMBEAST] = _("HOMBEAST"),
	[SPECIES_KENCHIRA] = _("KENCHIRA"),
	[SPECIES_KENCHUKO] = _("KENCHUKO"),
	[SPECIES_GLUTE] = _("GLUTE"),
	[SPECIES_BUTE] = _("BUTE"),
	[SPECIES_NUTE] = _("NUTE"),
	[SPECIES_FURI_X] = _("FURI X"),
	[SPECIES_FURI_Z] = _("FURI Z"),
	[SPECIES_FURI_Q] = _("FURI Q"),
	[SPECIES_TURMUR] = _("TURMUR"),
	[SPECIES_SHADERU] = _("SHADERU"),
	[SPECIES_FACELEECH] = _("FACELEECH"),
	[SPECIES_LUCA_ZAMON] = _("LUCA ZAMÓN"),
	[SPECIES_TEA_BARCAN] = _("TÉA BARQÁN"),
	[SPECIES_MINICE] = _("MINICE"),
	[SPECIES_MINIROCK] = _("MINIROCK"),
	[SPECIES_MINISTEEL] = _("MINISTEEL"),
	[SPECIES_GENEROBO] = _("GENEROBO"),
