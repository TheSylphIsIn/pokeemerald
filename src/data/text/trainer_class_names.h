const u8 gTrainerClassNames[][13] = {
    ...
    [TRAINER_CLASS_BUG_MANIAC] = _("LOOTER"),
    [TRAINER_CLASS_PSYCHIC] = _("TAOIST"),
	...
	[TRAINER_CLASS_DEATHCALLER] = _("DEATHCALLER"),
	[TRAINER_CLASS_ZOMBIE_KID] = _("ZOMBIE KID"),
	[TRAINER_CLASS_GHOST_GIRL] = _("GHOST GIRL"),
	[TRAINER_CLASS_SURVIVOR] = _("SURVIVOR"),
	[TRAINER_CLASS_DEMON_CORPSE] = _("DEMON CORPSE"),
	[TRAINER_CLASS_DEMON] = _("DEMON"),
	[TRAINER_CLASS_ARCHDEMON] = _("ARCHDEMON"),
};
