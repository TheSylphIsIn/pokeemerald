...
const u32 gTrainerFrontPic_Morgan[] = INCBIN_U32("graphics/trainers/front_pics/morgan.4bpp.lz");
const u32 gTrainerPalette_Morgan[] = INCBIN_U32("graphics/trainers/front_pics/morgan.gbapal.lz");

const u32 gTrainerFrontPic_Calvin[] = INCBIN_U32("graphics/trainers/front_pics/calvin.4bpp.lz");
const u32 gTrainerPalette_Calvin[] = INCBIN_U32("graphics/trainers/front_pics/calvin.gbapal.lz");
