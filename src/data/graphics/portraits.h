...
const u32 sPortraitPic_KinglerLaugh[] = INCBIN_U32("graphics/portraits/kingler_laugh.4bpp.lz");
const u32 sPortraitPal_KinglerLaugh[] = INCBIN_U32("graphics/portraits/kingler_laugh.gbapal.lz");
