...
const u32 gItemIconPalette_FireDust[] = INCBIN_U32("graphics/items/icon_palettes/fire_dust.gbapal.lz");
const u32 gItemIconPalette_WaterDust[] = INCBIN_U32("graphics/items/icon_palettes/water_dust.gbapal.lz");
const u32 gItemIconPalette_ElecDust[] = INCBIN_U32("graphics/items/icon_palettes/elec_dust.gbapal.lz");
const u32 gItemIconPalette_LeafDust[] = INCBIN_U32("graphics/items/icon_palettes/leaf_dust.gbapal.lz");
