static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_RUSTBORO_CITY - 1] = {MAP_GROUP(RUSTBORO_CITY), MAP_NUM(RUSTBORO_CITY), 9, 39},
    ...
    [HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE - 1] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 10, 9},
    ...
    [HEAL_LOCATION_ACTUAL_HELL_LANDING - 1] = {MAP_GROUP(ACTUAL_HELL_LANDING), MAP_NUM(ACTUAL_HELL_LANDING), 4, 4},
};
