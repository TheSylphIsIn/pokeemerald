static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_GAME_OVER_MAP1 - 1] = {MAP_GROUP(GAME_OVER_MAP1), MAP_NUM(GAME_OVER_MAP1), 7, 5},
    [HEAL_LOCATION_GAME_OVER_MAP2 - 1] = {MAP_GROUP(GAME_OVER_MAP2), MAP_NUM(GAME_OVER_MAP2), 7, 5},
};
