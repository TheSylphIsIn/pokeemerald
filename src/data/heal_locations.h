static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_DREAMY_ABYSS - 1] = {MAP_GROUP(DREAMY_ABYSS), MAP_NUM(DREAMY_ABYSS), 10, 41},
    [HEAL_LOCATION_CRAN_TOWN - 1] = {MAP_GROUP(CRAN_TOWN), MAP_NUM(CRAN_TOWN), 6, 14},
    [HEAL_LOCATION_PENZEL_CITY - 1] = {MAP_GROUP(PENZEL_CITY), MAP_NUM(PENZEL_CITY), 60, 17},
    [HEAL_LOCATION_PORT_WANDER - 1] = {MAP_GROUP(PORT_WANDER), MAP_NUM(PORT_WANDER), 38, 12},
};
