const struct MonCoords gTrainerFrontPicCoords[] =
{
	...
	[TRAINER_PIC_MORGAN] = {.size = 8, .y_offset = 1},
	[TRAINER_PIC_CALVIN] = {.size = 8, .y_offset = 1},
};
...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
	...
	TRAINER_SPRITE(MORGAN, gTrainerFrontPic_Morgan, TRAINER_PIC_SIZE),
	TRAINER_SPRITE(CALVIN, gTrainerFrontPic_Calvin, TRAINER_PIC_SIZE),
};
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
	...
	TRAINER_PAL(MORGAN, gTrainerPalette_Morgan),
	TRAINER_PAL(CALVIN, gTrainerPalette_Calvin),
};
