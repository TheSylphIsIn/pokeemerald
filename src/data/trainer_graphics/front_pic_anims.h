...
static const union AnimCmd *const sAnims_Morgan[] ={
    sAnim_GeneralFrame0,
};

static const union AnimCmd *const sAnims_Calvin[] ={
    sAnim_GeneralFrame0,
};
...
const union AnimCmd *const *const gTrainerFrontAnimsPtrTable[] =
{
	...
	[TRAINER_PIC_MORGAN] = sAnims_Morgan,
	[TRAINER_PIC_CALVIN] = sAnims_Calvin,
};
