...
const u16 gMetatiles_TheForest[] = INCBIN_U16("data/tilesets/secondary/the_forest/metatiles.bin");
const u16 gMetatileAttributes_TheForest[] = INCBIN_U16("data/tilesets/secondary/the_forest/metatile_attributes.bin");
