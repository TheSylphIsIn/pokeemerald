...
const struct MonCoords gMonFrontPicCoords[] =
{
	...
	[SPECIES_GORELAX] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_SHINIGAMI] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_ANTISPIRAL] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_DRAGON] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_AMONSTER] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_FANGASU] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_NIGERA] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_KURIPUTO] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_ROODANSE] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_OOSHE] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_GOOSUBOA] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_ROCLOBSTER] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_X32763] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_TELSON] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_MAGNEZONE] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_VIGOURLAN] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_DIAMANDIX] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_GIGAWOLF] = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  12 },
	[SPECIES_GALACTIMON] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_QWILSHARK] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_DRAGOONE] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  7 },
	[SPECIES_CALFBY] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_RAMSHAKER] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_SEVICIOUS] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_ZANGOL] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_PSYPIG] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_MUNCHLAX] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_SKYLAX] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_MYSTERYEGG] = { .size = MON_COORDS_SIZE(32, 32), .y_offset =  20 },
	[SPECIES_SECRETEGG] = { .size = MON_COORDS_SIZE(32, 32), .y_offset =  20 },
	[SPECIES_HYPEREGG] = { .size = MON_COORDS_SIZE(32, 32), .y_offset =  20 },
	[SPECIES_HOMBONE] = { .size = MON_COORDS_SIZE(64, 48), .y_offset =  6 },
	[SPECIES_HOMBEAST] = { .size = MON_COORDS_SIZE(64, 48), .y_offset =  6 },
	[SPECIES_KENCHIRA] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_KENCHUKO] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_GLUTE] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_BUTE] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_NUTE] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_FURI_X] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_FURI_Z] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_FURI_Q] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_TURMUR] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_SHADERU] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_FACELEECH] = { .size = MON_COORDS_SIZE(40, 48), .y_offset =  11 },
	[SPECIES_LUCA_ZAMON] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_TEA_BARCAN] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_MINICE] = { .size = MON_COORDS_SIZE(24, 28), .y_offset =  18 },
