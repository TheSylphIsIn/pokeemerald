...
const struct MonCoords gMonFrontPicCoords[] =
{
    ...
    [SPECIES_BULBASAUR]   = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  3 },
    [SPECIES_IVYSAUR]     = { .size = MON_COORDS_SIZE(60, 64), .y_offset =  0 },
    ...
    [SPECIES_CATERPIE]    = { .size = MON_COORDS_SIZE(52, 36), .y_offset =  5 },
    [SPECIES_METAPOD]     = { .size = MON_COORDS_SIZE(48, 44), .y_offset =  7 },
    [SPECIES_BUTTERFREE]  = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  1 },
    ...
    [SPECIES_NIDORINO]    = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  0 },
    ...
    [SPECIES_PARASECT]    = { .size = MON_COORDS_SIZE(44, 60), .y_offset =  5 },
    ...
    [SPECIES_WEEPINBELL]  = { .size = MON_COORDS_SIZE(64, 60), .y_offset = 1 },
    ...
    [SPECIES_SLOWPOKE]    = { .size = MON_COORDS_SIZE(44, 52), .y_offset =  9 },
    ...
    [SPECIES_DODRIO]      = { .size = MON_COORDS_SIZE(44, 64), .y_offset =  0 },
    ...
    [SPECIES_CLOYSTER]    = { .size = MON_COORDS_SIZE(60, 56), .y_offset =  1 },
    ...
    [SPECIES_SKARMORY]    = { .size = MON_COORDS_SIZE(64, 60), .y_offset =  2 },
    ...
    [SPECIES_PORYGON2]    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  4 },
    ...
    [SPECIES_LUNATONE]    = { .size = MON_COORDS_SIZE(64, 60), .y_offset =  3 },
    [SPECIES_SOLROCK]     = { .size = MON_COORDS_SIZE(64, 60), .y_offset =  1 },
