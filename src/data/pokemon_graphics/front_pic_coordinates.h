...
const struct MonCoords gMonFrontPicCoords[] =
{
	...
	[SPECIES_SECRETEGG] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_HYPEREGG] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
