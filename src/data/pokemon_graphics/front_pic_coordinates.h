...
const struct MonCoords gMonFrontPicCoords[] =
{
	...
	[SPECIES_DUBSNAKE] 	  =	{ .size = MON_COORDS_SIZE(46, 44), .y_offset = 14 },
	[SPECIES_HYDROIL] 	  = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_WYCERN] 	  = { .size = MON_COORDS_SIZE(62, 60), .y_offset =  1 },
	[SPECIES_BITTERAGON]  =	{ .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_CACTUMBRA]   = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_OBSICARGO]   = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_NORWHALE]	  = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_MINIOR_METEOR] = { .size = MON_COORDS_SIZE(44, 44), .y_offset =  0 },
	[SPECIES_MINIOR_CORE] = { .size = MON_COORDS_SIZE(44, 44), .y_offset =  0 },
	...
	[SPECIES_SLUGMA_FONEI] = { .size = MON_COORDS_SIZE(32, 40), .y_offset = 13 },
	[SPECIES_MAGCARGO_FONEI] = { .size = MON_COORDS_SIZE(40, 48), .y_offset = 13 },
	...
	[SPECIES_WATTITUDE]   = {	.size = MON_COORDS_SIZE(64, 64), .y_offset =  1 },
	...
	[SPECIES_DISABY] = { .size = MON_COORDS_SIZE(52, 52), .y_offset =  6 },
	...
	[SPECIES_MANIPULO] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  1 },
