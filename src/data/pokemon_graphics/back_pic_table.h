const struct CompressedSpriteSheet gMonBackPicTable[] =
{
	...
	SPECIES_SPRITE(GORELAX, gMonBackPic_Gorelax),
	SPECIES_SPRITE(SHINIGAMI, gMonBackPic_Shinigami),
	SPECIES_SPRITE(ANTISPIRAL, gMonBackPic_Antispiral),
	SPECIES_SPRITE(DRAGON, gMonBackPic_Dragon),
	SPECIES_SPRITE(AMONSTER, gMonBackPic_Amonster),
	SPECIES_SPRITE(FANGASU, gMonBackPic_Fangasu),
	SPECIES_SPRITE(NIGERA, gMonBackPic_Nigera),
	SPECIES_SPRITE(KURIPUTO, gMonBackPic_Kuriputo),
	SPECIES_SPRITE(ROODANSE, gMonBackPic_Roodanse),
	SPECIES_SPRITE(OOSHE, gMonBackPic_Ooshe),
	SPECIES_SPRITE(GOOSUBOA, gMonBackPic_Goosuboa),
	SPECIES_SPRITE(ROCLOBSTER, gMonBackPic_Roclobster),
	SPECIES_SPRITE(X32763, gMonBackPic_X32763),
	SPECIES_SPRITE(TELSON, gMonBackPic_Telson),
	SPECIES_SPRITE(MAGNEZONE, gMonBackPic_Magnezone),
	SPECIES_SPRITE(VIGOURLAN, gMonBackPic_Vigourlan),
	SPECIES_SPRITE(DIAMANDIX, gMonBackPic_Diamandix),
	SPECIES_SPRITE(GIGAWOLF, gMonBackPic_Gigawolf),
	SPECIES_SPRITE(GALACTIMON, gMonBackPic_Galactimon),
	SPECIES_SPRITE(QWILSHARK, gMonBackPic_Qwilshark),
	SPECIES_SPRITE(DRAGOONE, gMonBackPic_Dragoone),
	SPECIES_SPRITE(CALFBY, gMonBackPic_Calfby),
	SPECIES_SPRITE(RAMSHAKER, gMonBackPic_Ramshaker),
	SPECIES_SPRITE(SEVICIOUS, gMonBackPic_Sevicious),
	SPECIES_SPRITE(ZANGOL, gMonBackPic_Zangol),
	SPECIES_SPRITE(PSYPIG, gMonBackPic_Psypig),
	SPECIES_SPRITE(MUNCHLAX, gMonBackPic_Munchlax),
	SPECIES_SPRITE(SKYLAX, gMonBackPic_Skylax),
	SPECIES_SPRITE(MYSTERYEGG, gMonBackPic_Mysteryegg),
	SPECIES_SPRITE(SECRETEGG, gMonBackPic_Secretegg),
	SPECIES_SPRITE(HYPEREGG, gMonBackPic_Hyperegg),
	SPECIES_SPRITE(HOMBONE, gMonBackPic_Hombone),
	SPECIES_SPRITE(HOMBEAST, gMonBackPic_Hombeast),
	SPECIES_SPRITE(KENCHIRA, gMonBackPic_Kenchira),
	SPECIES_SPRITE(KENCHUKO, gMonBackPic_Kenchuko),
	SPECIES_SPRITE(GLUTE, gMonBackPic_Glute),
	SPECIES_SPRITE(BUTE, gMonBackPic_Bute),
	SPECIES_SPRITE(NUTE, gMonBackPic_Nute),
	SPECIES_SPRITE(FURI_X, gMonBackPic_FuriX),
	SPECIES_SPRITE(FURI_Z, gMonBackPic_FuriZ),
	SPECIES_SPRITE(FURI_Q, gMonBackPic_FuriQ),
	SPECIES_SPRITE(TURMUR, gMonBackPic_Turmur),
	SPECIES_SPRITE(SHADERU, gMonBackPic_Shaderu),
	SPECIES_SPRITE(FACELEECH, gMonBackPic_Faceleech),
	SPECIES_SPRITE(LUCA_ZAMON, gMonBackPic_LucaZamon),
	SPECIES_SPRITE(TEA_BARCAN, gMonBackPic_TeaBarcan),
	SPECIES_SPRITE(MINICE, gMonBackPic_Minice),
	SPECIES_SPRITE(MINIROCK, gMonBackPic_Minirock),
	SPECIES_SPRITE(MINISTEEL, gMonBackPic_Ministeel),
	SPECIES_SPRITE(GENEROBO, gMonBackPic_Generobo),
