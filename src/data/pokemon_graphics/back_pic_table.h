const struct CompressedSpriteSheet gMonBackPicTable[] =
{
	...
	SPECIES_SPRITE(CACTUMBRA, gMonBackPic_Cactumbra),
	SPECIES_SPRITE(OBSICARGO, gMonBackPic_Obsicargo),
	SPECIES_SPRITE(NORWHALE, gMonBackPic_Norwhale),
	SPECIES_SPRITE(MINIOR_METEOR, gMonBackPic_Minior),
	SPECIES_SPRITE(MINIOR_CORE, gMonBackPic_MiniorCore),
	SPECIES_SPRITE(SPOOKUM, gMonBackPic_Spookum),
	SPECIES_SPRITE(SPOOKUM_BUSTED, gMonBackPic_SpookumBusted),
	SPECIES_SPRITE(GLASMA, gMonBackPic_Glasma),
	SPECIES_SPRITE(PLASMOLYTE, gMonBackPic_Plasmolyte),
	SPECIES_SPRITE(STORMAGE, gMonBackPic_Stormage),
	SPECIES_SPRITE(SANDUDE, gMonBackPic_Sandude),
	SPECIES_SPRITE(SANDROSS, gMonBackPic_Sandross),
	SPECIES_SPRITE(SANDUEL, gMonBackPic_Sanduel),
	SPECIES_SPRITE(ELADRIFT, gMonBackPic_Eladrift),
	SPECIES_SPRITE(SLITHURENT, gMonBackPic_Slithurent),
	SPECIES_SPRITE(PRESCYLLON, gMonBackPic_Prescyllon),
	SPECIES_SPRITE(SLOSHMOSH, gMonBackPic_Sloshmosh),
	SPECIES_SPRITE(SLURPINSKI, gMonBackPic_Slurpinski),
	SPECIES_SPRITE(KEESH, gMonBackPic_Keesh),
	SPECIES_SPRITE(HATCHBLING, gMonBackPic_Hatchbling),
	SPECIES_SPRITE(HUMMBLING, gMonBackPic_Hummbling),
	SPECIES_SPRITE(KEESIGHT, gMonBackPic_Keesight),
	SPECIES_SPRITE(KEESPELL, gMonBackPic_Keespell),
	SPECIES_SPRITE(LARVOOL, gMonBackPic_Larvool),
	SPECIES_SPRITE(SPOOLER, gMonBackPic_Spooler),
	SPECIES_SPRITE(BILLIARACH, gMonBackPic_Billiarach),
	SPECIES_SPRITE(SLUGMA_FONEI, gMonBackPic_SlugmaFonei),
	SPECIES_SPRITE(MAGCARGO_FONEI, gMonBackPic_MagcargoFonei),
	SPECIES_SPRITE(SUNFOREST, gMonBackPic_Sunforest),
	SPECIES_SPRITE(HONEDGE_FONEI, gMonBackPic_HonedgeFonei),
	SPECIES_SPRITE(DOUBLADE_FONEI, gMonBackPic_DoubladeFonei),
	SPECIES_SPRITE(AEGISLASH_FONEI_A, gMonBackPic_AegislashFoneiA),
	SPECIES_SPRITE(AEGISLASH_FONEI_E, gMonBackPic_AegislashFoneiE),
	SPECIES_SPRITE(ELEMPTY, gMonBackPic_Elempty),
	SPECIES_SPRITE(VENEARTH, gMonBackPic_Venearth),
	SPECIES_SPRITE(MARSIZZLE, gMonBackPic_Marsizzle),
	SPECIES_SPRITE(JUPLASMA, gMonBackPic_Juplasma),
	SPECIES_SPRITE(MERLPOOL, gMonBackPic_Merlpool),
	SPECIES_SPRITE(OPHICALF, gMonBackPic_Ophicalf),
	SPECIES_SPRITE(SERPENTAUR, gMonBackPic_Serpentaur),
	SPECIES_SPRITE(GEODUDE_FONEI, gMonBackPic_GeodudeFonei),
	SPECIES_SPRITE(GRAVELER_FONEI, gMonBackPic_GravelerFonei),
	SPECIES_SPRITE(GOLEM_FONEI, gMonBackPic_GolemFonei),
	SPECIES_SPRITE(SUDOWOODO_FONEI, gMonBackPic_SudowoodoFonei),
	SPECIES_SPRITE(GRITWYRM, gMonBackPic_Gritwyrm),
	SPECIES_SPRITE(MOLDUNE, gMonBackPic_Moldune),
	SPECIES_SPRITE(WATTITUDE, gMonBackPic_Wattitude),
	SPECIES_SPRITE(RALTS_FONEI, gMonBackPic_RaltsFonei),
	SPECIES_SPRITE(KIRLIA_FONEI, gMonBackPic_KirliaFonei),
	SPECIES_SPRITE(GARDEVOIR_FONEI, gMonBackPic_GardevoirFonei),
	SPECIES_SPRITE(GALLADE_FONEI, gMonBackPic_GalladeFonei),
	SPECIES_SPRITE(WOOBAT, gMonBackPic_Woobat),
	SPECIES_SPRITE(SWOOBAT, gMonBackPic_Swoobat),
	SPECIES_SPRITE(TRUEBAT, gMonBackPic_Truebat),
	SPECIES_SPRITE(HOMBONE, gMonBackPic_Hombone),
	SPECIES_SPRITE(HOMBEAST, gMonBackPic_Hombeast),
	SPECIES_SPRITE(QWILSHARK, gMonBackPic_Qwilshark),
	SPECIES_SPRITE(KRISSY, gMonBackPic_Krissy),
	SPECIES_SPRITE(KRAKODEMON, gMonBackPic_Krakodemon),
	SPECIES_SPRITE(WEATHERBANE, gMonBackPic_Weatherbane),
	SPECIES_SPRITE(KETSUBAN, gMonBackPic_Ketsuban),
	SPECIES_SPRITE(DISABY, gMonBackPic_Disaby),
	SPECIES_SPRITE(DISASPRITE, gMonBackPic_Disasprite),
	SPECIES_SPRITE(DISMASTER, gMonBackPic_Dismaster),
	SPECIES_SPRITE(PURIDIAN, gMonBackPic_Puridian),
	SPECIES_SPRITE(MANIPULO, gMonBackPic_Manipulo),
	SPECIES_SPRITE(COILSPILL, gMonBackPic_Coilspill),
	SPECIES_SPRITE(BOOWHO, gMonBackPic_Boowho),
	SPECIES_SPRITE(BOOXER, gMonBackPic_Booxer),
	SPECIES_SPRITE(BOOZERKER, gMonBackPic_Boozerker),
	SPECIES_SPRITE(DEEPDARK, gMonBackPic_Deepdark),
	SPECIES_SPRITE(BURMITE, gMonBackPic_Burmite),
	SPECIES_SPRITE(SEDIMETAL, gMonBackPic_Sedimetal),
	SPECIES_SPRITE(SOLOSIS_FONEI, gMonBackPic_SolosisFonei),
	SPECIES_SPRITE(DUOSION_FONEI, gMonBackPic_DuosionFonei),
	SPECIES_SPRITE(REUNICLUS_FONEI, gMonBackPic_ReuniclusFonei),
	SPECIES_SPRITE(VINOS, gMonBackPic_Vinos),
	SPECIES_SPRITE(VINOCEIVER, gMonBackPic_Vinoceiver),
	SPECIES_SPRITE(ANNOYIDGE, gMonBackPic_Annoyidge),
	SPECIES_SPRITE(PESQUITO, gMonBackPic_Pesquito),
	SPECIES_SPRITE(MANKEY_FONEI, gMonBackPic_MankeyFonei),
	SPECIES_SPRITE(PRIMEAPE_FONEI, gMonBackPic_PrimeapeFonei),
	SPECIES_SPRITE(CRYOGONAL_FONEI, gMonBackPic_CryogonalFonei),
	SPECIES_SPRITE(AMPIBOISON, gMonBackPic_Ampiboison),
	SPECIES_SPRITE(LAGNET, gMonBackPic_Lagnet),
	SPECIES_SPRITE(LANNET, gMonBackPic_Lannet),
	SPECIES_SPRITE(CYBURN, gMonBackPic_Cyburn),
	SPECIES_SPRITE(SAPNOSE, gMonBackPic_Sapnose),
	SPECIES_SPRITE(BURROOT, gMonBackPic_Burroot),
	SPECIES_SPRITE(BURRUSH, gMonBackPic_Burrush),
	SPECIES_SPRITE(LAV, gMonBackPic_Lav),
	SPECIES_SPRITE(LAVALY, gMonBackPic_Lavaly),
	SPECIES_SPRITE(LAVSAMUCH, gMonBackPic_Lavsamuch),
	SPECIES_SPRITE(GUPPAGE, gMonBackPic_Guppage),
	SPECIES_SPRITE(SEAGE, gMonBackPic_Seage),
	SPECIES_SPRITE(BASSTION, gMonBackPic_Basstion),
	SPECIES_SPRITE(PANTOM, gMonBackPic_Pantom),
	SPECIES_SPRITE(HAPPANING, gMonBackPic_Happaning),
	SPECIES_SPRITE(PANZERGAST, gMonBackPic_Panzergast),
	SPECIES_SPRITE(SCAIRY, gMonBackPic_Scairy),
	SPECIES_SPRITE(DANKLIMMER, gMonBackPic_Danklimmer),
	SPECIES_SPRITE(GOLICHEM, gMonBackPic_Golichem),
	SPECIES_SPRITE(SPINDA_FONEI, gMonBackPic_SpindaFonei),
	SPECIES_SPRITE(EMUNITION, gMonBackPic_Emunition),
	SPECIES_SPRITE(EMORTAR, gMonBackPic_Emortar),
	SPECIES_SPRITE(OPEBBLISK, gMonBackPic_Opebblisk),
	SPECIES_SPRITE(STONUMENT, gMonBackPic_Stonument),
	SPECIES_SPRITE(MEMOIRBLE, gMonBackPic_Memoirble),
	SPECIES_SPRITE(NOKOMMON, gMonBackPic_Nokommon),
	SPECIES_SPRITE(TANGHOUL, gMonBackPic_Tanghoul),
	SPECIES_SPRITE(QWILYU, gMonBackPic_Qwilyu),
	SPECIES_SPRITE(CORILIA, gMonBackPic_Corilia),
	SPECIES_SPRITE(NIDOROOK, gMonBackPic_Nidorook),
	SPECIES_SPRITE(SKALVENGER, gMonBackPic_Skalvenger),
	SPECIES_SPRITE(SKULKREX, gMonBackPic_Skulkrex),
	SPECIES_SPRITE(SKELTYRANT, gMonBackPic_Skeltyrant),

	// SPECIES_SPRITE(SPCS, gMonBackPic_Spcs),
