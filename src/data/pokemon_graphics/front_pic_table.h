const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
	...
	SPECIES_SPRITE(CACTUMBRA, gMonFrontPic_Cactumbra),
	SPECIES_SPRITE(OBSICARGO, gMonFrontPic_Obsicargo),
	SPECIES_SPRITE(NORWHALE, gMonFrontPic_Norwhale),
	...
	SPECIES_SPRITE(SPOOKUM, gMonFrontPic_Spookum),
	SPECIES_SPRITE(SPOOKUM_BUSTED, gMonFrontPic_SpookumBusted),
	SPECIES_SPRITE(GLASMA, gMonFrontPic_Glasma),
	SPECIES_SPRITE(PLASMOLYTE, gMonFrontPic_Plasmolyte),
	SPECIES_SPRITE(STORMAGE, gMonFrontPic_Stormage),
	SPECIES_SPRITE(SANDUDE, gMonFrontPic_Sandude),
	SPECIES_SPRITE(SANDROSS, gMonFrontPic_Sandross),
	SPECIES_SPRITE(SANDUEL, gMonFrontPic_Sanduel),
	SPECIES_SPRITE(ELADRIFT, gMonFrontPic_Eladrift),
	SPECIES_SPRITE(SLITHURENT, gMonFrontPic_Slithurent),
	SPECIES_SPRITE(PRESCYLLON, gMonFrontPic_Prescyllon),
	SPECIES_SPRITE(SLOSHMOSH, gMonFrontPic_Sloshmosh),
	SPECIES_SPRITE(SLURPINSKI, gMonFrontPic_Slurpinski),
	SPECIES_SPRITE(KEESH, gMonFrontPic_Keesh),
	SPECIES_SPRITE(HATCHBLING, gMonFrontPic_Hatchbling),
	SPECIES_SPRITE(HUMMBLING, gMonFrontPic_Hummbling),
	SPECIES_SPRITE(KEESIGHT, gMonFrontPic_Keesight),
	SPECIES_SPRITE(KEESPELL, gMonFrontPic_Keespell),
	SPECIES_SPRITE(LARVOOL, gMonFrontPic_Larvool),
	SPECIES_SPRITE(SPOOLER, gMonFrontPic_Spooler),
	SPECIES_SPRITE(BILLIARACH, gMonFrontPic_Billiarach),
	SPECIES_SPRITE(SLUGMA_FONEI, gMonFrontPic_SlugmaFonei),
	SPECIES_SPRITE(MAGCARGO_FONEI, gMonFrontPic_MagcargoFonei),
	SPECIES_SPRITE(SUNFOREST, gMonFrontPic_Sunforest),
	SPECIES_SPRITE(HONEDGE_FONEI, gMonFrontPic_HonedgeFonei),
	SPECIES_SPRITE(DOUBLADE_FONEI, gMonFrontPic_DoubladeFonei),
	SPECIES_SPRITE(AEGISLASH_FONEI_A, gMonFrontPic_AegislashFoneiA),
	SPECIES_SPRITE(AEGISLASH_FONEI_E, gMonFrontPic_AegislashFoneiE),
	SPECIES_SPRITE(ELEMPTY, gMonFrontPic_Elempty),
	SPECIES_SPRITE(VENEARTH, gMonFrontPic_Venearth),
	SPECIES_SPRITE(MARSIZZLE, gMonFrontPic_Marsizzle),
	SPECIES_SPRITE(JUPLASMA, gMonFrontPic_Juplasma),
	SPECIES_SPRITE(MERLPOOL, gMonFrontPic_Merlpool),
	SPECIES_SPRITE(OPHICALF, gMonFrontPic_Ophicalf),
	SPECIES_SPRITE(SERPENTAUR, gMonFrontPic_Serpentaur),
	SPECIES_SPRITE(GEODUDE_FONEI, gMonFrontPic_GeodudeFonei),
	SPECIES_SPRITE(GRAVELER_FONEI, gMonFrontPic_GravelerFonei),
	SPECIES_SPRITE(GOLEM_FONEI, gMonFrontPic_GolemFonei),
	SPECIES_SPRITE(SUDOWOODO_FONEI, gMonFrontPic_SudowoodoFonei),
	SPECIES_SPRITE(GRITWYRM, gMonFrontPic_Gritwyrm),
	SPECIES_SPRITE(MOLDUNE, gMonFrontPic_Moldune),
	SPECIES_SPRITE(WATTITUDE, gMonFrontPic_Wattitude),
	SPECIES_SPRITE(RALTS_FONEI, gMonFrontPic_RaltsFonei),
	SPECIES_SPRITE(KIRLIA_FONEI, gMonFrontPic_KirliaFonei),
	SPECIES_SPRITE(GARDEVOIR_FONEI, gMonFrontPic_GardevoirFonei),
	SPECIES_SPRITE(GALLADE_FONEI, gMonFrontPic_GalladeFonei),
	SPECIES_SPRITE(WOOBAT, gMonFrontPic_Woobat),
	SPECIES_SPRITE(SWOOBAT, gMonFrontPic_Swoobat),
	SPECIES_SPRITE(TRUEBAT, gMonFrontPic_Truebat),
	SPECIES_SPRITE(HOMBONE, gMonFrontPic_Hombone),
	SPECIES_SPRITE(HOMBEAST, gMonFrontPic_Hombeast),
	SPECIES_SPRITE(QWILSHARK, gMonFrontPic_Qwilshark),
	SPECIES_SPRITE(KRISSY, gMonFrontPic_Krissy),
	SPECIES_SPRITE(KRAKODEMON, gMonFrontPic_Krakodemon),
	SPECIES_SPRITE(WEATHERBANE, gMonFrontPic_Weatherbane),
	SPECIES_SPRITE(KETSUBAN, gMonFrontPic_Ketsuban),
	// SPECIES_SPRITE(SPCS, gMonFrontPic_Spcs),
	...
	SPECIES_SPRITE(DISABY, gMonFrontPic_Disaby),
	SPECIES_SPRITE(DISASPRITE, gMonFrontPic_Disasprite),
	SPECIES_SPRITE(DISMASTER, gMonFrontPic_Dismaster),
	SPECIES_SPRITE(PURIDIAN, gMonFrontPic_Puridian),
	SPECIES_SPRITE(MANIPULO, gMonFrontPic_Manipulo),
	SPECIES_SPRITE(COILSPILL, gMonFrontPic_Coilspill),
	SPECIES_SPRITE(BOOWHO, gMonFrontPic_Boowho),
	SPECIES_SPRITE(BOOXER, gMonFrontPic_Booxer),
	SPECIES_SPRITE(BOOZERKER, gMonFrontPic_Boozerker),
	SPECIES_SPRITE(DEEPDARK, gMonFrontPic_Deepdark),
	SPECIES_SPRITE(BURMITE, gMonFrontPic_Burmite),
	SPECIES_SPRITE(SEDIMETAL, gMonFrontPic_Sedimetal),
	SPECIES_SPRITE(SOLOSIS_FONEI, gMonFrontPic_SolosisFonei),
	SPECIES_SPRITE(DUOSION_FONEI, gMonFrontPic_DuosionFonei),
	SPECIES_SPRITE(REUNICLUS_FONEI, gMonFrontPic_ReuniclusFonei),
	SPECIES_SPRITE(VINOS, gMonFrontPic_Vinos),
	SPECIES_SPRITE(VINOCEIVER, gMonFrontPic_Vinoceiver),
	SPECIES_SPRITE(ANNOYIDGE, gMonFrontPic_Annoyidge),
	SPECIES_SPRITE(PESQUITO, gMonFrontPic_Pesquito),
	SPECIES_SPRITE(MANKEY_FONEI, gMonFrontPic_MankeyFonei),
	SPECIES_SPRITE(PRIMEAPE_FONEI, gMonFrontPic_PrimeapeFonei),
	SPECIES_SPRITE(CRYOGONAL_FONEI, gMonFrontPic_CryogonalFonei),
	SPECIES_SPRITE(AMPIBOISON, gMonFrontPic_Ampiboison),
	SPECIES_SPRITE(LAGNET, gMonFrontPic_Lagnet),
	SPECIES_SPRITE(LANNET, gMonFrontPic_Lannet),
	SPECIES_SPRITE(CYBURN, gMonFrontPic_Cyburn),
	SPECIES_SPRITE(SAPNOSE, gMonFrontPic_Sapnose),
	SPECIES_SPRITE(BURROOT, gMonFrontPic_Burroot),
	SPECIES_SPRITE(BURRUSH, gMonFrontPic_Burrush),
	SPECIES_SPRITE(LAV, gMonFrontPic_Lav),
	SPECIES_SPRITE(LAVALY, gMonFrontPic_Lavaly),
	SPECIES_SPRITE(LAVSAMUCH, gMonFrontPic_Lavsamuch),
	SPECIES_SPRITE(GUPPAGE, gMonFrontPic_Guppage),
	SPECIES_SPRITE(SEAGE, gMonFrontPic_Seage),
	SPECIES_SPRITE(BASSTION, gMonFrontPic_Basstion),
	SPECIES_SPRITE(PANTOM, gMonFrontPic_Pantom),
	SPECIES_SPRITE(HAPPANING, gMonFrontPic_Happaning),
	SPECIES_SPRITE(PANZERGAST, gMonFrontPic_Panzergast),
	SPECIES_SPRITE(SCAIRY, gMonFrontPic_Scairy),
	SPECIES_SPRITE(DANKLIMMER, gMonFrontPic_Danklimmer),
	SPECIES_SPRITE(GOLICHEM, gMonFrontPic_Golichem),
	SPECIES_SPRITE(SPINDA_FONEI, gMonFrontPic_SpindaFonei),
	SPECIES_SPRITE(EMUNITION, gMonFrontPic_Emunition),
	SPECIES_SPRITE(EMORTAR, gMonFrontPic_Emortar),
	SPECIES_SPRITE(OPEBBLISK, gMonFrontPic_Opebblisk),
	SPECIES_SPRITE(STONUMENT, gMonFrontPic_Stonument),
	SPECIES_SPRITE(MEMOIRBLE, gMonFrontPic_Memoirble),
	SPECIES_SPRITE(NOKOMMON, gMonFrontPic_Nokommon),
	SPECIES_SPRITE(TANGHOUL, gMonFrontPic_Tanghoul),
	SPECIES_SPRITE(QWILYU, gMonFrontPic_Qwilyu),
	SPECIES_SPRITE(CORILIA, gMonFrontPic_Corilia),
	SPECIES_SPRITE(NIDOROOK, gMonFrontPic_Nidorook),
	SPECIES_SPRITE(SKALVENGER, gMonFrontPic_Skalvenger),
	SPECIES_SPRITE(SKULKREX, gMonFrontPic_Skulkrex),
	SPECIES_SPRITE(SKELTYRANT, gMonFrontPic_Skeltyrant),
