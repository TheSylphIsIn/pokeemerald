const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
	...
	SPECIES_SPRITE(GORELAX, gMonFrontPic_Gorelax),
	SPECIES_SPRITE(SHINIGAMI, gMonFrontPic_Shinigami),
	SPECIES_SPRITE(ANTISPIRAL, gMonFrontPic_Antispiral),
	SPECIES_SPRITE(DRAGON, gMonFrontPic_Dragon),
	SPECIES_SPRITE(AMONSTER, gMonFrontPic_Amonster),
	SPECIES_SPRITE(FANGASU, gMonFrontPic_Fangasu),
	SPECIES_SPRITE(NIGERA, gMonFrontPic_Nigera),
	SPECIES_SPRITE(KURIPUTO, gMonFrontPic_Kuriputo),
	SPECIES_SPRITE(ROODANSE, gMonFrontPic_Roodanse),
	SPECIES_SPRITE(OOSHE, gMonFrontPic_Ooshe),
	SPECIES_SPRITE(GOOSUBOA, gMonFrontPic_Goosuboa),
	SPECIES_SPRITE(ROCLOBSTER, gMonFrontPic_Roclobster),
	SPECIES_SPRITE(X32763, gMonFrontPic_X32763),
	SPECIES_SPRITE(TELSON, gMonFrontPic_Telson),
	SPECIES_SPRITE(MAGNEZONE, gMonFrontPic_Magnezone),
	SPECIES_SPRITE(VIGOURLAN, gMonFrontPic_Vigourlan),
	SPECIES_SPRITE(DIAMANDIX, gMonFrontPic_Diamandix),
	SPECIES_SPRITE(GIGAWOLF, gMonFrontPic_Gigawolf),
	SPECIES_SPRITE(GALACTIMON, gMonFrontPic_Galactimon),
	SPECIES_SPRITE(QWILSHARK, gMonFrontPic_Qwilshark),
	SPECIES_SPRITE(DRAGOONE, gMonFrontPic_Dragoone),
	SPECIES_SPRITE(CALFBY, gMonFrontPic_Calfby),
	SPECIES_SPRITE(RAMSHAKER, gMonFrontPic_Ramshaker),
	SPECIES_SPRITE(SEVICIOUS, gMonFrontPic_Sevicious),
	SPECIES_SPRITE(ZANGOL, gMonFrontPic_Zangol),
	SPECIES_SPRITE(PSYPIG, gMonFrontPic_Psypig),
	SPECIES_SPRITE(MUNCHLAX, gMonFrontPic_Munchlax),
	SPECIES_SPRITE(SKYLAX, gMonFrontPic_Skylax),
	SPECIES_SPRITE(MYSTERYEGG, gMonFrontPic_Mysteryegg),
	SPECIES_SPRITE(SECRETEGG, gMonFrontPic_Secretegg),
	SPECIES_SPRITE(HYPEREGG, gMonFrontPic_Hyperegg),
	SPECIES_SPRITE(HOMBONE, gMonFrontPic_Hombone),
	SPECIES_SPRITE(HOMBEAST, gMonFrontPic_Hombeast),
	SPECIES_SPRITE(KENCHIRA, gMonFrontPic_Kenchira),
	SPECIES_SPRITE(KENCHUKO, gMonFrontPic_Kenchuko),
	SPECIES_SPRITE(GLUTE, gMonFrontPic_Glute),
	SPECIES_SPRITE(BUTE, gMonFrontPic_Bute),
	SPECIES_SPRITE(NUTE, gMonFrontPic_Nute),
	SPECIES_SPRITE(FURI_X, gMonFrontPic_FuriX),
	SPECIES_SPRITE(FURI_Z, gMonFrontPic_FuriZ),
	SPECIES_SPRITE(FURI_Q, gMonFrontPic_FuriQ),
	SPECIES_SPRITE(TURMUR, gMonFrontPic_Turmur),
	SPECIES_SPRITE(SHADERU, gMonFrontPic_Shaderu),
	SPECIES_SPRITE(FACELEECH, gMonFrontPic_Faceleech),
	SPECIES_SPRITE(LUCA_ZAMON, gMonFrontPic_LucaZamon),
	SPECIES_SPRITE(TEA_BARCAN, gMonFrontPic_TeaBarcan),
	SPECIES_SPRITE(MINICE, gMonFrontPic_Minice),
	SPECIES_SPRITE(MINIROCK, gMonFrontPic_Minirock),
	SPECIES_SPRITE(MINISTEEL, gMonFrontPic_Ministeel),
	SPECIES_SPRITE(GENEROBO, gMonFrontPic_Generobo),
