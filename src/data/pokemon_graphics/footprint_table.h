const u8 *const gMonFootprintTable[] =
{
	...
	[SPECIES_SPOOKUM] = gMonFootprint_Spookum,
	[SPECIES_SPOOKUM_BUSTED] = gMonFootprint_Spookum,
	[SPECIES_GLASMA] = gMonFootprint_Glasma,
	[SPECIES_PLASMOLYTE] = gMonFootprint_Plasmolyte,
	[SPECIES_STORMAGE] = gMonFootprint_Stormage,
	[SPECIES_SANDUDE] = gMonFootprint_Sandude,
	[SPECIES_SANDROSS] = gMonFootprint_Sandross,
	[SPECIES_SANDUEL] = gMonFootprint_Sanduel,
	[SPECIES_ELADRIFT] = gMonFootprint_Eladrift,
	[SPECIES_SLITHURENT] = gMonFootprint_Slithurent,
	[SPECIES_PRESCYLLON] = gMonFootprint_Prescyllon,
	[SPECIES_SLOSHMOSH] = gMonFootprint_Sloshmosh,
	[SPECIES_SLURPINSKI] = gMonFootprint_Slurpinski,
	[SPECIES_KEESH] = gMonFootprint_Keesh,
	[SPECIES_HATCHBLING] = gMonFootprint_Hatchbling,
	[SPECIES_HUMMBLING] = gMonFootprint_Hummbling,
	[SPECIES_KEESIGHT] = gMonFootprint_Keesight,
	[SPECIES_KEESPELL] = gMonFootprint_Keespell,
	[SPECIES_LARVOOL] = gMonFootprint_Larvool,
	[SPECIES_SPOOLER] = gMonFootprint_Spooler,
	[SPECIES_BILLIARACH] = gMonFootprint_Billiarach,
	[SPECIES_SLUGMA_FONEI] = gMonFootprint_SlugmaFonei,
	[SPECIES_MAGCARGO_FONEI] = gMonFootprint_MagcargoFonei,
	[SPECIES_SUNFOREST] = gMonFootprint_Sunforest,
	[SPECIES_HONEDGE_FONEI] = gMonFootprint_HonedgeFonei,
	[SPECIES_DOUBLADE_FONEI] = gMonFootprint_DoubladeFonei,
	[SPECIES_AEGISLASH_FONEI_A] = gMonFootprint_AegislashFoneiA,
	[SPECIES_AEGISLASH_FONEI_E] = gMonFootprint_AegislashFoneiE,
	[SPECIES_ELEMPTY] = gMonFootprint_Elempty,
	[SPECIES_VENEARTH] = gMonFootprint_Venearth,
	[SPECIES_MARSIZZLE] = gMonFootprint_Marsizzle,
	[SPECIES_JUPLASMA] = gMonFootprint_Juplasma,
	[SPECIES_MERLPOOL] = gMonFootprint_Merlpool,
	[SPECIES_OPHICALF] = gMonFootprint_Ophicalf,
	[SPECIES_SERPENTAUR] = gMonFootprint_Serpentaur,
	[SPECIES_GEODUDE_FONEI] = gMonFootprint_GeodudeFonei,
	[SPECIES_GRAVELER_FONEI] = gMonFootprint_GravelerFonei,
	[SPECIES_GOLEM_FONEI] = gMonFootprint_GolemFonei,
	...
	[SPECIES_RALTS_FONEI] = gMonFootprint_RaltsFonei,
	[SPECIES_KIRLIA_FONEI] = gMonFootprint_KirliaFonei,
	[SPECIES_GARDEVOIR_FONEI] = gMonFootprint_GardevoirFonei,
	[SPECIES_GALLADE_FONEI] = gMonFootprint_GalladeFonei,
	[SPECIES_WOOBAT] = gMonFootprint_Woobat,
	[SPECIES_SWOOBAT] = gMonFootprint_Swoobat,
	[SPECIES_TRUEBAT] = gMonFootprint_Truebat,
	[SPECIES_HOMBONE] = gMonFootprint_Hombone,
	[SPECIES_HOMBEAST] = gMonFootprint_Hombeast,
	[SPECIES_QWILSHARK] = gMonFootprint_Qwilshark,
	[SPECIES_KRISSY] = gMonFootprint_Krissy,
	[SPECIES_KRAKODEMON] = gMonFootprint_Krakodemon,
	[SPECIES_WEATHERBANE] = gMonFootprint_Weatherbane,
	[SPECIES_KETSUBAN] = gMonFootprint_Ketsuban,
	[SPECIES_DISABY] = gMonFootprint_Disaby,
	[SPECIES_DISASPRITE] = gMonFootprint_Disasprite,
	[SPECIES_DISMASTER] = gMonFootprint_Dismaster,
	[SPECIES_PURIDIAN] = gMonFootprint_Puridian,
	[SPECIES_MANIPULO] = gMonFootprint_Manipulo,
	[SPECIES_COILSPILL] = gMonFootprint_Coilspill,
	[SPECIES_BOOWHO] = gMonFootprint_Boowho,
	[SPECIES_BOOXER] = gMonFootprint_Booxer,
	[SPECIES_BOOZERKER] = gMonFootprint_Boozerker,
	[SPECIES_DEEPDARK] = gMonFootprint_Deepdark,
	[SPECIES_BURMITE] = gMonFootprint_Burmite,
	[SPECIES_SEDIMETAL] = gMonFootprint_Sedimetal,
	[SPECIES_SOLOSIS_FONEI] = gMonFootprint_SolosisFonei,
	[SPECIES_DUOSION_FONEI] = gMonFootprint_DuosionFonei,
	[SPECIES_REUNICLUS_FONEI] = gMonFootprint_ReuniclusFonei,
	[SPECIES_VINOS] = gMonFootprint_Vinos,
	[SPECIES_VINOCEIVER] = gMonFootprint_Vinoceiver,
	[SPECIES_ANNOYIDGE] = gMonFootprint_Annoyidge,
	[SPECIES_PESQUITO] = gMonFootprint_Pesquito,
	[SPECIES_MANKEY_FONEI] = gMonFootprint_MankeyFonei,
	[SPECIES_PRIMEAPE_FONEI] = gMonFootprint_PrimeapeFonei,
	[SPECIES_CRYOGONAL_FONEI] = gMonFootprint_CryogonalFonei,
	[SPECIES_AMPIBOISON] = gMonFootprint_Ampiboison,
	[SPECIES_LAGNET] = gMonFootprint_Lagnet,
	[SPECIES_LANNET] = gMonFootprint_Lannet,
	[SPECIES_CYBURN] = gMonFootprint_Cyburn,
	[SPECIES_SAPNOSE] = gMonFootprint_Sapnose,
	[SPECIES_BURROOT] = gMonFootprint_Burroot,
	[SPECIES_BURRUSH] = gMonFootprint_Burrush,
	[SPECIES_LAV] = gMonFootprint_Lav,
	[SPECIES_LAVALY] = gMonFootprint_Lavaly,
	[SPECIES_LAVSAMUCH] = gMonFootprint_Lavsamuch,
	[SPECIES_GUPPAGE] = gMonFootprint_Guppage,
	[SPECIES_SEAGE] = gMonFootprint_Seage,
	[SPECIES_BASSTION] = gMonFootprint_Basstion,
	[SPECIES_PANTOM] = gMonFootprint_Pantom,
	[SPECIES_HAPPANING] = gMonFootprint_Happaning,
	[SPECIES_PANZERGAST] = gMonFootprint_Panzergast,
	[SPECIES_SCAIRY] = gMonFootprint_Scairy,
	[SPECIES_DANKLIMMER] = gMonFootprint_Danklimmer,
	[SPECIES_GOLICHEM] = gMonFootprint_Golichem,
	[SPECIES_SPINDA_FONEI] = gMonFootprint_SpindaFonei,
	[SPECIES_EMUNITION] = gMonFootprint_Emunition,
	[SPECIES_EMORTAR] = gMonFootprint_Emortar,
	[SPECIES_OPEBBLISK] = gMonFootprint_Opebblisk,
	[SPECIES_STONUMENT] = gMonFootprint_Stonument,
	[SPECIES_MEMOIRBLE] = gMonFootprint_Memoirble,
	[SPECIES_NOKOMMON] = gMonFootprint_Nokommon,
	[SPECIES_TANGHOUL] = gMonFootprint_Tanghoul,
	[SPECIES_QWILYU] = gMonFootprint_Qwilyu,
	[SPECIES_CORILIA] = gMonFootprint_Corilia,
	[SPECIES_NIDOROOK] = gMonFootprint_Nidorook,
	[SPECIES_SKALVENGER] = gMonFootprint_Skalvenger,
	[SPECIES_SKULKREX] = gMonFootprint_Skulkrex,
	[SPECIES_SKELTYRANT] = gMonFootprint_Skeltyrant,
