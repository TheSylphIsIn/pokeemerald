const u8 *const gMonFootprintTable[] =
{
	...
	[SPECIES_GORELAX] = gMonFootprint_Gorelax,
	[SPECIES_SHINIGAMI] = gMonFootprint_Shinigami,
	[SPECIES_ANTISPIRAL] = gMonFootprint_Antispiral,
	[SPECIES_DRAGON] = gMonFootprint_Dragon,
	[SPECIES_AMONSTER] = gMonFootprint_Amonster,
	[SPECIES_FANGASU] = gMonFootprint_Fangasu,
	[SPECIES_NIGERA] = gMonFootprint_Nigera,
	[SPECIES_KURIPUTO] = gMonFootprint_Kuriputo,
	[SPECIES_ROODANSE] = gMonFootprint_Roodanse,
	[SPECIES_OOSHE] = gMonFootprint_Ooshe,
	[SPECIES_GOOSUBOA] = gMonFootprint_Goosuboa,
	[SPECIES_ROCLOBSTER] = gMonFootprint_Roclobster,
	[SPECIES_X32763] = gMonFootprint_X32763,
	[SPECIES_TELSON] = gMonFootprint_Telson,
	[SPECIES_MAGNEZONE] = gMonFootprint_Magnezone,
	[SPECIES_VIGOURLAN] = gMonFootprint_Vigourlan,
	[SPECIES_DIAMANDIX] = gMonFootprint_Diamandix,
	[SPECIES_GIGAWOLF] = gMonFootprint_Gigawolf,
	[SPECIES_GALACTIMON] = gMonFootprint_Galactimon,
	[SPECIES_QWILSHARK] = gMonFootprint_Qwilshark,
	[SPECIES_DRAGOONE] = gMonFootprint_Dragoone,
	[SPECIES_CALFBY] = gMonFootprint_Calfby,
	[SPECIES_RAMSHAKER] = gMonFootprint_Ramshaker,
	[SPECIES_SEVICIOUS] = gMonFootprint_Sevicious,
	[SPECIES_ZANGOL] = gMonFootprint_Zangol,
	[SPECIES_PSYPIG] = gMonFootprint_Psypig,
	[SPECIES_MUNCHLAX] = gMonFootprint_Munchlax,
	[SPECIES_SKYLAX] = gMonFootprint_Skylax,
	[SPECIES_MYSTERYEGG] = gMonFootprint_Mysteryegg,
	[SPECIES_SECRETEGG] = gMonFootprint_Secretegg,
	[SPECIES_HYPEREGG] = gMonFootprint_Hyperegg,
	[SPECIES_HOMBONE] = gMonFootprint_Hombone,
	[SPECIES_HOMBEAST] = gMonFootprint_Hombeast,
	[SPECIES_KENCHIRA] = gMonFootprint_Kenchira,
	[SPECIES_KENCHUKO] = gMonFootprint_Kenchuko,
	[SPECIES_GLUTE] = gMonFootprint_Glute,
	[SPECIES_BUTE] = gMonFootprint_Bute,
	[SPECIES_NUTE] = gMonFootprint_Nute,
	[SPECIES_FURI_X] = gMonFootprint_FuriX,
	[SPECIES_FURI_Z] = gMonFootprint_FuriZ,
	[SPECIES_FURI_Q] = gMonFootprint_FuriQ,
	[SPECIES_TURMUR] = gMonFootprint_Turmur,
	[SPECIES_SHADERU] = gMonFootprint_Shaderu,
	[SPECIES_FACELEECH] = gMonFootprint_Faceleech,
	[SPECIES_LUCA_ZAMON] = gMonFootprint_LucaZamon,
	[SPECIES_TEA_BARCAN] = gMonFootprint_TeaBarcan,
	[SPECIES_MINICE] = gMonFootprint_Minice,
	[SPECIES_MINIROCK] = gMonFootprint_Minirock,
	[SPECIES_MINISTEEL] = gMonFootprint_Ministeel,
	[SPECIES_GENEROBO] = gMonFootprint_Generobo,
