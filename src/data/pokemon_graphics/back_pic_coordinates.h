...
const struct MonCoords gMonBackPicCoords[] =
{
	...
	[SPECIES_VIGOURLAN] = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  9 },
	...
	[SPECIES_DRAGOONE] = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  0 },
	...
	[SPECIES_MYSTERYEGG] = { .size = MON_COORDS_SIZE(32, 20), .y_offset =  16 },
	[SPECIES_SECRETEGG] = { .size = MON_COORDS_SIZE(32, 20), .y_offset =  16 },
	[SPECIES_HYPEREGG] = { .size = MON_COORDS_SIZE(32, 20), .y_offset =  16 },
	[SPECIES_HOMBONE] = { .size = MON_COORDS_SIZE(56, 48), .y_offset =  7 },
	[SPECIES_HOMBEAST] = { .size = MON_COORDS_SIZE(64, 48), .y_offset =  7 },
