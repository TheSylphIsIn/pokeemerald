...
const struct MonCoords gMonBackPicCoords[] =
{
	...
	[SPECIES_DUBSNAKE]	  =	{ .size = MON_COORDS_SIZE(62, 44), .y_offset =  0 },
	[SPECIES_HYDROIL] 	  =	{ .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_WYCERN]	  = { .size = MON_COORDS_SIZE(60, 56), .y_offset =  0 },
	[SPECIES_BITTERAGON]  =	{ .size = MON_COORDS_SIZE(64, 50), .y_offset =  0 },
	[SPECIES_CACTUMBRA]   =	{ .size = MON_COORDS_SIZE(64, 50), .y_offset =  0 },
	[SPECIES_OBSICARGO]   = { .size = MON_COORDS_SIZE(64, 50), .y_offset =  0 },
	[SPECIES_NORWHALE] 	  = { .size = MON_COORDS_SIZE(64, 50), .y_offset =  0 },
	[SPECIES_MINIOR_METEOR] = { .size = MON_COORDS_SIZE(52, 40), .y_offset = 14 },
	[SPECIES_MINIOR_CORE] =	{ .size = MON_COORDS_SIZE(52, 40), .y_offset = 15 },
	[SPECIES_CASTFORM_SUNNY] = { .size = MON_COORDS_SIZE(32, 40), .y_offset = 13 },
	[SPECIES_CASTFORM_RAINY] = { .size = MON_COORDS_SIZE(32, 40), .y_offset = 13 },
	[SPECIES_CASTFORM_SNOWY] = { .size = MON_COORDS_SIZE(32, 40), .y_offset = 13 },
	[SPECIES_SPOOKUM] 	  = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  6 },
	[SPECIES_SPOOKUM_BUSTED] = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  6 },
	[SPECIES_GLASMA] = { .size = MON_COORDS_SIZE(44, 24), .y_offset = 16 },
	[SPECIES_PLASMOLYTE]  = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_STORMAGE] 	  = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_SANDUDE] 	  = { .size = MON_COORDS_SIZE(44, 32), .y_offset =  0 },
	[SPECIES_SANDROSS] 	  = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_SANDUEL] 	  = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_ELADRIFT] 	  =	{ .size = MON_COORDS_SIZE(44, 44), .y_offset =  0 },
	[SPECIES_SLITHURENT]  = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_PRESCYLLON]  = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_SLOSHMOSH]   =	{ .size = MON_COORDS_SIZE(44, 32), .y_offset = 16 },
	[SPECIES_SLURPINSKI]  = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_KEESH] 	  =	{ .size = MON_COORDS_SIZE(64, 24), .y_offset = 16 },
	...
	[SPECIES_BILLIARACH]  = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_SLUGMA_FONEI] = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  8 },
	[SPECIES_MAGCARGO_FONEI] = { .size = MON_COORDS_SIZE(56, 48), .y_offset =  9 },
	[SPECIES_SUNFOREST]   = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_HONEDGE_FONEI] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_DOUBLADE_FONEI] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_AEGISLASH_FONEI_A] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_AEGISLASH_FONEI_E] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_ELEMPTY] 	  =	{ .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_VENEARTH] 	  =	{ .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_MARSIZZLE]   =	{ .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_JUPLASMA] 	  =	{ .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_MERLPOOL] 	  =	{ .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_OPHICALF] 	  =	{ .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_SERPENTAUR]  =	{ .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_GEODUDE_FONEI] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_GRAVELER_FONEI] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_GOLEM_FONEI] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_SUDOWOODO_FONEI] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_GRITWYRM] 	  = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_MOLDUNE] 	  = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_WATTITUDE]   = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  0 },
	[SPECIES_RALTS_FONEI] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_KIRLIA_FONEI] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_GARDEVOIR_FONEI] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_GALLADE_FONEI] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_WOOBAT] 	  = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_SWOOBAT] 	  = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_TRUEBAT] 	  = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_HOMBONE] 	  = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_HOMBEAST]	  = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_QWILSHARK]   = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_KRISSY] 	  = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_KRAKODEMON]  = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_WEATHERBANE] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_KETSUBAN]  = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	...
	[SPECIES_COILSPILL] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_BOOWHO] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_BOOXER] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_BOOZERKER] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	...
	[SPECIES_SOLOSIS_FONEI] = { .size = MON_COORDS_SIZE(52, 40), .y_offset =  19 },
	...
	[SPECIES_VINOCEIVER] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_ANNOYIDGE] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_PESQUITO] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_MANKEY_FONEI] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_PRIMEAPE_FONEI] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_CRYOGONAL_FONEI] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_AMPIBOISON] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_LAGNET] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_LANNET] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_CYBURN] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_SAPNOSE] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_BURROOT] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_BURRUSH] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_LAV] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_LAVALY] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_LAVSAMUCH] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_GUPPAGE] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_SEAGE] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_BASSTION] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_PANTOM] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_HAPPANING] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_PANZERGAST] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_SCAIRY] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_DANKLIMMER] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_GOLICHEM] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_SPINDA_FONEI] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_EMUNITION] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_EMORTAR] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_OPEBBLISK] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_STONUMENT] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_MEMOIRBLE] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_NOKOMMON] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_TANGHOUL] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_QWILYU] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_CORILIA] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_NIDOROOK] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_SKALVENGER] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_SKULKREX] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
	[SPECIES_SKELTYRANT] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
};
