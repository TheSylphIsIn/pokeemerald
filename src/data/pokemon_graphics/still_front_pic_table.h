...
// Gen III
	...
	SPECIES_SPRITE(DUBSNAKE, 	  gMonStillFrontPic_Dubsnake),
	SPECIES_SPRITE(HYDROIL, 	  gMonStillFrontPic_Hydroil),
	SPECIES_SPRITE(WYCERN, gMonStillFrontPic_Wycern),
	SPECIES_SPRITE(BITTERAGON, gMonStillFrontPic_Bitteragon),
	...
	SPECIES_SPRITE(SPOOKUM, gMonStillFrontPic_Spookum),
	SPECIES_SPRITE(SPOOKUM_BUSTED, gMonStillFrontPic_SpookumBusted),
	...
	SPECIES_SPRITE(GLASMA, gMonStillFrontPic_Glasma),
	SPECIES_SPRITE(PLASMOLYTE, gMonStillFrontPic_Plasmolyte),
	SPECIES_SPRITE(STORMAGE, gMonStillFrontPic_Stormage),
	SPECIES_SPRITE(SANDUDE, gMonStillFrontPic_Sandude),
	SPECIES_SPRITE(SANDROSS, gMonStillFrontPic_Sandross),
	SPECIES_SPRITE(SANDUEL, gMonStillFrontPic_Sanduel),
	SPECIES_SPRITE(ELADRIFT, gMonStillFrontPic_Eladrift),
	SPECIES_SPRITE(SLITHURENT, gMonStillFrontPic_Slithurent),
	SPECIES_SPRITE(PRESCYLLON, gMonStillFrontPic_Prescyllon),
	SPECIES_SPRITE(SLOSHMOSH, gMonStillFrontPic_Sloshmosh),
	SPECIES_SPRITE(SLURPINSKI, gMonStillFrontPic_Slurpinski),
	SPECIES_SPRITE(KEESH, gMonStillFrontPic_Keesh),
	SPECIES_SPRITE(HATCHBLING, gMonStillFrontPic_Hatchbling),
	SPECIES_SPRITE(HUMMBLING, gMonStillFrontPic_Hummbling),
	SPECIES_SPRITE(KEESIGHT, gMonStillFrontPic_Keesight),
	SPECIES_SPRITE(KEESPELL, gMonStillFrontPic_Keespell),
	SPECIES_SPRITE(LARVOOL, gMonStillFrontPic_Larvool),
	SPECIES_SPRITE(SPOOLER, gMonStillFrontPic_Spooler),
	SPECIES_SPRITE(BILLIARACH, gMonStillFrontPic_Billiarach),
	SPECIES_SPRITE(SLUGMA_FONEI, gMonStillFrontPic_SlugmaFonei),
	SPECIES_SPRITE(MAGCARGO_FONEI, gMonStillFrontPic_MagcargoFonei),
	SPECIES_SPRITE(SUNFOREST, gMonStillFrontPic_Sunforest),
	SPECIES_SPRITE(HONEDGE_FONEI, gMonStillFrontPic_HonedgeFonei),
	SPECIES_SPRITE(DOUBLADE_FONEI, gMonStillFrontPic_DoubladeFonei),
	SPECIES_SPRITE(AEGISLASH_FONEI_A, gMonStillFrontPic_AegislashFoneiA),
	SPECIES_SPRITE(AEGISLASH_FONEI_E, gMonStillFrontPic_AegislashFoneiE),
	SPECIES_SPRITE(ELEMPTY, gMonStillFrontPic_Elempty),
	SPECIES_SPRITE(VENEARTH, gMonStillFrontPic_Venearth),
	SPECIES_SPRITE(MARSIZZLE, gMonStillFrontPic_Marsizzle),
	SPECIES_SPRITE(JUPLASMA, gMonStillFrontPic_Juplasma),
	SPECIES_SPRITE(MERLPOOL, gMonStillFrontPic_Merlpool),
	SPECIES_SPRITE(OPHICALF, gMonStillFrontPic_Ophicalf),
	SPECIES_SPRITE(SERPENTAUR, gMonStillFrontPic_Serpentaur),
	SPECIES_SPRITE(GEODUDE_FONEI, gMonStillFrontPic_GeodudeFonei),
	SPECIES_SPRITE(GRAVELER_FONEI, gMonStillFrontPic_GravelerFonei),
	SPECIES_SPRITE(GOLEM_FONEI, gMonStillFrontPic_GolemFonei),
	SPECIES_SPRITE(SUDOWOODO_FONEI, gMonStillFrontPic_SudowoodoFonei),
	SPECIES_SPRITE(GRITWYRM, gMonStillFrontPic_Gritwyrm),
	SPECIES_SPRITE(MOLDUNE, gMonStillFrontPic_Moldune),
	SPECIES_SPRITE(WATTITUDE, gMonFrontPic_Wattitude),
	SPECIES_SPRITE(RALTS_FONEI, gMonStillFrontPic_RaltsFonei),
	SPECIES_SPRITE(KIRLIA_FONEI, gMonStillFrontPic_KirliaFonei),
	SPECIES_SPRITE(GARDEVOIR_FONEI, gMonStillFrontPic_GardevoirFonei),
	SPECIES_SPRITE(GALLADE_FONEI, gMonStillFrontPic_GalladeFonei),
	SPECIES_SPRITE(WOOBAT, gMonStillFrontPic_Woobat),
	SPECIES_SPRITE(SWOOBAT, gMonStillFrontPic_Swoobat),
	SPECIES_SPRITE(TRUEBAT, gMonStillFrontPic_Truebat),
	SPECIES_SPRITE(HOMBONE, gMonStillFrontPic_Hombone),
	SPECIES_SPRITE(HOMBEAST, gMonStillFrontPic_Hombeast),
	SPECIES_SPRITE(QWILSHARK, gMonStillFrontPic_Qwilshark),
	SPECIES_SPRITE(KRISSY, gMonStillFrontPic_Krissy),
	SPECIES_SPRITE(KRAKODEMON, gMonStillFrontPic_Krakodemon),
	SPECIES_SPRITE(WEATHERBANE, gMonStillFrontPic_Weatherbane),
	SPECIES_SPRITE(KETSUBAN, gMonStillFrontPic_Ketsuban),
	SPECIES_SPRITE(DISABY, gMonStillFrontPic_Disaby),
	SPECIES_SPRITE(DISASPRITE, gMonStillFrontPic_Disasprite),
	SPECIES_SPRITE(DISMASTER, gMonStillFrontPic_Dismaster),
	SPECIES_SPRITE(PURIDIAN, gMonStillFrontPic_Puridian),
	SPECIES_SPRITE(MANIPULO, gMonStillFrontPic_Manipulo),
	SPECIES_SPRITE(COILSPILL, gMonStillFrontPic_Coilspill),
	SPECIES_SPRITE(BOOWHO, gMonStillFrontPic_Boowho),
	SPECIES_SPRITE(BOOXER, gMonStillFrontPic_Booxer),
	SPECIES_SPRITE(BOOZERKER, gMonStillFrontPic_Boozerker),
	SPECIES_SPRITE(DEEPDARK, gMonStillFrontPic_Deepdark),
	SPECIES_SPRITE(BURMITE, gMonStillFrontPic_Burmite),
	SPECIES_SPRITE(SEDIMETAL, gMonStillFrontPic_Sedimetal),
	SPECIES_SPRITE(SOLOSIS_FONEI, gMonStillFrontPic_SolosisFonei),
	SPECIES_SPRITE(DUOSION_FONEI, gMonStillFrontPic_DuosionFonei),
	SPECIES_SPRITE(REUNICLUS_FONEI, gMonStillFrontPic_ReuniclusFonei),
	SPECIES_SPRITE(VINOS, gMonStillFrontPic_Vinos),
	SPECIES_SPRITE(VINOCEIVER, gMonStillFrontPic_Vinoceiver),
	SPECIES_SPRITE(ANNOYIDGE, gMonStillFrontPic_Annoyidge),
	SPECIES_SPRITE(PESQUITO, gMonStillFrontPic_Pesquito),
	SPECIES_SPRITE(MANKEY_FONEI, gMonStillFrontPic_MankeyFonei),
	SPECIES_SPRITE(PRIMEAPE_FONEI, gMonStillFrontPic_PrimeapeFonei),
	SPECIES_SPRITE(CRYOGONAL_FONEI, gMonStillFrontPic_CryogonalFonei),
	SPECIES_SPRITE(AMPIBOISON, gMonStillFrontPic_Ampiboison),
	SPECIES_SPRITE(LAGNET, gMonStillFrontPic_Lagnet),
	SPECIES_SPRITE(LANNET, gMonStillFrontPic_Lannet),
	SPECIES_SPRITE(CYBURN, gMonStillFrontPic_Cyburn),
	SPECIES_SPRITE(SAPNOSE, gMonStillFrontPic_Sapnose),
	SPECIES_SPRITE(BURROOT, gMonStillFrontPic_Burroot),
	SPECIES_SPRITE(BURRUSH, gMonStillFrontPic_Burrush),
	SPECIES_SPRITE(LAV, gMonStillFrontPic_Lav),
	SPECIES_SPRITE(LAVALY, gMonStillFrontPic_Lavaly),
	SPECIES_SPRITE(LAVSAMUCH, gMonStillFrontPic_Lavsamuch),
	SPECIES_SPRITE(GUPPAGE, gMonStillFrontPic_Guppage),
	SPECIES_SPRITE(SEAGE, gMonStillFrontPic_Seage),
	SPECIES_SPRITE(BASSTION, gMonStillFrontPic_Basstion),
	SPECIES_SPRITE(PANTOM, gMonStillFrontPic_Pantom),
	SPECIES_SPRITE(HAPPANING, gMonStillFrontPic_Happaning),
	SPECIES_SPRITE(PANZERGAST, gMonStillFrontPic_Panzergast),
	SPECIES_SPRITE(SCAIRY, gMonStillFrontPic_Scairy),
	SPECIES_SPRITE(DANKLIMMER, gMonStillFrontPic_Danklimmer),
	SPECIES_SPRITE(GOLICHEM, gMonStillFrontPic_Golichem),
	SPECIES_SPRITE(SPINDA_FONEI, gMonStillFrontPic_SpindaFonei),
	SPECIES_SPRITE(EMUNITION, gMonStillFrontPic_Emunition),
	SPECIES_SPRITE(EMORTAR, gMonStillFrontPic_Emortar),
	SPECIES_SPRITE(OPEBBLISK, gMonStillFrontPic_Opebblisk),
	SPECIES_SPRITE(STONUMENT, gMonStillFrontPic_Stonument),
	SPECIES_SPRITE(MEMOIRBLE, gMonStillFrontPic_Memoirble),
	SPECIES_SPRITE(NOKOMMON, gMonStillFrontPic_Nokommon),
	SPECIES_SPRITE(TANGHOUL, gMonStillFrontPic_Tanghoul),
	SPECIES_SPRITE(QWILYU, gMonStillFrontPic_Qwilyu),
	SPECIES_SPRITE(CORILIA, gMonStillFrontPic_Corilia),
	SPECIES_SPRITE(NIDOROOK, gMonStillFrontPic_Nidorook),
	SPECIES_SPRITE(SKALVENGER, gMonStillFrontPic_Skalvenger),
	SPECIES_SPRITE(SKULKREX, gMonStillFrontPic_Skulkrex),
	SPECIES_SPRITE(SKELTYRANT, gMonStillFrontPic_Skeltyrant),
	// SPECIES_SPRITE(SPCS, gMonStillFrontPic_Spcs),
