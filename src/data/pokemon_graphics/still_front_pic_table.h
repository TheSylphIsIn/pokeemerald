...
// Gen III
	...
	SPECIES_SPRITE(GORELAX, gMonStillFrontPic_Gorelax),
	SPECIES_SPRITE(SHINIGAMI, gMonStillFrontPic_Shinigami),
	SPECIES_SPRITE(ANTISPIRAL, gMonStillFrontPic_Antispiral),
	SPECIES_SPRITE(DRAGON, gMonStillFrontPic_Dragon),
	SPECIES_SPRITE(AMONSTER, gMonStillFrontPic_Amonster),
	SPECIES_SPRITE(FANGASU, gMonStillFrontPic_Fangasu),
	SPECIES_SPRITE(NIGERA, gMonStillFrontPic_Nigera),
	SPECIES_SPRITE(KURIPUTO, gMonStillFrontPic_Kuriputo),
	SPECIES_SPRITE(ROODANSE, gMonStillFrontPic_Roodanse),
	SPECIES_SPRITE(OOSHE, gMonStillFrontPic_Ooshe),
	SPECIES_SPRITE(GOOSUBOA, gMonStillFrontPic_Goosuboa),
	SPECIES_SPRITE(ROCLOBSTER, gMonStillFrontPic_Roclobster),
	SPECIES_SPRITE(X32763, gMonStillFrontPic_X32763),
	SPECIES_SPRITE(TELSON, gMonStillFrontPic_Telson),
	SPECIES_SPRITE(MAGNEZONE, gMonStillFrontPic_Magnezone),
	SPECIES_SPRITE(VIGOURLAN, gMonStillFrontPic_Vigourlan),
	SPECIES_SPRITE(DIAMANDIX, gMonStillFrontPic_Diamandix),
	SPECIES_SPRITE(GIGAWOLF, gMonStillFrontPic_Gigawolf),
	SPECIES_SPRITE(GALACTIMON, gMonStillFrontPic_Galactimon),
	SPECIES_SPRITE(QWILSHARK, gMonStillFrontPic_Qwilshark),
	SPECIES_SPRITE(DRAGOONE, gMonStillFrontPic_Dragoone),
	SPECIES_SPRITE(CALFBY, gMonStillFrontPic_Calfby),
	SPECIES_SPRITE(RAMSHAKER, gMonStillFrontPic_Ramshaker),
	SPECIES_SPRITE(SEVICIOUS, gMonStillFrontPic_Sevicious),
	SPECIES_SPRITE(ZANGOL, gMonStillFrontPic_Zangol),
	SPECIES_SPRITE(PSYPIG, gMonStillFrontPic_Psypig),
	SPECIES_SPRITE(MUNCHLAX, gMonStillFrontPic_Munchlax),
	SPECIES_SPRITE(SKYLAX, gMonStillFrontPic_Skylax),
	SPECIES_SPRITE(MYSTERYEGG, gMonStillFrontPic_Mysteryegg),
	SPECIES_SPRITE(SECRETEGG, gMonStillFrontPic_Secretegg),
	SPECIES_SPRITE(HYPEREGG, gMonStillFrontPic_Hyperegg),
	SPECIES_SPRITE(HOMBONE, gMonStillFrontPic_Hombone),
	SPECIES_SPRITE(HOMBEAST, gMonStillFrontPic_Hombeast),
	SPECIES_SPRITE(KENCHIRA, gMonStillFrontPic_Kenchira),
	SPECIES_SPRITE(KENCHUKO, gMonStillFrontPic_Kenchuko),
	SPECIES_SPRITE(GLUTE, gMonStillFrontPic_Glute),
	SPECIES_SPRITE(BUTE, gMonStillFrontPic_Bute),
	SPECIES_SPRITE(NUTE, gMonStillFrontPic_Nute),
	SPECIES_SPRITE(FURI_X, gMonStillFrontPic_FuriX),
	SPECIES_SPRITE(FURI_Z, gMonStillFrontPic_FuriZ),
	SPECIES_SPRITE(FURI_Q, gMonStillFrontPic_FuriQ),
	SPECIES_SPRITE(TURMUR, gMonStillFrontPic_Turmur),
	SPECIES_SPRITE(SHADERU, gMonStillFrontPic_Shaderu),
	SPECIES_SPRITE(FACELEECH, gMonStillFrontPic_Faceleech),
	SPECIES_SPRITE(LUCA_ZAMON, gMonStillFrontPic_LucaZamon),
	SPECIES_SPRITE(TEA_BARCAN, gMonStillFrontPic_TeaBarcan),
	SPECIES_SPRITE(MINICE, gMonStillFrontPic_Minice),
	SPECIES_SPRITE(MINIROCK, gMonStillFrontPic_Minirock),
	SPECIES_SPRITE(MINISTEEL, gMonStillFrontPic_Ministeel),
	SPECIES_SPRITE(GENEROBO, gMonStillFrontPic_Generobo),
