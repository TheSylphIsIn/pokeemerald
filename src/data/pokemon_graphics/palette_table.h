const struct CompressedSpritePalette gMonPaletteTable[] =
{
	...
	SPECIES_PAL(GORELAX, gMonPalette_Gorelax),
	SPECIES_PAL(SHINIGAMI, gMonPalette_Shinigami),
	SPECIES_PAL(ANTISPIRAL, gMonPalette_Antispiral),
	SPECIES_PAL(DRAGON, gMonPalette_Dragon),
	SPECIES_PAL(AMONSTER, gMonPalette_Amonster),
	SPECIES_PAL(FANGASU, gMonPalette_Fangasu),
	SPECIES_PAL(NIGERA, gMonPalette_Nigera),
	SPECIES_PAL(KURIPUTO, gMonPalette_Kuriputo),
	SPECIES_PAL(ROODANSE, gMonPalette_Roodanse),
	SPECIES_PAL(OOSHE, gMonPalette_Ooshe),
	SPECIES_PAL(GOOSUBOA, gMonPalette_Goosuboa),
	SPECIES_PAL(ROCLOBSTER, gMonPalette_Roclobster),
	SPECIES_PAL(X32763, gMonPalette_X32763),
	SPECIES_PAL(TELSON, gMonPalette_Telson),
	SPECIES_PAL(MAGNEZONE, gMonPalette_Magnezone),
	SPECIES_PAL(VIGOURLAN, gMonPalette_Vigourlan),
	SPECIES_PAL(DIAMANDIX, gMonPalette_Diamandix),
	SPECIES_PAL(GIGAWOLF, gMonPalette_Gigawolf),
	SPECIES_PAL(GALACTIMON, gMonPalette_Galactimon),
	SPECIES_PAL(QWILSHARK, gMonPalette_Qwilshark),
	SPECIES_PAL(DRAGOONE, gMonPalette_Dragoone),
	SPECIES_PAL(CALFBY, gMonPalette_Calfby),
	SPECIES_PAL(RAMSHAKER, gMonPalette_Ramshaker),
	SPECIES_PAL(SEVICIOUS, gMonPalette_Sevicious),
	SPECIES_PAL(ZANGOL, gMonPalette_Zangol),
	SPECIES_PAL(PSYPIG, gMonPalette_Psypig),
	SPECIES_PAL(MUNCHLAX, gMonPalette_Munchlax),
	SPECIES_PAL(SKYLAX, gMonPalette_Skylax),
	SPECIES_PAL(MYSTERYEGG, gMonPalette_Mysteryegg),
	SPECIES_PAL(SECRETEGG, gMonPalette_Secretegg),
	SPECIES_PAL(HYPEREGG, gMonPalette_Hyperegg),
	SPECIES_PAL(HOMBONE, gMonPalette_Hombone),
	SPECIES_PAL(HOMBEAST, gMonPalette_Hombeast),
	SPECIES_PAL(KENCHIRA, gMonPalette_Kenchira),
	SPECIES_PAL(KENCHUKO, gMonPalette_Kenchuko),
	SPECIES_PAL(GLUTE, gMonPalette_Glute),
	SPECIES_PAL(BUTE, gMonPalette_Bute),
	SPECIES_PAL(NUTE, gMonPalette_Nute),
	SPECIES_PAL(FURI_X, gMonPalette_FuriX),
	SPECIES_PAL(FURI_Z, gMonPalette_FuriZ),
	SPECIES_PAL(FURI_Q, gMonPalette_FuriQ),
	SPECIES_PAL(TURMUR, gMonPalette_Turmur),
	SPECIES_PAL(SHADERU, gMonPalette_Shaderu),
	SPECIES_PAL(FACELEECH, gMonPalette_Faceleech),
	SPECIES_PAL(LUCA_ZAMON, gMonPalette_LucaZamon),
	SPECIES_PAL(TEA_BARCAN, gMonPalette_TeaBarcan),
	SPECIES_PAL(MINICE, gMonPalette_Minice),
	SPECIES_PAL(MINIROCK, gMonPalette_Minirock),
	SPECIES_PAL(MINISTEEL, gMonPalette_Ministeel),
	SPECIES_PAL(GENEROBO, gMonPalette_Generobo),
