const struct CompressedSpritePalette gMonPaletteTable[] =
{
	...
	SPECIES_PAL(CACTUMBRA, gMonPalette_Cactumbra),
	SPECIES_PAL(OBSICARGO, gMonPalette_Obsicargo),
	SPECIES_PAL(NORWHALE, gMonPalette_Norwhale),
	SPECIES_PAL(MINIOR_METEOR, gMonPalette_Minior),
	SPECIES_PAL(MINIOR_CORE, gMonPalette_MiniorCore),
	SPECIES_PAL(SPOOKUM, gMonPalette_Spookum),
	SPECIES_PAL(SPOOKUM_BUSTED, gMonPalette_SpookumBusted),
	SPECIES_PAL(GLASMA, gMonPalette_Glasma),
	SPECIES_PAL(PLASMOLYTE, gMonPalette_Plasmolyte),
	SPECIES_PAL(STORMAGE, gMonPalette_Stormage),
	SPECIES_PAL(SANDUDE, gMonPalette_Sandude),
	SPECIES_PAL(SANDROSS, gMonPalette_Sandross),
	SPECIES_PAL(SANDUEL, gMonPalette_Sanduel),
	SPECIES_PAL(ELADRIFT, gMonPalette_Eladrift),
	SPECIES_PAL(SLITHURENT, gMonPalette_Slithurent),
	SPECIES_PAL(PRESCYLLON, gMonPalette_Prescyllon),
	SPECIES_PAL(SLOSHMOSH, gMonPalette_Sloshmosh),
	SPECIES_PAL(SLURPINSKI, gMonPalette_Slurpinski),
	SPECIES_PAL(KEESH, gMonPalette_Keesh),
	SPECIES_PAL(HATCHBLING, gMonPalette_Hatchbling),
	SPECIES_PAL(HUMMBLING, gMonPalette_Hummbling),
	SPECIES_PAL(KEESIGHT, gMonPalette_Keesight),
	SPECIES_PAL(KEESPELL, gMonPalette_Keespell),
	SPECIES_PAL(LARVOOL, gMonPalette_Larvool),
	SPECIES_PAL(SPOOLER, gMonPalette_Spooler),
	SPECIES_PAL(BILLIARACH, gMonPalette_Billiarach),
	SPECIES_PAL(SLUGMA_FONEI, gMonPalette_SlugmaFonei),
	SPECIES_PAL(MAGCARGO_FONEI, gMonPalette_MagcargoFonei),
	SPECIES_PAL(SUNFOREST, gMonPalette_Sunforest),
	SPECIES_PAL(HONEDGE_FONEI, gMonPalette_HonedgeFonei),
	SPECIES_PAL(DOUBLADE_FONEI, gMonPalette_DoubladeFonei),
	SPECIES_PAL(AEGISLASH_FONEI_A, gMonPalette_AegislashFoneiA),
	SPECIES_PAL(AEGISLASH_FONEI_E, gMonPalette_AegislashFoneiE),
	SPECIES_PAL(ELEMPTY, gMonPalette_Elempty),
	SPECIES_PAL(VENEARTH, gMonPalette_Venearth),
	SPECIES_PAL(MARSIZZLE, gMonPalette_Marsizzle),
	SPECIES_PAL(JUPLASMA, gMonPalette_Juplasma),
	SPECIES_PAL(MERLPOOL, gMonPalette_Merlpool),
	SPECIES_PAL(OPHICALF, gMonPalette_Ophicalf),
	SPECIES_PAL(SERPENTAUR, gMonPalette_Serpentaur),
	SPECIES_PAL(GEODUDE_FONEI, gMonPalette_GeodudeFonei),
	SPECIES_PAL(GRAVELER_FONEI, gMonPalette_GravelerFonei),
	SPECIES_PAL(GOLEM_FONEI, gMonPalette_GolemFonei),
	SPECIES_PAL(SUDOWOODO_FONEI, gMonPalette_SudowoodoFonei),
	SPECIES_PAL(GRITWYRM, gMonPalette_Gritwyrm),
	SPECIES_PAL(MOLDUNE, gMonPalette_Moldune),
	SPECIES_PAL(WATTITUDE, gMonPalette_Wattitude),
	SPECIES_PAL(RALTS_FONEI, gMonPalette_RaltsFonei),
	SPECIES_PAL(KIRLIA_FONEI, gMonPalette_KirliaFonei),
	SPECIES_PAL(GARDEVOIR_FONEI, gMonPalette_GardevoirFonei),
	SPECIES_PAL(GALLADE_FONEI, gMonPalette_GalladeFonei),
	SPECIES_PAL(WOOBAT, gMonPalette_Woobat),
	SPECIES_PAL(SWOOBAT, gMonPalette_Swoobat),
	SPECIES_PAL(TRUEBAT, gMonPalette_Truebat),
	SPECIES_PAL(HOMBONE, gMonPalette_Hombone),
	SPECIES_PAL(HOMBEAST, gMonPalette_Hombeast),
	SPECIES_PAL(QWILSHARK, gMonPalette_Qwilshark),
	SPECIES_PAL(KRISSY, gMonPalette_Krissy),
	SPECIES_PAL(KRAKODEMON, gMonPalette_Krakodemon),
	SPECIES_PAL(WEATHERBANE, gMonPalette_Weatherbane),
	SPECIES_PAL(KETSUBAN, gMonPalette_Ketsuban),
	SPECIES_PAL(DISABY, gMonPalette_Disaby),
	SPECIES_PAL(DISASPRITE, gMonPalette_Disasprite),
	SPECIES_PAL(DISMASTER, gMonPalette_Dismaster),
	SPECIES_PAL(PURIDIAN, gMonPalette_Puridian),
	SPECIES_PAL(MANIPULO, gMonPalette_Manipulo),
	SPECIES_PAL(COILSPILL, gMonPalette_Coilspill),
	SPECIES_PAL(BOOWHO, gMonPalette_Boowho),
	SPECIES_PAL(BOOXER, gMonPalette_Booxer),
	SPECIES_PAL(BOOZERKER, gMonPalette_Boozerker),
	SPECIES_PAL(DEEPDARK, gMonPalette_Deepdark),
	SPECIES_PAL(BURMITE, gMonPalette_Burmite),
	SPECIES_PAL(SEDIMETAL, gMonPalette_Sedimetal),
	SPECIES_PAL(SOLOSIS_FONEI, gMonPalette_SolosisFonei),
	SPECIES_PAL(DUOSION_FONEI, gMonPalette_DuosionFonei),
	SPECIES_PAL(REUNICLUS_FONEI, gMonPalette_ReuniclusFonei),
	SPECIES_PAL(VINOS, gMonPalette_Vinos),
	SPECIES_PAL(VINOCEIVER, gMonPalette_Vinoceiver),
	SPECIES_PAL(ANNOYIDGE, gMonPalette_Annoyidge),
	SPECIES_PAL(PESQUITO, gMonPalette_Pesquito),
	SPECIES_PAL(MANKEY_FONEI, gMonPalette_MankeyFonei),
	SPECIES_PAL(PRIMEAPE_FONEI, gMonPalette_PrimeapeFonei),
	SPECIES_PAL(CRYOGONAL_FONEI, gMonPalette_CryogonalFonei),
	SPECIES_PAL(AMPIBOISON, gMonPalette_Ampiboison),
	SPECIES_PAL(LAGNET, gMonPalette_Lagnet),
	SPECIES_PAL(LANNET, gMonPalette_Lannet),
	SPECIES_PAL(CYBURN, gMonPalette_Cyburn),
	SPECIES_PAL(SAPNOSE, gMonPalette_Sapnose),
	SPECIES_PAL(BURROOT, gMonPalette_Burroot),
	SPECIES_PAL(BURRUSH, gMonPalette_Burrush),
	SPECIES_PAL(LAV, gMonPalette_Lav),
	SPECIES_PAL(LAVALY, gMonPalette_Lavaly),
	SPECIES_PAL(LAVSAMUCH, gMonPalette_Lavsamuch),
	SPECIES_PAL(GUPPAGE, gMonPalette_Guppage),
	SPECIES_PAL(SEAGE, gMonPalette_Seage),
	SPECIES_PAL(BASSTION, gMonPalette_Basstion),
	SPECIES_PAL(PANTOM, gMonPalette_Pantom),
	SPECIES_PAL(HAPPANING, gMonPalette_Happaning),
	SPECIES_PAL(PANZERGAST, gMonPalette_Panzergast),
	SPECIES_PAL(SCAIRY, gMonPalette_Scairy),
	SPECIES_PAL(DANKLIMMER, gMonPalette_Danklimmer),
	SPECIES_PAL(GOLICHEM, gMonPalette_Golichem),
	SPECIES_PAL(SPINDA_FONEI, gMonPalette_SpindaFonei),
	SPECIES_PAL(EMUNITION, gMonPalette_Emunition),
	SPECIES_PAL(EMORTAR, gMonPalette_Emortar),
	SPECIES_PAL(OPEBBLISK, gMonPalette_Opebblisk),
	SPECIES_PAL(STONUMENT, gMonPalette_Stonument),
	SPECIES_PAL(MEMOIRBLE, gMonPalette_Memoirble),
	SPECIES_PAL(NOKOMMON, gMonPalette_Nokommon),
	SPECIES_PAL(TANGHOUL, gMonPalette_Tanghoul),
	SPECIES_PAL(QWILYU, gMonPalette_Qwilyu),
	SPECIES_PAL(CORILIA, gMonPalette_Corilia),
	SPECIES_PAL(NIDOROOK, gMonPalette_Nidorook),
	SPECIES_PAL(SKALVENGER, gMonPalette_Skalvenger),
	SPECIES_PAL(SKULKREX, gMonPalette_Skulkrex),
	SPECIES_PAL(SKELTYRANT, gMonPalette_Skeltyrant),

	// SPECIES_PAL(SPCS, gMonPalette_Spcs),
