const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
	...
	SPECIES_SHINY_PAL(GORELAX, gMonShinyPalette_Gorelax),
	SPECIES_SHINY_PAL(SHINIGAMI, gMonShinyPalette_Shinigami),
	SPECIES_SHINY_PAL(ANTISPIRAL, gMonShinyPalette_Antispiral),
	SPECIES_SHINY_PAL(DRAGON, gMonShinyPalette_Dragon),
	SPECIES_SHINY_PAL(AMONSTER, gMonShinyPalette_Amonster),
	SPECIES_SHINY_PAL(FANGASU, gMonShinyPalette_Fangasu),
	SPECIES_SHINY_PAL(NIGERA, gMonShinyPalette_Nigera),
	SPECIES_SHINY_PAL(KURIPUTO, gMonShinyPalette_Kuriputo),
	SPECIES_SHINY_PAL(ROODANSE, gMonShinyPalette_Roodanse),
	SPECIES_SHINY_PAL(OOSHE, gMonShinyPalette_Ooshe),
	SPECIES_SHINY_PAL(GOOSUBOA, gMonShinyPalette_Goosuboa),
	SPECIES_SHINY_PAL(ROCLOBSTER, gMonShinyPalette_Roclobster),
	SPECIES_SHINY_PAL(X32763, gMonShinyPalette_X32763),
	SPECIES_SHINY_PAL(TELSON, gMonShinyPalette_Telson),
	SPECIES_SHINY_PAL(MAGNEZONE, gMonShinyPalette_Magnezone),
	SPECIES_SHINY_PAL(VIGOURLAN, gMonShinyPalette_Vigourlan),
	SPECIES_SHINY_PAL(DIAMANDIX, gMonShinyPalette_Diamandix),
	SPECIES_SHINY_PAL(GIGAWOLF, gMonShinyPalette_Gigawolf),
	SPECIES_SHINY_PAL(GALACTIMON, gMonShinyPalette_Galactimon),
	SPECIES_SHINY_PAL(QWILSHARK, gMonShinyPalette_Qwilshark),
	SPECIES_SHINY_PAL(DRAGOONE, gMonShinyPalette_Dragoone),
	SPECIES_SHINY_PAL(CALFBY, gMonShinyPalette_Calfby),
	SPECIES_SHINY_PAL(RAMSHAKER, gMonShinyPalette_Ramshaker),
	SPECIES_SHINY_PAL(SEVICIOUS, gMonShinyPalette_Sevicious),
	SPECIES_SHINY_PAL(ZANGOL, gMonShinyPalette_Zangol),
	SPECIES_SHINY_PAL(PSYPIG, gMonShinyPalette_Psypig),
	SPECIES_SHINY_PAL(MUNCHLAX, gMonShinyPalette_Munchlax),
	SPECIES_SHINY_PAL(SKYLAX, gMonShinyPalette_Skylax),
	SPECIES_SHINY_PAL(MYSTERYEGG, gMonShinyPalette_Mysteryegg),
	SPECIES_SHINY_PAL(SECRETEGG, gMonShinyPalette_Secretegg),
	SPECIES_SHINY_PAL(HYPEREGG, gMonShinyPalette_Hyperegg),
	SPECIES_SHINY_PAL(HOMBONE, gMonShinyPalette_Hombone),
	SPECIES_SHINY_PAL(HOMBEAST, gMonShinyPalette_Hombeast),
	SPECIES_SHINY_PAL(KENCHIRA, gMonShinyPalette_Kenchira),
	SPECIES_SHINY_PAL(KENCHUKO, gMonShinyPalette_Kenchuko),
	SPECIES_SHINY_PAL(GLUTE, gMonShinyPalette_Glute),
	SPECIES_SHINY_PAL(BUTE, gMonShinyPalette_Bute),
	SPECIES_SHINY_PAL(NUTE, gMonShinyPalette_Nute),
	SPECIES_SHINY_PAL(FURI_X, gMonShinyPalette_FuriX),
	SPECIES_SHINY_PAL(FURI_Z, gMonShinyPalette_FuriZ),
	SPECIES_SHINY_PAL(FURI_Q, gMonShinyPalette_FuriQ),
	SPECIES_SHINY_PAL(TURMUR, gMonShinyPalette_Turmur),
	SPECIES_SHINY_PAL(SHADERU, gMonShinyPalette_Shaderu),
	SPECIES_SHINY_PAL(FACELEECH, gMonShinyPalette_Faceleech),
	SPECIES_SHINY_PAL(LUCA_ZAMON, gMonShinyPalette_LucaZamon),
	SPECIES_SHINY_PAL(TEA_BARCAN, gMonShinyPalette_TeaBarcan),
	SPECIES_SHINY_PAL(MINICE, gMonShinyPalette_Minice),
	SPECIES_SHINY_PAL(MINIROCK, gMonShinyPalette_Minirock),
	SPECIES_SHINY_PAL(MINISTEEL, gMonShinyPalette_Ministeel),
	SPECIES_SHINY_PAL(GENEROBO, gMonShinyPalette_Generobo),
