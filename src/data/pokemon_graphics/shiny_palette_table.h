const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
	...
	SPECIES_SHINY_PAL(CACTUMBRA, gMonShinyPalette_Cactumbra),
	SPECIES_SHINY_PAL(OBSICARGO, gMonShinyPalette_Obsicargo),
	SPECIES_SHINY_PAL(NORWHALE, gMonShinyPalette_Norwhale),
	SPECIES_SHINY_PAL(MINIOR_METEOR, gMonShinyPalette_Minior),
	SPECIES_SHINY_PAL(MINIOR_CORE, gMonShinyPalette_MiniorCore),
	SPECIES_SHINY_PAL(SPOOKUM, gMonShinyPalette_Spookum),
	SPECIES_SHINY_PAL(SPOOKUM_BUSTED, gMonShinyPalette_SpookumBusted),
	SPECIES_SHINY_PAL(GLASMA, gMonShinyPalette_Glasma),
	SPECIES_SHINY_PAL(PLASMOLYTE, gMonShinyPalette_Plasmolyte),
	SPECIES_SHINY_PAL(STORMAGE, gMonShinyPalette_Stormage),
	SPECIES_SHINY_PAL(SANDUDE, gMonShinyPalette_Sandude),
	SPECIES_SHINY_PAL(SANDROSS, gMonShinyPalette_Sandross),
	SPECIES_SHINY_PAL(SANDUEL, gMonShinyPalette_Sanduel),
	SPECIES_SHINY_PAL(ELADRIFT, gMonShinyPalette_Eladrift),
	SPECIES_SHINY_PAL(SLITHURENT, gMonShinyPalette_Slithurent),
	SPECIES_SHINY_PAL(PRESCYLLON, gMonShinyPalette_Prescyllon),
	SPECIES_SHINY_PAL(SLOSHMOSH, gMonShinyPalette_Sloshmosh),
	SPECIES_SHINY_PAL(SLURPINSKI, gMonShinyPalette_Slurpinski),
	SPECIES_SHINY_PAL(KEESH, gMonShinyPalette_Keesh),
	SPECIES_SHINY_PAL(HATCHBLING, gMonShinyPalette_Hatchbling),
	SPECIES_SHINY_PAL(HUMMBLING, gMonShinyPalette_Hummbling),
	SPECIES_SHINY_PAL(KEESIGHT, gMonShinyPalette_Keesight),
	SPECIES_SHINY_PAL(KEESPELL, gMonShinyPalette_Keespell),
	SPECIES_SHINY_PAL(LARVOOL, gMonShinyPalette_Larvool),
	SPECIES_SHINY_PAL(SPOOLER, gMonShinyPalette_Spooler),
	SPECIES_SHINY_PAL(BILLIARACH, gMonShinyPalette_Billiarach),
	SPECIES_SHINY_PAL(SLUGMA_FONEI, gMonShinyPalette_SlugmaFonei),
	SPECIES_SHINY_PAL(MAGCARGO_FONEI, gMonShinyPalette_MagcargoFonei),
	SPECIES_SHINY_PAL(SUNFOREST, gMonShinyPalette_Sunforest),
	SPECIES_SHINY_PAL(HONEDGE_FONEI, gMonShinyPalette_HonedgeFonei),
	SPECIES_SHINY_PAL(DOUBLADE_FONEI, gMonShinyPalette_DoubladeFonei),
	SPECIES_SHINY_PAL(AEGISLASH_FONEI_A, gMonShinyPalette_AegislashFoneiA),
	SPECIES_SHINY_PAL(AEGISLASH_FONEI_E, gMonShinyPalette_AegislashFoneiE),
	SPECIES_SHINY_PAL(ELEMPTY, gMonShinyPalette_Elempty),
	SPECIES_SHINY_PAL(VENEARTH, gMonShinyPalette_Venearth),
	SPECIES_SHINY_PAL(MARSIZZLE, gMonShinyPalette_Marsizzle),
	SPECIES_SHINY_PAL(JUPLASMA, gMonShinyPalette_Juplasma),
	SPECIES_SHINY_PAL(MERLPOOL, gMonShinyPalette_Merlpool),
	SPECIES_SHINY_PAL(OPHICALF, gMonShinyPalette_Ophicalf),
	SPECIES_SHINY_PAL(SERPENTAUR, gMonShinyPalette_Serpentaur),
	SPECIES_SHINY_PAL(GEODUDE_FONEI, gMonShinyPalette_GeodudeFonei),
	SPECIES_SHINY_PAL(GRAVELER_FONEI, gMonShinyPalette_GravelerFonei),
	SPECIES_SHINY_PAL(GOLEM_FONEI, gMonShinyPalette_GolemFonei),
	SPECIES_SHINY_PAL(SUDOWOODO_FONEI, gMonShinyPalette_SudowoodoFonei),
	SPECIES_SHINY_PAL(GRITWYRM, gMonShinyPalette_Gritwyrm),
	SPECIES_SHINY_PAL(MOLDUNE, gMonShinyPalette_Moldune),
	SPECIES_SHINY_PAL(WATTITUDE, gMonShinyPalette_Wattitude),
	SPECIES_SHINY_PAL(RALTS_FONEI, gMonShinyPalette_RaltsFonei),
	SPECIES_SHINY_PAL(KIRLIA_FONEI, gMonShinyPalette_KirliaFonei),
	SPECIES_SHINY_PAL(GARDEVOIR_FONEI, gMonShinyPalette_GardevoirFonei),
	SPECIES_SHINY_PAL(GALLADE_FONEI, gMonShinyPalette_GalladeFonei),
	SPECIES_SHINY_PAL(WOOBAT, gMonShinyPalette_Woobat),
	SPECIES_SHINY_PAL(SWOOBAT, gMonShinyPalette_Swoobat),
	SPECIES_SHINY_PAL(TRUEBAT, gMonShinyPalette_Truebat),
	SPECIES_SHINY_PAL(HOMBONE, gMonShinyPalette_Hombone),
	SPECIES_SHINY_PAL(HOMBEAST, gMonShinyPalette_Hombeast),
	SPECIES_SHINY_PAL(QWILSHARK, gMonShinyPalette_Qwilshark),
	SPECIES_SHINY_PAL(KRISSY, gMonShinyPalette_Krissy),
	SPECIES_SHINY_PAL(KRAKODEMON, gMonShinyPalette_Krakodemon),
	SPECIES_SHINY_PAL(WEATHERBANE, gMonShinyPalette_Weatherbane),
	SPECIES_SHINY_PAL(KETSUBAN, gMonShinyPalette_Ketsuban),
	SPECIES_SHINY_PAL(DISABY, gMonShinyPalette_Disaby),
	SPECIES_SHINY_PAL(DISASPRITE, gMonShinyPalette_Disasprite),
	SPECIES_SHINY_PAL(DISMASTER, gMonShinyPalette_Dismaster),
	SPECIES_SHINY_PAL(PURIDIAN, gMonShinyPalette_Puridian),
	SPECIES_SHINY_PAL(MANIPULO, gMonShinyPalette_Manipulo),
	SPECIES_SHINY_PAL(COILSPILL, gMonShinyPalette_Coilspill),
	SPECIES_SHINY_PAL(BOOWHO, gMonShinyPalette_Boowho),
	SPECIES_SHINY_PAL(BOOXER, gMonShinyPalette_Booxer),
	SPECIES_SHINY_PAL(BOOZERKER, gMonShinyPalette_Boozerker),
	SPECIES_SHINY_PAL(DEEPDARK, gMonShinyPalette_Deepdark),
	SPECIES_SHINY_PAL(BURMITE, gMonShinyPalette_Burmite),
	SPECIES_SHINY_PAL(SEDIMETAL, gMonShinyPalette_Sedimetal),
	SPECIES_SHINY_PAL(SOLOSIS_FONEI, gMonShinyPalette_SolosisFonei),
	SPECIES_SHINY_PAL(DUOSION_FONEI, gMonShinyPalette_DuosionFonei),
	SPECIES_SHINY_PAL(REUNICLUS_FONEI, gMonShinyPalette_ReuniclusFonei),
	SPECIES_SHINY_PAL(VINOS, gMonShinyPalette_Vinos),
	SPECIES_SHINY_PAL(VINOCEIVER, gMonShinyPalette_Vinoceiver),
	SPECIES_SHINY_PAL(ANNOYIDGE, gMonShinyPalette_Annoyidge),
	SPECIES_SHINY_PAL(PESQUITO, gMonShinyPalette_Pesquito),
	SPECIES_SHINY_PAL(MANKEY_FONEI, gMonShinyPalette_MankeyFonei),
	SPECIES_SHINY_PAL(PRIMEAPE_FONEI, gMonShinyPalette_PrimeapeFonei),
	SPECIES_SHINY_PAL(CRYOGONAL_FONEI, gMonShinyPalette_CryogonalFonei),
	SPECIES_SHINY_PAL(AMPIBOISON, gMonShinyPalette_Ampiboison),
	SPECIES_SHINY_PAL(LAGNET, gMonShinyPalette_Lagnet),
	SPECIES_SHINY_PAL(LANNET, gMonShinyPalette_Lannet),
	SPECIES_SHINY_PAL(CYBURN, gMonShinyPalette_Cyburn),
	SPECIES_SHINY_PAL(SAPNOSE, gMonShinyPalette_Sapnose),
	SPECIES_SHINY_PAL(BURROOT, gMonShinyPalette_Burroot),
	SPECIES_SHINY_PAL(BURRUSH, gMonShinyPalette_Burrush),
	SPECIES_SHINY_PAL(LAV, gMonShinyPalette_Lav),
	SPECIES_SHINY_PAL(LAVALY, gMonShinyPalette_Lavaly),
	SPECIES_SHINY_PAL(LAVSAMUCH, gMonShinyPalette_Lavsamuch),
	SPECIES_SHINY_PAL(GUPPAGE, gMonShinyPalette_Guppage),
	SPECIES_SHINY_PAL(SEAGE, gMonShinyPalette_Seage),
	SPECIES_SHINY_PAL(BASSTION, gMonShinyPalette_Basstion),
	SPECIES_SHINY_PAL(PANTOM, gMonShinyPalette_Pantom),
	SPECIES_SHINY_PAL(HAPPANING, gMonShinyPalette_Happaning),
	SPECIES_SHINY_PAL(PANZERGAST, gMonShinyPalette_Panzergast),
	SPECIES_SHINY_PAL(SCAIRY, gMonShinyPalette_Scairy),
	SPECIES_SHINY_PAL(DANKLIMMER, gMonShinyPalette_Danklimmer),
	SPECIES_SHINY_PAL(GOLICHEM, gMonShinyPalette_Golichem),
	SPECIES_SHINY_PAL(SPINDA_FONEI, gMonShinyPalette_SpindaFonei),
	SPECIES_SHINY_PAL(EMUNITION, gMonShinyPalette_Emunition),
	SPECIES_SHINY_PAL(EMORTAR, gMonShinyPalette_Emortar),
	SPECIES_SHINY_PAL(OPEBBLISK, gMonShinyPalette_Opebblisk),
	SPECIES_SHINY_PAL(STONUMENT, gMonShinyPalette_Stonument),
	SPECIES_SHINY_PAL(MEMOIRBLE, gMonShinyPalette_Memoirble),
	SPECIES_SHINY_PAL(NOKOMMON, gMonShinyPalette_Nokommon),
	SPECIES_SHINY_PAL(TANGHOUL, gMonShinyPalette_Tanghoul),
	SPECIES_SHINY_PAL(QWILYU, gMonShinyPalette_Qwilyu),
	SPECIES_SHINY_PAL(CORILIA, gMonShinyPalette_Corilia),
	SPECIES_SHINY_PAL(NIDOROOK, gMonShinyPalette_Nidorook),
	SPECIES_SHINY_PAL(SKALVENGER, gMonShinyPalette_Skalvenger),
	SPECIES_SHINY_PAL(SKULKREX, gMonShinyPalette_Skulkrex),
	SPECIES_SHINY_PAL(SKELTYRANT, gMonShinyPalette_Skeltyrant),
	// SPECIES_SHINY_PAL(SPCS, gMonShinyPalette_Spcs),
