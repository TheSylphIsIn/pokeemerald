...
static UNUSED void Debug_AddDaycareSteps(u16 numSteps)
{
...
static UNUSED void ClearAllDaycareData(struct DayCare *daycare)
{
    u8 i;
...
// Unused
static UNUSED void TriggerPendingDaycareMaleEgg(void)
{
...
static u16 DetermineEggSpeciesAndParentSlots(struct DayCare *daycare, u8 *parentSlots)
{
    ...
    eggSpecies = GetBaseSpecies(species[parentSlots[0]]);
...
static UNUSED void GetDaycareLevelMenuText(struct DayCare *daycare, u8 *dest)
{
...
static UNUSED void GetDaycareLevelMenuLevelText(struct DayCare *daycare, u8 *dest)
{
    u8 i;
    u8 level;
    u8 text[20];
