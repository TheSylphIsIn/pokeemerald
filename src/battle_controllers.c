...
{
    gBattleResources->transferBuffer[0] = CONTROLLER_USETACTICS;
    gBattleResources->transferBuffer[1] = CONTROLLER_USETACTICS;
    gBattleResources->transferBuffer[2] = CONTROLLER_USETACTICS;
    gBattleResources->transferBuffer[3] = CONTROLLER_USETACTICS;
    PrepareBufferDataTransfer(battler, bufferId, gBattleResources->transferBuffer, 4);
}
...
static void UNUSED BtlController_EmitCmd32(u32 battler, u32 bufferId, u16 size, void *data)
{
    ...
    gBattleResources->transferBuffer[0] = CONTROLLER_OPENFIELDSTATUS;
...
void BtlController_HandleDrawTrainerPic(u32 battler, u32 trainerPicId, bool32 isFrontPic, s16 xPos, s16 yPos, s32 subpriority)
{
    if (GetBattlerSide(battler) == B_SIDE_OPPONENT) // Always the front sprite for the opponent.
    {
        ...
        gSprites[gBattlerSpriteIds[battler]].x2 = -DISPLAY_WIDTH;
        gSprites[gBattlerSpriteIds[battler]].sSpeedX = INTRO_SLIDE_SPEED;
