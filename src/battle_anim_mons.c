...
static UNUSED void TranslateSpriteInLissajousCurve(struct Sprite *sprite)
{
    if (sprite->sDuration)
    {
...
static UNUSED void TranslateSpriteToBattleTargetPos(struct Sprite *sprite)
{
...
static UNUSED void TranslateSpriteToBattleAttackerPos(struct Sprite *sprite)
{
    sprite->sStartX = sprite->x + sprite->x2;
    sprite->sStartY = sprite->y + sprite->y2;
...
static UNUSED void EndUnkPaletteAnim(struct Sprite *sprite)
{
...
static UNUSED void StartAnimLinearTranslation_SetCornerVecX(struct Sprite *sprite)
{
    sprite->data[1] = sprite->x;
    sprite->data[3] = sprite->y;
    InitAnimLinearTranslation(sprite);
...
static UNUSED u8 GetSpritePalIdxByPosition(u8 position)
{
...
static UNUSED void SetPriorityForVisibleBattlers(u8 priority)
{
