...
static const u8 sSpeciesToBackAnimSet[] =
{
	...
	[SPECIES_DUBSNAKE]   = BACK_ANIM_H_SHAKE,
	[SPECIES_HYDROIL]    = BACK_ANIM_H_SHAKE,
	[SPECIES_WYCERN] 	 = BACK_ANIM_DIP_RIGHT_SIDE,
	[SPECIES_BITTERAGON] = BACK_ANIM_JOLT_RIGHT,
	[SPECIES_CACTUMBRA]  = BACK_ANIM_SHAKE_GLOW_GREEN,
	[SPECIES_OBSICARGO]  = BACK_ANIM_SHAKE_GLOW_RED,
	[SPECIES_NORWHALE]   = BACK_ANIM_SHAKE_GLOW_BLUE,
	[SPECIES_MINIOR_METEOR] = BACK_ANIM_V_SHAKE_LOW,
	[SPECIES_MINIOR_CORE] = BACK_ANIM_TRIANGLE_DOWN,
	[SPECIES_SPOOKUM] = BACK_ANIM_H_VIBRATE,
	[SPECIES_SPOOKUM_BUSTED] = BACK_ANIM_H_VIBRATE,
	[SPECIES_GLASMA]	= BACK_ANIM_DIP_RIGHT_SIDE,
	[SPECIES_PLASMOLYTE]	= BACK_ANIM_H_VIBRATE,
	[SPECIES_STORMAGE]	= BACK_ANIM_H_VIBRATE,
	[SPECIES_SANDUDE]	= BACK_ANIM_H_SHAKE,
	[SPECIES_SANDROSS]	= BACK_ANIM_H_VIBRATE,
	[SPECIES_SANDUEL]	= BACK_ANIM_H_VIBRATE,
	[SPECIES_ELADRIFT]	= BACK_ANIM_V_SHAKE,
	[SPECIES_SLITHURENT]	= BACK_ANIM_H_VIBRATE,
	[SPECIES_PRESCYLLON]	= BACK_ANIM_H_VIBRATE,
	[SPECIES_SLOSHMOSH]	= BACK_ANIM_H_STRETCH,
	[SPECIES_SLURPINSKI]	= BACK_ANIM_H_VIBRATE,
	[SPECIES_KEESH]	= BACK_ANIM_V_SHAKE_H_SLIDE,
	[SPECIES_HATCHBLING]	= BACK_ANIM_H_VIBRATE,
	[SPECIES_HUMMBLING]	= BACK_ANIM_H_VIBRATE,
	[SPECIES_KEESIGHT]	= BACK_ANIM_H_VIBRATE,
	[SPECIES_KEESPELL]	= BACK_ANIM_H_VIBRATE,
	[SPECIES_LARVOOL]	= BACK_ANIM_H_VIBRATE,
	[SPECIES_SPOOLER]	= BACK_ANIM_H_VIBRATE,
	[SPECIES_BILLIARACH]	= BACK_ANIM_H_VIBRATE,
	[SPECIES_SLUGMA_FONEI]	= BACK_ANIM_DIP_RIGHT_SIDE,
	[SPECIES_MAGCARGO_FONEI]	= BACK_ANIM_SHAKE_FLASH_YELLOW,
	[SPECIES_SUNFOREST]	= BACK_ANIM_H_VIBRATE,
	[SPECIES_HONEDGE_FONEI]	= BACK_ANIM_H_VIBRATE,
	[SPECIES_DOUBLADE_FONEI]	= BACK_ANIM_H_VIBRATE,
	[SPECIES_AEGISLASH_FONEI_A]	= BACK_ANIM_H_VIBRATE,
	[SPECIES_AEGISLASH_FONEI_E]	= BACK_ANIM_H_VIBRATE,
	[SPECIES_ELEMPTY]	= BACK_ANIM_H_VIBRATE,
	[SPECIES_VENEARTH]	= BACK_ANIM_H_VIBRATE,
	[SPECIES_MARSIZZLE]	= BACK_ANIM_H_VIBRATE,
	[SPECIES_JUPLASMA]	= BACK_ANIM_H_VIBRATE,
	[SPECIES_MERLPOOL]	= BACK_ANIM_H_VIBRATE,
	[SPECIES_OPHICALF]	= BACK_ANIM_H_VIBRATE,
	[SPECIES_SERPENTAUR]	= BACK_ANIM_H_VIBRATE,
	[SPECIES_GEODUDE_FONEI]	= BACK_ANIM_H_VIBRATE,
	[SPECIES_GRAVELER_FONEI]	= BACK_ANIM_H_VIBRATE,
	[SPECIES_GOLEM_FONEI]	= BACK_ANIM_H_VIBRATE,
	[SPECIES_SUDOWOODO_FONEI]	= BACK_ANIM_H_VIBRATE,
	[SPECIES_GRITWYRM]	= BACK_ANIM_H_VIBRATE,
	[SPECIES_MOLDUNE]	= BACK_ANIM_H_VIBRATE,
	[SPECIES_WATTITUDE]	= BACK_ANIM_H_SPRING,
	[SPECIES_RALTS_FONEI]	= BACK_ANIM_H_SHAKE,
	[SPECIES_KIRLIA_FONEI]	= BACK_ANIM_H_SHAKE,
	[SPECIES_GARDEVOIR_FONEI]	= BACK_ANIM_H_SHAKE,
	[SPECIES_GALLADE_FONEI]	= BACK_ANIM_H_SHAKE,
	[SPECIES_WOOBAT]	= BACK_ANIM_H_SHAKE,
	[SPECIES_SWOOBAT]	= BACK_ANIM_H_SHAKE,
	[SPECIES_TRUEBAT]	= BACK_ANIM_H_SHAKE,
	[SPECIES_HOMBONE]	= BACK_ANIM_H_SHAKE,
	[SPECIES_HOMBEAST]	= BACK_ANIM_H_SHAKE,
	[SPECIES_QWILSHARK]	= BACK_ANIM_H_SHAKE,
	[SPECIES_KRISSY]	= BACK_ANIM_H_SHAKE,
	[SPECIES_KRAKODEMON]	= BACK_ANIM_H_SHAKE,
	[SPECIES_WEATHERBANE]	= BACK_ANIM_H_SHAKE,
	[SPECIES_KETSUBAN]	= BACK_ANIM_H_SHAKE,
	[SPECIES_DISABY]	= BACK_ANIM_CONVEX_DOUBLE_ARC,
	[SPECIES_DISASPRITE]	= BACK_ANIM_H_SHAKE,
	[SPECIES_DISMASTER]	= BACK_ANIM_H_SHAKE,
	[SPECIES_PURIDIAN]	= BACK_ANIM_H_SHAKE,
	[SPECIES_MANIPULO]	= BACK_ANIM_SHRINK_GROW_VIBRATE,
	[SPECIES_COILSPILL]	= BACK_ANIM_H_SHAKE,
	[SPECIES_BOOWHO]	= BACK_ANIM_H_SHAKE,
	[SPECIES_BOOXER]	= BACK_ANIM_H_SHAKE,
	[SPECIES_BOOZERKER]	= BACK_ANIM_H_SHAKE,
	[SPECIES_DEEPDARK]	= BACK_ANIM_H_SHAKE,
	[SPECIES_BURMITE]	= BACK_ANIM_H_SHAKE,
	[SPECIES_SEDIMETAL]	= BACK_ANIM_H_SHAKE,
	[SPECIES_SOLOSIS_FONEI]	= BACK_ANIM_V_SHAKE,
	[SPECIES_DUOSION_FONEI]	= BACK_ANIM_H_SHAKE,
	[SPECIES_REUNICLUS_FONEI]	= BACK_ANIM_H_SHAKE,
	[SPECIES_VINOS]	= BACK_ANIM_H_SHAKE,
	[SPECIES_VINOCEIVER]	= BACK_ANIM_H_SHAKE,
	[SPECIES_ANNOYIDGE]	= BACK_ANIM_H_SHAKE,
	[SPECIES_PESQUITO]	= BACK_ANIM_H_SHAKE,
	[SPECIES_MANKEY_FONEI]	= BACK_ANIM_H_SHAKE,
	[SPECIES_PRIMEAPE_FONEI]	= BACK_ANIM_H_SHAKE,
	[SPECIES_CRYOGONAL_FONEI]	= BACK_ANIM_H_SHAKE,
	[SPECIES_AMPIBOISON]	= BACK_ANIM_H_SHAKE,
	[SPECIES_LAGNET]	= BACK_ANIM_H_SHAKE,
	[SPECIES_LANNET]	= BACK_ANIM_H_SHAKE,
	[SPECIES_CYBURN]	= BACK_ANIM_H_SHAKE,
	[SPECIES_SAPNOSE]	= BACK_ANIM_H_SHAKE,
	[SPECIES_BURROOT]	= BACK_ANIM_H_SHAKE,
	[SPECIES_BURRUSH]	= BACK_ANIM_H_SHAKE,
	[SPECIES_LAV]	= BACK_ANIM_H_SHAKE,
	[SPECIES_LAVALY]	= BACK_ANIM_H_SHAKE,
	[SPECIES_LAVSAMUCH]	= BACK_ANIM_H_SHAKE,
	[SPECIES_GUPPAGE]	= BACK_ANIM_H_SHAKE,
	[SPECIES_SEAGE]	= BACK_ANIM_H_SHAKE,
	[SPECIES_BASSTION]	= BACK_ANIM_H_SHAKE,
	[SPECIES_PANTOM]	= BACK_ANIM_H_SHAKE,
	[SPECIES_HAPPANING]	= BACK_ANIM_H_SHAKE,
	[SPECIES_PANZERGAST]	= BACK_ANIM_H_SHAKE,
	[SPECIES_SCAIRY]	= BACK_ANIM_H_SHAKE,
	[SPECIES_DANKLIMMER]	= BACK_ANIM_H_SHAKE,
	[SPECIES_GOLICHEM]	= BACK_ANIM_H_SHAKE,
	[SPECIES_SPINDA_FONEI]	= BACK_ANIM_H_SHAKE,
	[SPECIES_EMUNITION]	= BACK_ANIM_H_SHAKE,
	[SPECIES_EMORTAR]	= BACK_ANIM_H_SHAKE,
	[SPECIES_OPEBBLISK]	= BACK_ANIM_H_SHAKE,
	[SPECIES_STONUMENT]	= BACK_ANIM_H_SHAKE,
	[SPECIES_MEMOIRBLE]	= BACK_ANIM_H_SHAKE,
	[SPECIES_NOKOMMON]	= BACK_ANIM_H_SHAKE,
	[SPECIES_TANGHOUL]	= BACK_ANIM_H_SHAKE,
	[SPECIES_QWILYU]	= BACK_ANIM_H_SHAKE,
	[SPECIES_CORILIA]	= BACK_ANIM_H_SHAKE,
	[SPECIES_NIDOROOK]	= BACK_ANIM_H_SHAKE,
	[SPECIES_SKALVENGER]	= BACK_ANIM_H_SHAKE,
	[SPECIES_SKULKREX]	= BACK_ANIM_H_SHAKE,
	[SPECIES_SKELTYRANT]	= BACK_ANIM_H_SHAKE,


	// [SPECIES_SPCS] = BACK_ANIM_,
