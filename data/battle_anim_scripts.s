...
gBattleAnims_Moves::
	...
	.4byte Move_CHARMING_CRY
	.4byte Move_TWINKLE_POP
	.4byte Move_DRAIN_KISS
	.4byte Move_PLAY_ROUGH
	.4byte Move_STAR_PUNCH
	.4byte Move_FAIRY_LIGHT
	.4byte Move_SPIRE
	...
	.4byte Move_SHADOW_STALK
	.4byte Move_AURA_WAVE
...
Move_CLOSE_COMBAT:
	...
	setalpha 12, 8
	createvisualtask AnimTask_IsContest, 2
	jumprettrue CloseCombatInContest
	createvisualtask AnimTask_IsTargetPlayerSide, 2
	jumpretfalse CloseCombatOnOpponent
	goto CloseCombatOnPlayer
CloseCombatContinue:
	waitbgfadein
	createsprite gSuperpowerOrbSpriteTemplate, ANIM_TARGET, 2, ANIM_ATTACKER
	playsewithpan SE_M_MEGA_KICK, SOUND_PAN_ATTACKER
...
CloseCombatOnOpponent:
	fadetobg BG_IMPACT_OPPONENT
	goto CloseCombatContinue
CloseCombatOnPlayer:
	fadetobg BG_IMPACT_PLAYER
	goto CloseCombatContinue
CloseCombatInContest:
	fadetobg BG_IMPACT_CONTESTS
	goto CloseCombatContinue
...
Move_INFERNO_RAY:
	...
	monbg ANIM_DEF_PARTNER
	splitbgprio ANIM_TARGET
	jumpifmoveturn 0, InfernoRayOne
	jumpifmoveturn 1, InfernoRayTwo
	goto InfernoRayThree
InfernoRayContinue:
	waitforvisualfinish
	clearmonbg ANIM_DEF_PARTNER
	blendoff
...
InfernoRayOne:
	loopsewithpan SE_M_FLAME_WHEEL, SOUND_PAN_ATTACKER, 7, 3
	createsprite gDragonBreathFireSpriteTemplate, ANIM_TARGET, 2, 0, 0, 0, 0, 20
	delay 2
	createsprite gDragonBreathFireSpriteTemplate, ANIM_TARGET, 2, 0, 0, 0, 0, 20
	delay 2
...
InfernoRayThree:
	loopsewithpan SE_M_FLAME_WHEEL, SOUND_PAN_ATTACKER, 7, 11
	createsprite gDragonBreathFireSpriteTemplate, ANIM_TARGET, 2, 0, 0, 0, 0, 20
	delay 2
	createsprite gDragonBreathFireSpriteTemplate, ANIM_TARGET, 2, 0, 0, 0, 0, 20
	delay 2
	...
	createsprite gDragonBreathFireSpriteTemplate, ANIM_TARGET, 2, 0, 0, 0, 0, 20
	delay 2
	createvisualtask AnimTask_ShakeMon2, 2, ANIM_TARGET, 2, 0, 33, 1
	createsprite gDragonBreathFireSpriteTemplate, ANIM_TARGET, 2, 0, 0, 0, 0, 20
	delay 2
	createsprite gDragonBreathFireSpriteTemplate, ANIM_TARGET, 2, 0, 0, 0, 0, 20
	delay 2
